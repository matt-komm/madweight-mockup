...
#include "P0_Sigma_sm_uu_uuuux_qcd_4j.h"
...
void P0_Sigma_sm_uu_uuuux_qcd_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_uu_uuuux_qcd_4j::sigmaKin() 
{
...
double P0_Sigma_sm_uu_uuuux_qcd_4j::sigmaHat() 
{
...
void P0_Sigma_sm_uu_uuuux_qcd_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[0], w[3], pars->GC_11, pars->ZERO, pars->ZERO, w[15]); 
  FFV1_3(w[1], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[16]); 
  ...
  FFV1_3(w[5], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[20]); 
  FFV1_2(w[1], w[15], pars->GC_11, pars->ZERO, pars->ZERO, w[21]); 
  FFV1_3(w[0], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[22]); 
...
double P0_Sigma_sm_uu_uuuux_qcd_4j::matrix_uu_uuuux() 
{
  int i, j; 
  // Local variables
