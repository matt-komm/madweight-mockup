...
#include "P0_Sigma_sm_gg_ucuxcx_qcd_4j.h"
...
// Process: g g > u c u~ c~ WEIGHTED=4
// Process: g g > u d u~ d~ WEIGHTED=4
// Process: g g > u s u~ s~ WEIGHTED=4
// Process: g g > c d c~ d~ WEIGHTED=4
// Process: g g > c s c~ s~ WEIGHTED=4
// Process: g g > d s d~ s~ WEIGHTED=4

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_gg_ucuxcx_qcd_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_gg_ucuxcx_qcd_4j::sigmaKin() 
{
...
double P0_Sigma_sm_gg_ucuxcx_qcd_4j::sigmaHat() 
{
  // Select between the different processes
  if(id1 == 21 && id2 == 21)
  {
    // Add matrix elements for processes with beams (21, 21)
    return matrix_element[0] * 6; 
  }
  else
  {
...
void P0_Sigma_sm_gg_ucuxcx_qcd_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_1(w[2], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[11]); 
  FFV1_2(w[4], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[12]); 
  FFV1_1(w[2], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[13]); 
  FFV1_1(w[3], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[14]); 
  FFV1_3(w[4], w[13], pars->GC_11, pars->ZERO, pars->ZERO, w[15]); 
  FFV1_2(w[4], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[16]); 
  FFV1_2(w[5], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[17]); 
  FFV1_1(w[13], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[18]); 
  FFV1_1(w[3], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[19]); 
  FFV1_1(w[2], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[20]); 
  FFV1_3(w[5], w[19], pars->GC_11, pars->ZERO, pars->ZERO, w[21]); 
  FFV1_1(w[19], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[22]); 
  FFV1_2(w[4], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[23]); 
  FFV1_3(w[23], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[24]); 
  FFV1_2(w[23], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[25]); 
  FFV1_2(w[5], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[26]); 
  FFV1_3(w[26], w[3], pars->GC_11, pars->ZERO, pars->ZERO, w[27]); 
  FFV1_2(w[26], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[28]); 
  ...
  FFV1_0(w[17], w[3], w[15], pars->GC_11, amp[7]); 
  FFV1_0(w[4], w[18], w[10], pars->GC_11, amp[8]); 
  VVV1_0(w[1], w[10], w[15], pars->GC_10, amp[9]); 
  FFV1_0(w[4], w[20], w[21], pars->GC_11, amp[10]); 
  FFV1_0(w[16], w[2], w[21], pars->GC_11, amp[11]); 
  FFV1_0(w[17], w[19], w[7], pars->GC_11, amp[12]); 
  FFV1_0(w[5], w[22], w[7], pars->GC_11, amp[13]); 
  VVV1_0(w[1], w[7], w[21], pars->GC_10, amp[14]); 
  FFV1_0(w[23], w[20], w[10], pars->GC_11, amp[15]); 
  FFV1_0(w[5], w[14], w[24], pars->GC_11, amp[16]); 
  FFV1_0(w[17], w[3], w[24], pars->GC_11, amp[17]); 
  FFV1_0(w[25], w[2], w[10], pars->GC_11, amp[18]); 
  VVV1_0(w[1], w[10], w[24], pars->GC_10, amp[19]); 
  FFV1_0(w[4], w[20], w[27], pars->GC_11, amp[20]); 
  FFV1_0(w[26], w[14], w[7], pars->GC_11, amp[21]); 
  FFV1_0(w[16], w[2], w[27], pars->GC_11, amp[22]); 
  FFV1_0(w[28], w[3], w[7], pars->GC_11, amp[23]); 
  ...
  FFV1_0(w[33], w[2], w[10], pars->GC_11, amp[29]); 
  FFV1_0(w[16], w[2], w[30], pars->GC_11, amp[30]); 
  FFV1_0(w[34], w[3], w[7], pars->GC_11, amp[31]); 
  FFV1_0(w[17], w[3], w[32], pars->GC_11, amp[32]); 
  ...
  VVV1_0(w[1], w[10], w[32], pars->GC_10, amp[36]); 
  VVV1_0(w[1], w[7], w[30], pars->GC_10, amp[37]); 

}
double P0_Sigma_sm_gg_ucuxcx_qcd_4j::matrix_gg_ucuxcx() 
{
  int i, j; 
  // Local variables
