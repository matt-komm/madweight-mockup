...
#include "P0_Sigma_sm_uc_ucccx_qcd_4j.h"
...
void P0_Sigma_sm_uc_ucccx_qcd_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_uc_ucccx_qcd_4j::sigmaKin() 
{
...
double P0_Sigma_sm_uc_ucccx_qcd_4j::sigmaHat() 
{
...
void P0_Sigma_sm_uc_ucccx_qcd_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[5], w[3], pars->GC_11, pars->ZERO, pars->ZERO, w[13]); 
...
double P0_Sigma_sm_uc_ucccx_qcd_4j::matrix_uc_ucccx() 
{
  int i, j; 
  // Local variables
