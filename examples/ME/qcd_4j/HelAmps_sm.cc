    ...
    complex<double> COUP, double M1, double W1, complex<double> V1[])
{
  ...
  TMP16 = (V4[2] * P1[0] - V4[3] * P1[1] - V4[4] * P1[2] - V4[5] * P1[3]); 
  TMP11 = (V2[2] * V3[2] - V2[3] * V3[3] - V2[4] * V3[4] - V2[5] * V3[5]); 
  TMP0 = (V4[2] * V2[2] - V4[3] * V2[3] - V4[4] * V2[4] - V4[5] * V2[5]); 
  denom = COUP/(pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) - pow(P1[3], 2) -
      M1 * (M1 - cI * W1));
  V1[2] = denom * (OM1 * P1[0] * (-cI * (TMP0 * TMP4) + cI * (TMP11 * TMP16)) +
      (-cI * (V4[2] * TMP11) + cI * (V3[2] * TMP0)));
  V1[3] = denom * (OM1 * P1[1] * (-cI * (TMP0 * TMP4) + cI * (TMP11 * TMP16)) +
      (-cI * (V4[3] * TMP11) + cI * (V3[3] * TMP0)));
  V1[4] = denom * (OM1 * P1[2] * (-cI * (TMP0 * TMP4) + cI * (TMP11 * TMP16)) +
      (-cI * (V4[4] * TMP11) + cI * (V3[4] * TMP0)));
  V1[5] = denom * (OM1 * P1[3] * (-cI * (TMP0 * TMP4) + cI * (TMP11 * TMP16)) +
      (-cI * (V4[5] * TMP11) + cI * (V3[5] * TMP0)));
}
    ...
    complex<double> COUP, double M1, double W1, complex<double> V1[])
{
  ...
  denom = COUP/(pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) - pow(P1[3], 2) -
      M1 * (M1 - cI * W1));
  V1[2] = denom * (OM1 * P1[0] * (-cI * (TMP2 * TMP5) + cI * (TMP0 * TMP4)) +
      (-cI * (V3[2] * TMP0) + cI * (V2[2] * TMP2)));
  V1[3] = denom * (OM1 * P1[1] * (-cI * (TMP2 * TMP5) + cI * (TMP0 * TMP4)) +
      (-cI * (V3[3] * TMP0) + cI * (V2[3] * TMP2)));
  V1[4] = denom * (OM1 * P1[2] * (-cI * (TMP2 * TMP5) + cI * (TMP0 * TMP4)) +
      (-cI * (V3[4] * TMP0) + cI * (V2[4] * TMP2)));
  V1[5] = denom * (OM1 * P1[3] * (-cI * (TMP2 * TMP5) + cI * (TMP0 * TMP4)) +
      (-cI * (V3[5] * TMP0) + cI * (V2[5] * TMP2)));
}
    ...
    complex<double> V4[], complex<double> COUP, complex<double> & vertex)
{
  ...
  complex<double> TMP1; 
  TMP15 = (V4[2] * V1[2] - V4[3] * V1[3] - V4[4] * V1[4] - V4[5] * V1[5]); 
  TMP11 = (V2[2] * V3[2] - V2[3] * V3[3] - V2[4] * V3[4] - V2[5] * V3[5]); 
  TMP1 = (V3[2] * V1[2] - V3[3] * V1[3] - V3[4] * V1[4] - V3[5] * V1[5]); 
  TMP0 = (V4[2] * V2[2] - V4[3] * V2[3] - V4[4] * V2[4] - V4[5] * V2[5]); 
  vertex = COUP * (-cI * (TMP11 * TMP15) + cI * (TMP0 * TMP1)); 
}
    ...
    double M3, double W3, complex<double> V3[])
{
  ...
  P3[2] = -V3[1].imag(); 
  P3[3] = -V3[0].imag(); 
  TMP7 = (F1[2] * (F2[4] * (P3[0] + P3[3]) + F2[5] * (P3[1] + cI * (P3[2]))) +
    ...
    complex<double> COUP, complex<double> & vertex)
{
  ...
  TMP4 = (V3[2] * P1[0] - V3[3] * P1[1] - V3[4] * P1[2] - V3[5] * P1[3]); 
  TMP11 = (V2[2] * V3[2] - V2[3] * V3[3] - V2[4] * V3[4] - V2[5] * V3[5]); 
  TMP10 = (V1[2] * P2[0] - V1[3] * P2[1] - V1[4] * P2[2] - V1[5] * P2[3]); 
  TMP3 = (V2[2] * V1[2] - V2[3] * V1[3] - V2[4] * V1[4] - V2[5] * V1[5]); 
  TMP12 = (V1[2] * P3[0] - V1[3] * P3[1] - V1[4] * P3[2] - V1[5] * P3[3]); 
  vertex = COUP * (TMP1 * (-cI * (TMP9) + cI * (TMP5)) + (TMP11 * (-cI *
      (TMP10) + cI * (TMP12)) + TMP3 * (-cI * (TMP4) + cI * (TMP8))));
}
    ...
    complex<double> COUP, double M1, double W1, complex<double> V1[])
{
  ...
  denom = COUP/(pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) - pow(P1[3], 2) -
      M1 * (M1 - cI * W1));
  V1[2] = denom * (OM1 * P1[0] * (-cI * (TMP2 * TMP5) + cI * (TMP11 * TMP16)) +
      (-cI * (V4[2] * TMP11) + cI * (V2[2] * TMP2)));
  V1[3] = denom * (OM1 * P1[1] * (-cI * (TMP2 * TMP5) + cI * (TMP11 * TMP16)) +
      (-cI * (V4[3] * TMP11) + cI * (V2[3] * TMP2)));
  V1[4] = denom * (OM1 * P1[2] * (-cI * (TMP2 * TMP5) + cI * (TMP11 * TMP16)) +
      (-cI * (V4[4] * TMP11) + cI * (V2[4] * TMP2)));
  V1[5] = denom * (OM1 * P1[3] * (-cI * (TMP2 * TMP5) + cI * (TMP11 * TMP16)) +
      (-cI * (V4[5] * TMP11) + cI * (V2[5] * TMP2)));
}
    ...
    complex<double> V4[], complex<double> COUP, complex<double> & vertex)
{
  ...
  TMP3 = (V2[2] * V1[2] - V2[3] * V1[3] - V2[4] * V1[4] - V2[5] * V1[5]); 
  TMP2 = (V4[2] * V3[2] - V4[3] * V3[3] - V4[4] * V3[4] - V4[5] * V3[5]); 
  vertex = COUP * (-cI * (TMP11 * TMP15) + cI * (TMP2 * TMP3)); 
}
    ...
    double M1, double W1, complex<double> V1[])
{
  ...
  denom = COUP/(pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) - pow(P1[3], 2) -
      M1 * (M1 - cI * W1));
  V1[2] = denom * (OM1 * P1[0] * (TMP11 * (-cI * (TMP14) + cI * (TMP13)) + (-cI
      * (TMP5 * TMP8) + cI * (TMP4 * TMP9))) + (TMP11 * (-cI * (P2[0]) + cI *
      (P3[0])) + (V2[2] * (-cI * (TMP4) + cI * (TMP8)) + V3[2] * (-cI * (TMP9)
      + cI * (TMP5)))));
  V1[3] = denom * (OM1 * P1[1] * (TMP11 * (-cI * (TMP14) + cI * (TMP13)) + (-cI
      * (TMP5 * TMP8) + cI * (TMP4 * TMP9))) + (TMP11 * (-cI * (P2[1]) + cI *
      (P3[1])) + (V2[3] * (-cI * (TMP4) + cI * (TMP8)) + V3[3] * (-cI * (TMP9)
      + cI * (TMP5)))));
  V1[4] = denom * (OM1 * P1[2] * (TMP11 * (-cI * (TMP14) + cI * (TMP13)) + (-cI
      * (TMP5 * TMP8) + cI * (TMP4 * TMP9))) + (TMP11 * (-cI * (P2[2]) + cI *
      (P3[2])) + (V2[4] * (-cI * (TMP4) + cI * (TMP8)) + V3[4] * (-cI * (TMP9)
      + cI * (TMP5)))));
  V1[5] = denom * (OM1 * P1[3] * (TMP11 * (-cI * (TMP14) + cI * (TMP13)) + (-cI
      * (TMP5 * TMP8) + cI * (TMP4 * TMP9))) + (TMP11 * (-cI * (P2[3]) + cI *
      (P3[3])) + (V2[5] * (-cI * (TMP4) + cI * (TMP8)) + V3[5] * (-cI * (TMP9)
      + cI * (TMP5)))));
}
