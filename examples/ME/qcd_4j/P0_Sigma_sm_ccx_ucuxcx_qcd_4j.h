...
#ifndef MG5_Sigma_sm_ccx_ucuxcx_H
#define MG5_Sigma_sm_ccx_ucuxcx_H
...
class P0_Sigma_sm_ccx_ucuxcx_qcd_4j
{
  public:

    // Constructor.
    P0_Sigma_sm_ccx_ucuxcx_qcd_4j() {}
    ...
    virtual string name() const {return "c c~ > u c u~ c~ (sm)";}
...
#endif  // MG5_Sigma_sm_ccx_ucuxcx_H
