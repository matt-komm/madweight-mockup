...
#include "P0_Sigma_sm_gg_gguux_qcd_4j.h"
...
// Process: g g > g g u u~ WEIGHTED=4
// Process: g g > g g c c~ WEIGHTED=4
// Process: g g > g g d d~ WEIGHTED=4
// Process: g g > g g s s~ WEIGHTED=4

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_gg_gguux_qcd_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_gg_gguux_qcd_4j::sigmaKin() 
{
...
double P0_Sigma_sm_gg_gguux_qcd_4j::sigmaHat() 
{
...
void P0_Sigma_sm_gg_gguux_qcd_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_1(w[4], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[11]); 
  VVV1_1(w[6], w[3], pars->GC_10, pars->ZERO, pars->ZERO, w[12]); 
  FFV1_2(w[5], w[3], pars->GC_11, pars->ZERO, pars->ZERO, w[13]); 
  FFV1_2(w[5], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[14]); 
  FFV1_1(w[4], w[3], pars->GC_11, pars->ZERO, pars->ZERO, w[15]); 
  VVV1_1(w[6], w[2], pars->GC_10, pars->ZERO, pars->ZERO, w[16]); 
  VVV1_1(w[0], w[2], pars->GC_10, pars->ZERO, pars->ZERO, w[17]); 
  VVV1_1(w[1], w[3], pars->GC_10, pars->ZERO, pars->ZERO, w[18]); 
  FFV1_1(w[4], w[17], pars->GC_11, pars->ZERO, pars->ZERO, w[19]); 
  FFV1_2(w[5], w[17], pars->GC_11, pars->ZERO, pars->ZERO, w[20]); 
  FFV1_1(w[4], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[21]); 
  VVV1_1(w[17], w[3], pars->GC_10, pars->ZERO, pars->ZERO, w[22]); 
  FFV1_2(w[5], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[23]); 
  VVV1_1(w[17], w[1], pars->GC_10, pars->ZERO, pars->ZERO, w[24]); 
  VVV1_1(w[0], w[3], pars->GC_10, pars->ZERO, pars->ZERO, w[25]); 
  VVV1_1(w[1], w[2], pars->GC_10, pars->ZERO, pars->ZERO, w[26]); 
  FFV1_1(w[4], w[25], pars->GC_11, pars->ZERO, pars->ZERO, w[27]); 
  FFV1_2(w[5], w[25], pars->GC_11, pars->ZERO, pars->ZERO, w[28]); 
  VVV1_1(w[25], w[2], pars->GC_10, pars->ZERO, pars->ZERO, w[29]); 
  VVV1_1(w[25], w[1], pars->GC_10, pars->ZERO, pars->ZERO, w[30]); 
  FFV1_1(w[4], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[31]); 
  FFV1_1(w[31], w[3], pars->GC_11, pars->ZERO, pars->ZERO, w[32]); 
  FFV1_3(w[5], w[31], pars->GC_11, pars->ZERO, pars->ZERO, w[33]); 
  FFV1_1(w[31], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[34]); 
  FFV1_1(w[31], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[35]); 
  VVVV1_1(w[1], w[2], w[3], pars->GC_12, pars->ZERO, pars->ZERO, w[36]); 
  VVVV3_1(w[1], w[2], w[3], pars->GC_12, pars->ZERO, pars->ZERO, w[37]); 
  VVVV4_1(w[1], w[2], w[3], pars->GC_12, pars->ZERO, pars->ZERO, w[38]); 
  FFV1_2(w[5], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[39]); 
  FFV1_2(w[39], w[3], pars->GC_11, pars->ZERO, pars->ZERO, w[40]); 
  FFV1_3(w[39], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[41]); 
  FFV1_2(w[39], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[42]); 
  FFV1_2(w[39], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[43]); 
  VVV1_1(w[0], w[26], pars->GC_10, pars->ZERO, pars->ZERO, w[44]); 
  FFV1_1(w[15], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[45]); 
  FFV1_2(w[13], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[46]); 
  VVV1_1(w[0], w[10], pars->GC_10, pars->ZERO, pars->ZERO, w[47]); 
  VVV1_1(w[0], w[18], pars->GC_10, pars->ZERO, pars->ZERO, w[48]); 
  ...
  VVV1_1(w[0], w[7], pars->GC_10, pars->ZERO, pars->ZERO, w[52]); 
  FFV1_2(w[23], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[53]); 
  VVVV1_1(w[0], w[1], w[2], pars->GC_12, pars->ZERO, pars->ZERO, w[54]); 
  VVVV3_1(w[0], w[1], w[2], pars->GC_12, pars->ZERO, pars->ZERO, w[55]); 
  VVVV4_1(w[0], w[1], w[2], pars->GC_12, pars->ZERO, pars->ZERO, w[56]); 
  VVVV1_1(w[0], w[1], w[3], pars->GC_12, pars->ZERO, pars->ZERO, w[57]); 
  VVVV3_1(w[0], w[1], w[3], pars->GC_12, pars->ZERO, pars->ZERO, w[58]); 
  VVVV4_1(w[0], w[1], w[3], pars->GC_12, pars->ZERO, pars->ZERO, w[59]); 
  VVVV1_1(w[0], w[2], w[3], pars->GC_12, pars->ZERO, pars->ZERO, w[60]); 
  VVVV3_1(w[0], w[2], w[3], pars->GC_12, pars->ZERO, pars->ZERO, w[61]); 
  VVVV4_1(w[0], w[2], w[3], pars->GC_12, pars->ZERO, pars->ZERO, w[62]); 
  ...
  FFV1_0(w[9], w[15], w[2], pars->GC_11, amp[10]); 
  FFV1_0(w[13], w[4], w[16], pars->GC_11, amp[11]); 
  FFV1_0(w[13], w[8], w[2], pars->GC_11, amp[12]); 
  VVVV1_0(w[6], w[2], w[3], w[10], pars->GC_12, amp[13]); 
  VVVV3_0(w[6], w[2], w[3], w[10], pars->GC_12, amp[14]); 
  VVVV4_0(w[6], w[2], w[3], w[10], pars->GC_12, amp[15]); 
  VVV1_0(w[3], w[10], w[16], pars->GC_10, amp[16]); 
  VVV1_0(w[2], w[10], w[12], pars->GC_10, amp[17]); 
  FFV1_0(w[5], w[19], w[18], pars->GC_11, amp[18]); 
  FFV1_0(w[20], w[4], w[18], pars->GC_11, amp[19]); 
  VVV1_0(w[17], w[18], w[10], pars->GC_10, amp[20]); 
  FFV1_0(w[5], w[21], w[22], pars->GC_11, amp[21]); 
  FFV1_0(w[20], w[21], w[3], pars->GC_11, amp[22]); 
  FFV1_0(w[13], w[21], w[17], pars->GC_11, amp[23]); 
  FFV1_0(w[23], w[4], w[22], pars->GC_11, amp[24]); 
  FFV1_0(w[23], w[19], w[3], pars->GC_11, amp[25]); 
  FFV1_0(w[23], w[15], w[17], pars->GC_11, amp[26]); 
  FFV1_0(w[5], w[15], w[24], pars->GC_11, amp[27]); 
  FFV1_0(w[20], w[15], w[1], pars->GC_11, amp[28]); 
  FFV1_0(w[13], w[4], w[24], pars->GC_11, amp[29]); 
  FFV1_0(w[13], w[19], w[1], pars->GC_11, amp[30]); 
  VVVV1_0(w[17], w[1], w[3], w[10], pars->GC_12, amp[31]); 
  VVVV3_0(w[17], w[1], w[3], w[10], pars->GC_12, amp[32]); 
  VVVV4_0(w[17], w[1], w[3], w[10], pars->GC_12, amp[33]); 
  VVV1_0(w[3], w[10], w[24], pars->GC_10, amp[34]); 
  VVV1_0(w[1], w[10], w[22], pars->GC_10, amp[35]); 
  FFV1_0(w[5], w[27], w[26], pars->GC_11, amp[36]); 
  FFV1_0(w[28], w[4], w[26], pars->GC_11, amp[37]); 
  VVV1_0(w[25], w[26], w[10], pars->GC_10, amp[38]); 
  FFV1_0(w[5], w[21], w[29], pars->GC_11, amp[39]); 
  FFV1_0(w[28], w[21], w[2], pars->GC_11, amp[40]); 
  FFV1_0(w[14], w[21], w[25], pars->GC_11, amp[41]); 
  FFV1_0(w[23], w[4], w[29], pars->GC_11, amp[42]); 
  FFV1_0(w[23], w[27], w[2], pars->GC_11, amp[43]); 
  FFV1_0(w[23], w[11], w[25], pars->GC_11, amp[44]); 
  FFV1_0(w[5], w[11], w[30], pars->GC_11, amp[45]); 
  FFV1_0(w[28], w[11], w[1], pars->GC_11, amp[46]); 
  FFV1_0(w[14], w[4], w[30], pars->GC_11, amp[47]); 
  FFV1_0(w[14], w[27], w[1], pars->GC_11, amp[48]); 
  VVVV1_0(w[25], w[1], w[2], w[10], pars->GC_12, amp[49]); 
  VVVV3_0(w[25], w[1], w[2], w[10], pars->GC_12, amp[50]); 
  VVVV4_0(w[25], w[1], w[2], w[10], pars->GC_12, amp[51]); 
  VVV1_0(w[2], w[10], w[30], pars->GC_10, amp[52]); 
  VVV1_0(w[1], w[10], w[29], pars->GC_10, amp[53]); 
  FFV1_0(w[5], w[32], w[26], pars->GC_11, amp[54]); 
  VVV1_0(w[26], w[3], w[33], pars->GC_10, amp[55]); 
  FFV1_0(w[13], w[31], w[26], pars->GC_11, amp[56]); 
  FFV1_0(w[5], w[34], w[18], pars->GC_11, amp[57]); 
  VVV1_0(w[18], w[2], w[33], pars->GC_10, amp[58]); 
  FFV1_0(w[14], w[31], w[18], pars->GC_11, amp[59]); 
  FFV1_0(w[23], w[34], w[3], pars->GC_11, amp[60]); 
  FFV1_0(w[23], w[32], w[2], pars->GC_11, amp[61]); 
  FFV1_0(w[23], w[31], w[7], pars->GC_11, amp[62]); 
  FFV1_0(w[5], w[35], w[7], pars->GC_11, amp[63]); 
  VVV1_0(w[1], w[7], w[33], pars->GC_10, amp[64]); 
  FFV1_0(w[14], w[35], w[3], pars->GC_11, amp[65]); 
  FFV1_0(w[14], w[32], w[1], pars->GC_11, amp[66]); 
  FFV1_0(w[13], w[35], w[2], pars->GC_11, amp[67]); 
  FFV1_0(w[13], w[34], w[1], pars->GC_11, amp[68]); 
  FFV1_0(w[5], w[31], w[36], pars->GC_11, amp[69]); 
  FFV1_0(w[5], w[31], w[37], pars->GC_11, amp[70]); 
  FFV1_0(w[5], w[31], w[38], pars->GC_11, amp[71]); 
  FFV1_0(w[40], w[4], w[26], pars->GC_11, amp[72]); 
  VVV1_0(w[26], w[3], w[41], pars->GC_10, amp[73]); 
  FFV1_0(w[39], w[15], w[26], pars->GC_11, amp[74]); 
  FFV1_0(w[42], w[4], w[18], pars->GC_11, amp[75]); 
  VVV1_0(w[18], w[2], w[41], pars->GC_10, amp[76]); 
  FFV1_0(w[39], w[11], w[18], pars->GC_11, amp[77]); 
  FFV1_0(w[42], w[21], w[3], pars->GC_11, amp[78]); 
  FFV1_0(w[40], w[21], w[2], pars->GC_11, amp[79]); 
  FFV1_0(w[39], w[21], w[7], pars->GC_11, amp[80]); 
  FFV1_0(w[43], w[4], w[7], pars->GC_11, amp[81]); 
  VVV1_0(w[1], w[7], w[41], pars->GC_10, amp[82]); 
  FFV1_0(w[43], w[11], w[3], pars->GC_11, amp[83]); 
  FFV1_0(w[40], w[11], w[1], pars->GC_11, amp[84]); 
  FFV1_0(w[43], w[15], w[2], pars->GC_11, amp[85]); 
  FFV1_0(w[42], w[15], w[1], pars->GC_11, amp[86]); 
  FFV1_0(w[39], w[4], w[36], pars->GC_11, amp[87]); 
  FFV1_0(w[39], w[4], w[37], pars->GC_11, amp[88]); 
  FFV1_0(w[39], w[4], w[38], pars->GC_11, amp[89]); 
  FFV1_0(w[5], w[15], w[44], pars->GC_11, amp[90]); 
  FFV1_0(w[5], w[45], w[26], pars->GC_11, amp[91]); 
  FFV1_0(w[13], w[4], w[44], pars->GC_11, amp[92]); 
  FFV1_0(w[46], w[4], w[26], pars->GC_11, amp[93]); 
  VVVV1_0(w[0], w[26], w[3], w[10], pars->GC_12, amp[94]); 
  VVVV3_0(w[0], w[26], w[3], w[10], pars->GC_12, amp[95]); 
  VVVV4_0(w[0], w[26], w[3], w[10], pars->GC_12, amp[96]); 
  VVV1_0(w[3], w[10], w[44], pars->GC_10, amp[97]); 
  VVV1_0(w[26], w[3], w[47], pars->GC_10, amp[98]); 
  FFV1_0(w[5], w[11], w[48], pars->GC_11, amp[99]); 
  FFV1_0(w[5], w[49], w[18], pars->GC_11, amp[100]); 
  FFV1_0(w[14], w[4], w[48], pars->GC_11, amp[101]); 
  FFV1_0(w[50], w[4], w[18], pars->GC_11, amp[102]); 
  VVVV1_0(w[0], w[18], w[2], w[10], pars->GC_12, amp[103]); 
  VVVV3_0(w[0], w[18], w[2], w[10], pars->GC_12, amp[104]); 
  VVVV4_0(w[0], w[18], w[2], w[10], pars->GC_12, amp[105]); 
  VVV1_0(w[2], w[10], w[48], pars->GC_10, amp[106]); 
  VVV1_0(w[18], w[2], w[47], pars->GC_10, amp[107]); 
  FFV1_0(w[5], w[51], w[7], pars->GC_11, amp[108]); 
  FFV1_0(w[5], w[21], w[52], pars->GC_11, amp[109]); 
  FFV1_0(w[14], w[51], w[3], pars->GC_11, amp[110]); 
  FFV1_0(w[50], w[21], w[3], pars->GC_11, amp[111]); 
  FFV1_0(w[13], w[51], w[2], pars->GC_11, amp[112]); 
  FFV1_0(w[46], w[21], w[2], pars->GC_11, amp[113]); 
  FFV1_0(w[53], w[4], w[7], pars->GC_11, amp[114]); 
  FFV1_0(w[23], w[4], w[52], pars->GC_11, amp[115]); 
  FFV1_0(w[53], w[11], w[3], pars->GC_11, amp[116]); 
  FFV1_0(w[23], w[49], w[3], pars->GC_11, amp[117]); 
  FFV1_0(w[53], w[15], w[2], pars->GC_11, amp[118]); 
  FFV1_0(w[23], w[45], w[2], pars->GC_11, amp[119]); 
  ...
  FFV1_0(w[50], w[15], w[1], pars->GC_11, amp[127]); 
  FFV1_0(w[14], w[45], w[1], pars->GC_11, amp[128]); 
  FFV1_0(w[5], w[15], w[54], pars->GC_11, amp[129]); 
  FFV1_0(w[5], w[15], w[55], pars->GC_11, amp[130]); 
  FFV1_0(w[5], w[15], w[56], pars->GC_11, amp[131]); 
  FFV1_0(w[13], w[4], w[54], pars->GC_11, amp[132]); 
  FFV1_0(w[13], w[4], w[55], pars->GC_11, amp[133]); 
  FFV1_0(w[13], w[4], w[56], pars->GC_11, amp[134]); 
  VVV1_0(w[54], w[3], w[10], pars->GC_10, amp[135]); 
  VVV1_0(w[55], w[3], w[10], pars->GC_10, amp[136]); 
  VVV1_0(w[56], w[3], w[10], pars->GC_10, amp[137]); 
  FFV1_0(w[5], w[11], w[57], pars->GC_11, amp[138]); 
  FFV1_0(w[5], w[11], w[58], pars->GC_11, amp[139]); 
  FFV1_0(w[5], w[11], w[59], pars->GC_11, amp[140]); 
  FFV1_0(w[14], w[4], w[57], pars->GC_11, amp[141]); 
  FFV1_0(w[14], w[4], w[58], pars->GC_11, amp[142]); 
  FFV1_0(w[14], w[4], w[59], pars->GC_11, amp[143]); 
  VVV1_0(w[57], w[2], w[10], pars->GC_10, amp[144]); 
  VVV1_0(w[58], w[2], w[10], pars->GC_10, amp[145]); 
  VVV1_0(w[59], w[2], w[10], pars->GC_10, amp[146]); 
  FFV1_0(w[5], w[21], w[60], pars->GC_11, amp[147]); 
  FFV1_0(w[5], w[21], w[61], pars->GC_11, amp[148]); 
  FFV1_0(w[5], w[21], w[62], pars->GC_11, amp[149]); 
  FFV1_0(w[23], w[4], w[60], pars->GC_11, amp[150]); 
  FFV1_0(w[23], w[4], w[61], pars->GC_11, amp[151]); 
  FFV1_0(w[23], w[4], w[62], pars->GC_11, amp[152]); 
  VVV1_0(w[60], w[1], w[10], pars->GC_10, amp[153]); 
  VVV1_0(w[61], w[1], w[10], pars->GC_10, amp[154]); 
  VVV1_0(w[62], w[1], w[10], pars->GC_10, amp[155]); 
  VVV1_0(w[0], w[36], w[10], pars->GC_10, amp[156]); 
  VVV1_0(w[0], w[37], w[10], pars->GC_10, amp[157]); 
  VVV1_0(w[0], w[38], w[10], pars->GC_10, amp[158]); 

}
double P0_Sigma_sm_gg_gguux_qcd_4j::matrix_gg_gguux() 
{
  int i, j; 
  // Local variables
