...
#include "P0_Sigma_sm_uxcx_duxcxdx_qcd_4j.h"
...
void P0_Sigma_sm_uxcx_duxcxdx_qcd_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_uxcx_duxcxdx_qcd_4j::sigmaKin() 
{
...
double P0_Sigma_sm_uxcx_duxcxdx_qcd_4j::sigmaHat() 
{
...
void P0_Sigma_sm_uxcx_duxcxdx_qcd_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_2(w[3], w[7], pars->GC_11, pars->ZERO, pars->ZERO, w[13]); 
  FFV1_2(w[3], w[10], pars->GC_11, pars->ZERO, pars->ZERO, w[14]); 
  ...
  FFV1_0(w[13], w[0], w[10], pars->GC_11, amp[5]); 
  FFV1_0(w[14], w[0], w[7], pars->GC_11, amp[6]); 

}
double P0_Sigma_sm_uxcx_duxcxdx_qcd_4j::matrix_uxcx_duxcxdx() 
{
  int i, j; 
  // Local variables
  const int ngraphs = 7; 
