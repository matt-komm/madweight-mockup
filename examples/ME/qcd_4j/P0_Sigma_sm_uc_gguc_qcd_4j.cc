...
#include "P0_Sigma_sm_uc_gguc_qcd_4j.h"
...
void P0_Sigma_sm_uc_gguc_qcd_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_uc_gguc_qcd_4j::sigmaKin() 
{
...
double P0_Sigma_sm_uc_gguc_qcd_4j::sigmaHat() 
{
...
void P0_Sigma_sm_uc_gguc_qcd_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_2(w[1], w[3], pars->GC_11, pars->ZERO, pars->ZERO, w[17]); 
  FFV1_1(w[13], w[3], pars->GC_11, pars->ZERO, pars->ZERO, w[18]); 
  FFV1_1(w[5], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[19]); 
  FFV1_1(w[4], w[3], pars->GC_11, pars->ZERO, pars->ZERO, w[20]); 
  FFV1_3(w[1], w[19], pars->GC_11, pars->ZERO, pars->ZERO, w[21]); 
  ...
  FFV1_2(w[1], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[26]); 
  FFV1_3(w[26], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[27]); 
  ...
  FFV1_0(w[1], w[14], w[15], pars->GC_11, amp[5]); 
  FFV1_0(w[16], w[13], w[10], pars->GC_11, amp[6]); 
  FFV1_0(w[17], w[5], w[15], pars->GC_11, amp[7]); 
  ...
  FFV1_0(w[1], w[14], w[24], pars->GC_11, amp[16]); 
  FFV1_0(w[17], w[5], w[24], pars->GC_11, amp[17]); 
  ...
  FFV1_0(w[1], w[31], w[7], pars->GC_11, amp[27]); 
  FFV1_0(w[1], w[14], w[32], pars->GC_11, amp[28]); 
  FFV1_0(w[33], w[4], w[10], pars->GC_11, amp[29]); 
  FFV1_0(w[16], w[4], w[30], pars->GC_11, amp[30]); 
  FFV1_0(w[34], w[5], w[7], pars->GC_11, amp[31]); 
  FFV1_0(w[17], w[5], w[32], pars->GC_11, amp[32]); 
...
double P0_Sigma_sm_uc_gguc_qcd_4j::matrix_uc_gguc() 
{
  int i, j; 
  // Local variables
