...
#include "P0_Sigma_sm_uxux_cuxuxcx_qcd_4j.h"
...
void P0_Sigma_sm_uxux_cuxuxcx_qcd_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_uxux_cuxuxcx_qcd_4j::sigmaKin() 
{
...
double P0_Sigma_sm_uxux_cuxuxcx_qcd_4j::sigmaHat() 
{
...
void P0_Sigma_sm_uxux_cuxuxcx_qcd_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[3], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[13]); 
  FFV1_3(w[4], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[14]); 
  FFV1_1(w[2], w[13], pars->GC_11, pars->ZERO, pars->ZERO, w[15]); 
  ...
  FFV1_0(w[19], w[1], w[10], pars->GC_11, amp[10]); 
  FFV1_0(w[20], w[1], w[14], pars->GC_11, amp[11]); 
  FFV1_0(w[21], w[0], w[10], pars->GC_11, amp[12]); 
  FFV1_0(w[20], w[0], w[7], pars->GC_11, amp[13]); 

}
double P0_Sigma_sm_uxux_cuxuxcx_qcd_4j::matrix_uxux_cuxuxcx() 
{
  int i, j; 
  // Local variables
