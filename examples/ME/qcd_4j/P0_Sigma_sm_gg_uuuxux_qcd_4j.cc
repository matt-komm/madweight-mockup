...
#include "P0_Sigma_sm_gg_uuuxux_qcd_4j.h"
...
// Process: g g > u u u~ u~ WEIGHTED=4
// Process: g g > c c c~ c~ WEIGHTED=4
// Process: g g > d d d~ d~ WEIGHTED=4
// Process: g g > s s s~ s~ WEIGHTED=4

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_gg_uuuxux_qcd_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_gg_uuuxux_qcd_4j::sigmaKin() 
{
...
double P0_Sigma_sm_gg_uuuxux_qcd_4j::sigmaHat() 
{
...
void P0_Sigma_sm_gg_uuuxux_qcd_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[5], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[11]); 
  FFV1_2(w[4], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[12]); 
  FFV1_3(w[4], w[3], pars->GC_11, pars->ZERO, pars->ZERO, w[13]); 
  FFV1_1(w[2], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[14]); 
  FFV1_1(w[2], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[15]); 
  FFV1_1(w[3], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[16]); 
  FFV1_3(w[4], w[15], pars->GC_11, pars->ZERO, pars->ZERO, w[17]); 
  FFV1_3(w[5], w[15], pars->GC_11, pars->ZERO, pars->ZERO, w[18]); 
  FFV1_2(w[4], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[19]); 
  FFV1_2(w[5], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[20]); 
  FFV1_1(w[15], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[21]); 
  FFV1_1(w[3], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[22]); 
  FFV1_1(w[2], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[23]); 
  FFV1_3(w[4], w[22], pars->GC_11, pars->ZERO, pars->ZERO, w[24]); 
  FFV1_3(w[5], w[22], pars->GC_11, pars->ZERO, pars->ZERO, w[25]); 
  FFV1_1(w[22], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[26]); 
  FFV1_2(w[4], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[27]); 
  FFV1_3(w[27], w[3], pars->GC_11, pars->ZERO, pars->ZERO, w[28]); 
  FFV1_3(w[27], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[29]); 
  FFV1_2(w[27], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[30]); 
  FFV1_2(w[5], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[31]); 
  FFV1_3(w[31], w[3], pars->GC_11, pars->ZERO, pars->ZERO, w[32]); 
  FFV1_3(w[31], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[33]); 
  FFV1_2(w[31], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[34]); 
  ...
  FFV1_0(w[20], w[2], w[28], pars->GC_11, amp[35]); 
  FFV1_0(w[30], w[3], w[11], pars->GC_11, amp[36]); 
  VVV1_0(w[1], w[11], w[28], pars->GC_10, amp[37]); 
  FFV1_0(w[30], w[2], w[10], pars->GC_11, amp[38]); 
  VVV1_0(w[1], w[10], w[29], pars->GC_10, amp[39]); 
  ...
  FFV1_0(w[19], w[2], w[32], pars->GC_11, amp[45]); 
  ...
  FFV1_0(w[41], w[2], w[10], pars->GC_11, amp[60]); 
  FFV1_0(w[19], w[2], w[37], pars->GC_11, amp[61]); 
  ...
  VVV1_0(w[1], w[10], w[39], pars->GC_10, amp[69]); 
  ...
  VVV1_0(w[1], w[13], w[40], pars->GC_10, amp[74]); 
  VVV1_0(w[1], w[11], w[36], pars->GC_10, amp[75]); 

}
double P0_Sigma_sm_gg_uuuxux_qcd_4j::matrix_gg_uuuxux() 
{
  int i, j; 
  // Local variables
