...
#ifndef MG5_Sigma_sm_uc_ucccx_H
#define MG5_Sigma_sm_uc_ucccx_H
...
class P0_Sigma_sm_uc_ucccx_qcd_4j
{
  public:

    // Constructor.
    P0_Sigma_sm_uc_ucccx_qcd_4j() {}
