...
#include "P0_Sigma_sm_gu_gggu_qcd_4j.h"
...
void P0_Sigma_sm_gu_gggu_qcd_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_gu_gggu_qcd_4j::sigmaKin() 
{
...
double P0_Sigma_sm_gu_gggu_qcd_4j::sigmaHat() 
{
...
void P0_Sigma_sm_gu_gggu_qcd_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[1], w[31], pars->GC_11, pars->ZERO, pars->ZERO, w[33]); 
  ...
  FFV1_3(w[39], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[41]); 
...
double P0_Sigma_sm_gu_gggu_qcd_4j::matrix_gu_gggu() 
{
  int i, j; 
  // Local variables
