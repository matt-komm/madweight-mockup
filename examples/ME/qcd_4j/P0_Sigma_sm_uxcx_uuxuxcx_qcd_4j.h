...
#ifndef MG5_Sigma_sm_uxcx_uuxuxcx_H
#define MG5_Sigma_sm_uxcx_uuxuxcx_H
...
class P0_Sigma_sm_uxcx_uuxuxcx_qcd_4j
{
  public:

    // Constructor.
    P0_Sigma_sm_uxcx_uuxuxcx_qcd_4j() {}
...
#endif  // MG5_Sigma_sm_uxcx_uuxuxcx_H
