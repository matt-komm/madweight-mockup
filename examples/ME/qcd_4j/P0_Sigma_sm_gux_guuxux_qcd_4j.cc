...
#include "P0_Sigma_sm_gux_guuxux_qcd_4j.h"
...
void P0_Sigma_sm_gux_guuxux_qcd_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_gux_guuxux_qcd_4j::sigmaKin() 
{
...
double P0_Sigma_sm_gux_guuxux_qcd_4j::sigmaHat() 
{
...
void P0_Sigma_sm_gux_guuxux_qcd_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[5], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[11]); 
  FFV1_2(w[4], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[12]); 
  FFV1_3(w[4], w[3], pars->GC_11, pars->ZERO, pars->ZERO, w[13]); 
  FFV1_1(w[1], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[14]); 
  FFV1_1(w[1], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[15]); 
  FFV1_1(w[3], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[16]); 
  FFV1_3(w[4], w[15], pars->GC_11, pars->ZERO, pars->ZERO, w[17]); 
  FFV1_3(w[5], w[15], pars->GC_11, pars->ZERO, pars->ZERO, w[18]); 
  FFV1_2(w[4], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[19]); 
  FFV1_2(w[5], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[20]); 
  FFV1_1(w[15], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[21]); 
  FFV1_1(w[3], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[22]); 
  FFV1_1(w[1], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[23]); 
  ...
  FFV1_2(w[4], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[27]); 
  FFV1_3(w[27], w[3], pars->GC_11, pars->ZERO, pars->ZERO, w[28]); 
  ...
  FFV1_3(w[31], w[3], pars->GC_11, pars->ZERO, pars->ZERO, w[32]); 
  FFV1_3(w[31], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[33]); 
  ...
  FFV1_0(w[19], w[1], w[25], pars->GC_11, amp[22]); 
  FFV1_0(w[19], w[22], w[11], pars->GC_11, amp[23]); 
  FFV1_0(w[20], w[1], w[24], pars->GC_11, amp[24]); 
  ...
  FFV1_0(w[20], w[3], w[29], pars->GC_11, amp[34]); 
  FFV1_0(w[20], w[1], w[28], pars->GC_11, amp[35]); 
  FFV1_0(w[30], w[3], w[11], pars->GC_11, amp[36]); 
  VVV1_0(w[2], w[11], w[28], pars->GC_10, amp[37]); 
  FFV1_0(w[30], w[1], w[10], pars->GC_11, amp[38]); 
  ...
  FFV1_0(w[19], w[3], w[33], pars->GC_11, amp[44]); 
  FFV1_0(w[19], w[1], w[32], pars->GC_11, amp[45]); 
  FFV1_0(w[34], w[3], w[7], pars->GC_11, amp[46]); 
  VVV1_0(w[2], w[7], w[32], pars->GC_10, amp[47]); 
  FFV1_0(w[34], w[1], w[13], pars->GC_11, amp[48]); 
  ...
  FFV1_0(w[41], w[3], w[11], pars->GC_11, amp[58]); 
  FFV1_0(w[19], w[3], w[40], pars->GC_11, amp[59]); 
  FFV1_0(w[41], w[1], w[10], pars->GC_11, amp[60]); 
  FFV1_0(w[19], w[1], w[37], pars->GC_11, amp[61]); 
  FFV1_0(w[42], w[3], w[7], pars->GC_11, amp[62]); 
  FFV1_0(w[20], w[3], w[39], pars->GC_11, amp[63]); 
  FFV1_0(w[42], w[1], w[13], pars->GC_11, amp[64]); 
  FFV1_0(w[20], w[1], w[36], pars->GC_11, amp[65]); 
...
double P0_Sigma_sm_gux_guuxux_qcd_4j::matrix_gux_guuxux() 
{
  int i, j; 
  // Local variables
  ...
  jamp[0] = +1./2. * (+1./3. * amp[10] + amp[11] + 1./3. * amp[14] + amp[15] +
  ...
  jamp[1] = +1./2. * (-amp[10] - 1./3. * amp[11] - 1./3. * amp[12] - amp[13] -
  ...
  jamp[2] = +1./2. * (-std::complex<double> (0, 1) * amp[4] + amp[5] -
  ...
  jamp[3] = +1./2. * (+std::complex<double> (0, 1) * amp[1] - amp[2] + 1./3. *
      std::complex<double> (0, 1) * amp[6] + 1./3. * std::complex<double> (0,
  ...
  jamp[4] = +1./2. * (+std::complex<double> (0, 1) * amp[0] + amp[2] + 1./3. *
  ...
  jamp[9] = +1./2. * (-std::complex<double> (0, 1) * amp[0] - amp[2] - 1./3. *
      std::complex<double> (0, 1) * amp[3] - 1./3. * std::complex<double> (0,
  ...
  jamp[10] = +1./2. * (+std::complex<double> (0, 1) * amp[4] - amp[5] +
      std::complex<double> (0, 1) * amp[6] + 1./3. * std::complex<double> (0,
  ...
  jamp[11] = +1./2. * (-std::complex<double> (0, 1) * amp[1] + amp[2] - 1./3. *
      std::complex<double> (0, 1) * amp[6] - 1./3. * std::complex<double> (0,
