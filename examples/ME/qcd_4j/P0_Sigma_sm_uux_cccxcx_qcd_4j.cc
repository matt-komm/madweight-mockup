...
#include "P0_Sigma_sm_uux_cccxcx_qcd_4j.h"
...
// Process: u u~ > c c c~ c~ WEIGHTED=4
// Process: u u~ > d d d~ d~ WEIGHTED=4
// Process: u u~ > s s s~ s~ WEIGHTED=4
// Process: c c~ > u u u~ u~ WEIGHTED=4
// Process: c c~ > d d d~ d~ WEIGHTED=4
// Process: c c~ > s s s~ s~ WEIGHTED=4
// Process: d d~ > u u u~ u~ WEIGHTED=4
// Process: d d~ > c c c~ c~ WEIGHTED=4
// Process: d d~ > s s s~ s~ WEIGHTED=4
// Process: s s~ > u u u~ u~ WEIGHTED=4
// Process: s s~ > c c c~ c~ WEIGHTED=4
// Process: s s~ > d d d~ d~ WEIGHTED=4

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_uux_cccxcx_qcd_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_uux_cccxcx_qcd_4j::sigmaKin() 
{
...
double P0_Sigma_sm_uux_cccxcx_qcd_4j::sigmaHat() 
{
...
void P0_Sigma_sm_uux_cccxcx_qcd_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double P0_Sigma_sm_uux_cccxcx_qcd_4j::matrix_uux_cccxcx() 
{
  int i, j; 
  // Local variables
