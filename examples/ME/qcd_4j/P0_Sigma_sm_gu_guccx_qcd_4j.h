...
#ifndef MG5_Sigma_sm_gu_guccx_H
#define MG5_Sigma_sm_gu_guccx_H
...
class P0_Sigma_sm_gu_guccx_qcd_4j
{
  public:

    // Constructor.
    P0_Sigma_sm_gu_guccx_qcd_4j() {}
    ...
    virtual string name() const {return "g u > g u c c~ (sm)";}
