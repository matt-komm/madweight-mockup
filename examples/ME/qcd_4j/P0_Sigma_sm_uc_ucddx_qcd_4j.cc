...
#include "P0_Sigma_sm_uc_ucddx_qcd_4j.h"
...
void P0_Sigma_sm_uc_ucddx_qcd_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_uc_ucddx_qcd_4j::sigmaKin() 
{
...
double P0_Sigma_sm_uc_ucddx_qcd_4j::sigmaHat() 
{
...
void P0_Sigma_sm_uc_ucddx_qcd_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double P0_Sigma_sm_uc_ucddx_qcd_4j::matrix_uc_ucddx() 
{
  int i, j; 
  // Local variables
  const int ngraphs = 7; 
