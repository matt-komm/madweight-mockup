...
#include "P0_Sigma_sm_uxcx_gguxcx_qcd_4j.h"
...
void P0_Sigma_sm_uxcx_gguxcx_qcd_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_uxcx_gguxcx_qcd_4j::sigmaKin() 
{
...
double P0_Sigma_sm_uxcx_gguxcx_qcd_4j::sigmaHat() 
{
...
void P0_Sigma_sm_uxcx_gguxcx_qcd_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_1(w[0], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[11]); 
  FFV1_2(w[4], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[12]); 
  FFV1_1(w[0], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[13]); 
  FFV1_1(w[1], w[3], pars->GC_11, pars->ZERO, pars->ZERO, w[14]); 
  FFV1_3(w[4], w[13], pars->GC_11, pars->ZERO, pars->ZERO, w[15]); 
  FFV1_2(w[4], w[3], pars->GC_11, pars->ZERO, pars->ZERO, w[16]); 
  ...
  FFV1_1(w[0], w[3], pars->GC_11, pars->ZERO, pars->ZERO, w[20]); 
  FFV1_3(w[5], w[19], pars->GC_11, pars->ZERO, pars->ZERO, w[21]); 
  FFV1_1(w[19], w[3], pars->GC_11, pars->ZERO, pars->ZERO, w[22]); 
  FFV1_2(w[4], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[23]); 
  FFV1_3(w[23], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[24]); 
  ...
  FFV1_0(w[4], w[11], w[10], pars->GC_11, amp[3]); 
  FFV1_0(w[12], w[0], w[10], pars->GC_11, amp[4]); 
  FFV1_0(w[5], w[14], w[15], pars->GC_11, amp[5]); 
  FFV1_0(w[16], w[13], w[10], pars->GC_11, amp[6]); 
  FFV1_0(w[17], w[1], w[15], pars->GC_11, amp[7]); 
  FFV1_0(w[4], w[18], w[10], pars->GC_11, amp[8]); 
  VVV1_0(w[3], w[10], w[15], pars->GC_10, amp[9]); 
  FFV1_0(w[4], w[20], w[21], pars->GC_11, amp[10]); 
  FFV1_0(w[16], w[0], w[21], pars->GC_11, amp[11]); 
  ...
  FFV1_0(w[25], w[0], w[10], pars->GC_11, amp[18]); 
  VVV1_0(w[3], w[10], w[24], pars->GC_10, amp[19]); 
  FFV1_0(w[4], w[20], w[27], pars->GC_11, amp[20]); 
  FFV1_0(w[26], w[14], w[7], pars->GC_11, amp[21]); 
  FFV1_0(w[16], w[0], w[27], pars->GC_11, amp[22]); 
  FFV1_0(w[28], w[1], w[7], pars->GC_11, amp[23]); 
  VVV1_0(w[3], w[7], w[27], pars->GC_10, amp[24]); 
  FFV1_0(w[4], w[29], w[10], pars->GC_11, amp[25]); 
  FFV1_0(w[4], w[20], w[30], pars->GC_11, amp[26]); 
  FFV1_0(w[5], w[31], w[7], pars->GC_11, amp[27]); 
  FFV1_0(w[5], w[14], w[32], pars->GC_11, amp[28]); 
  FFV1_0(w[33], w[0], w[10], pars->GC_11, amp[29]); 
  FFV1_0(w[16], w[0], w[30], pars->GC_11, amp[30]); 
...
double P0_Sigma_sm_uxcx_gguxcx_qcd_4j::matrix_uxcx_gguxcx() 
{
  int i, j; 
  // Local variables
  ...
  jamp[4] = +1./2. * (+std::complex<double> (0, 1) * amp[1] - amp[2] +
  ...
  jamp[5] = +1./2. * (-std::complex<double> (0, 1) * amp[1] + amp[2] -
  ...
  jamp[6] = +1./2. * (-1./3. * std::complex<double> (0, 1) * amp[3] - 1./3. *
      ...
      1./3. * amp[29]);
  jamp[7] = +1./2. * (+1./3. * std::complex<double> (0, 1) * amp[3] + 1./3. *
  ...
  jamp[10] = +1./2. * (-amp[10] - amp[12] - std::complex<double> (0, 1) *
  ...
  jamp[11] = +1./2. * (+1./3. * amp[10] + 1./3. * amp[11] + 1./3. * amp[20] +
      1./3. * amp[22]);
