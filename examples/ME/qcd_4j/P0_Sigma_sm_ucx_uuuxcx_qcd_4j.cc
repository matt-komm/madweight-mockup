...
#include "P0_Sigma_sm_ucx_uuuxcx_qcd_4j.h"
...
void P0_Sigma_sm_ucx_uuuxcx_qcd_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_ucx_uuuxcx_qcd_4j::sigmaKin() 
{
...
double P0_Sigma_sm_ucx_uuuxcx_qcd_4j::sigmaHat() 
{
...
void P0_Sigma_sm_ucx_uuuxcx_qcd_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[4], w[3], pars->GC_11, pars->ZERO, pars->ZERO, w[7]); 
  ...
  FFV1_3(w[4], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[14]); 
...
double P0_Sigma_sm_ucx_uuuxcx_qcd_4j::matrix_ucx_uuuxcx() 
{
  int i, j; 
  // Local variables
