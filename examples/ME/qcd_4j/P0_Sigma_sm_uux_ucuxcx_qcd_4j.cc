...
#include "P0_Sigma_sm_uux_ucuxcx_qcd_4j.h"
...
// Process: u u~ > u c u~ c~ WEIGHTED=4
// Process: u u~ > u d u~ d~ WEIGHTED=4
// Process: u u~ > u s u~ s~ WEIGHTED=4
// Process: c c~ > c d c~ d~ WEIGHTED=4
// Process: c c~ > c s c~ s~ WEIGHTED=4
// Process: d d~ > d s d~ s~ WEIGHTED=4

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_uux_ucuxcx_qcd_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_uux_ucuxcx_qcd_4j::sigmaKin() 
{
...
double P0_Sigma_sm_uux_ucuxcx_qcd_4j::sigmaHat() 
{
...
void P0_Sigma_sm_uux_ucuxcx_qcd_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[0], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[13]); 
  FFV1_3(w[4], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[14]); 
  FFV1_1(w[3], w[13], pars->GC_11, pars->ZERO, pars->ZERO, w[15]); 
  FFV1_2(w[5], w[13], pars->GC_11, pars->ZERO, pars->ZERO, w[16]); 
  FFV1_2(w[4], w[13], pars->GC_11, pars->ZERO, pars->ZERO, w[17]); 
  FFV1_1(w[1], w[13], pars->GC_11, pars->ZERO, pars->ZERO, w[18]); 
  ...
  FFV1_0(w[16], w[3], w[14], pars->GC_11, amp[6]); 
  VVV1_0(w[13], w[14], w[10], pars->GC_10, amp[7]); 
  FFV1_0(w[17], w[1], w[10], pars->GC_11, amp[8]); 
  FFV1_0(w[4], w[18], w[10], pars->GC_11, amp[9]); 
  FFV1_0(w[19], w[2], w[10], pars->GC_11, amp[10]); 
  FFV1_0(w[20], w[2], w[14], pars->GC_11, amp[11]); 
  FFV1_0(w[21], w[1], w[10], pars->GC_11, amp[12]); 
  FFV1_0(w[20], w[1], w[7], pars->GC_11, amp[13]); 

}
double P0_Sigma_sm_uux_ucuxcx_qcd_4j::matrix_uux_ucuxcx() 
{
  int i, j; 
  // Local variables
