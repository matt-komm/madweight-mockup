...
#include "P0_Sigma_sm_uxcx_uuxuxcx_qcd_4j.h"
...
void P0_Sigma_sm_uxcx_uuxuxcx_qcd_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_uxcx_uuxuxcx_qcd_4j::sigmaKin() 
{
...
double P0_Sigma_sm_uxcx_uuxuxcx_qcd_4j::sigmaHat() 
{
...
void P0_Sigma_sm_uxcx_uuxuxcx_qcd_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[3], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[13]); 
  FFV1_3(w[4], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[14]); 
  FFV1_1(w[1], w[13], pars->GC_11, pars->ZERO, pars->ZERO, w[15]); 
  FFV1_2(w[5], w[13], pars->GC_11, pars->ZERO, pars->ZERO, w[16]); 
  FFV1_2(w[4], w[13], pars->GC_11, pars->ZERO, pars->ZERO, w[17]); 
  FFV1_1(w[0], w[13], pars->GC_11, pars->ZERO, pars->ZERO, w[18]); 
  FFV1_2(w[3], w[14], pars->GC_11, pars->ZERO, pars->ZERO, w[19]); 
  FFV1_2(w[3], w[10], pars->GC_11, pars->ZERO, pars->ZERO, w[20]); 
  FFV1_2(w[3], w[7], pars->GC_11, pars->ZERO, pars->ZERO, w[21]); 
  ...
  FFV1_0(w[11], w[2], w[10], pars->GC_11, amp[3]); 
  FFV1_0(w[4], w[12], w[10], pars->GC_11, amp[4]); 
  FFV1_0(w[5], w[15], w[14], pars->GC_11, amp[5]); 
  FFV1_0(w[16], w[1], w[14], pars->GC_11, amp[6]); 
  VVV1_0(w[13], w[14], w[10], pars->GC_10, amp[7]); 
  FFV1_0(w[17], w[0], w[10], pars->GC_11, amp[8]); 
  FFV1_0(w[4], w[18], w[10], pars->GC_11, amp[9]); 
  FFV1_0(w[19], w[2], w[10], pars->GC_11, amp[10]); 
  FFV1_0(w[20], w[2], w[14], pars->GC_11, amp[11]); 
  FFV1_0(w[21], w[0], w[10], pars->GC_11, amp[12]); 
  FFV1_0(w[20], w[0], w[7], pars->GC_11, amp[13]); 

}
double P0_Sigma_sm_uxcx_uuxuxcx_qcd_4j::matrix_uxcx_uuxuxcx() 
{
  int i, j; 
  // Local variables
  ...
  jamp[2] = +1./4. * (-amp[0] + std::complex<double> (0, 1) * amp[2] - amp[3] -
      ...
      amp[13]);
  jamp[3] = +1./4. * (+1./3. * amp[3] + 1./3. * amp[4] + 1./9. * amp[5] + 1./9.
      * amp[6] + 1./9. * amp[8] + 1./9. * amp[9] + 1./9. * amp[10] + 1./9. *
      amp[11] + 1./3. * amp[12] + 1./3. * amp[13]);
  jamp[4] = +1./4. * (+1./3. * amp[0] + 1./3. * amp[1] + amp[5] -
