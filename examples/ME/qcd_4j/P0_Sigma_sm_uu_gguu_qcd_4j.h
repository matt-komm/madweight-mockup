...
#ifndef MG5_Sigma_sm_uu_gguu_H
#define MG5_Sigma_sm_uu_gguu_H
...
class P0_Sigma_sm_uu_gguu_qcd_4j
{
  public:

    // Constructor.
    P0_Sigma_sm_uu_gguu_qcd_4j() {}
