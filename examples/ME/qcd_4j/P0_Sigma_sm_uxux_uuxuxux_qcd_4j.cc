...
#include "P0_Sigma_sm_uxux_uuxuxux_qcd_4j.h"
...
void P0_Sigma_sm_uxux_uuxuxux_qcd_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_uxux_uuxuxux_qcd_4j::sigmaKin() 
{
...
double P0_Sigma_sm_uxux_uuxuxux_qcd_4j::sigmaHat() 
{
...
void P0_Sigma_sm_uxux_uuxuxux_qcd_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[3], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[6]); 
  ...
  FFV1_3(w[5], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[10]); 
  FFV1_3(w[4], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[11]); 
  FFV1_1(w[1], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[12]); 
  FFV1_3(w[5], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[13]); 
  FFV1_2(w[4], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[14]); 
  FFV1_3(w[3], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[15]); 
  FFV1_3(w[4], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[16]); 
  FFV1_1(w[2], w[15], pars->GC_11, pars->ZERO, pars->ZERO, w[17]); 
  FFV1_2(w[5], w[15], pars->GC_11, pars->ZERO, pars->ZERO, w[18]); 
  FFV1_1(w[0], w[15], pars->GC_11, pars->ZERO, pars->ZERO, w[19]); 
  FFV1_3(w[5], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[20]); 
  FFV1_2(w[4], w[15], pars->GC_11, pars->ZERO, pars->ZERO, w[21]); 
  FFV1_3(w[3], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[22]); 
  FFV1_1(w[1], w[22], pars->GC_11, pars->ZERO, pars->ZERO, w[23]); 
  FFV1_2(w[5], w[22], pars->GC_11, pars->ZERO, pars->ZERO, w[24]); 
  FFV1_1(w[0], w[22], pars->GC_11, pars->ZERO, pars->ZERO, w[25]); 
  FFV1_2(w[4], w[22], pars->GC_11, pars->ZERO, pars->ZERO, w[26]); 
  FFV1_2(w[3], w[16], pars->GC_11, pars->ZERO, pars->ZERO, w[27]); 
  FFV1_2(w[3], w[13], pars->GC_11, pars->ZERO, pars->ZERO, w[28]); 
  FFV1_2(w[3], w[10], pars->GC_11, pars->ZERO, pars->ZERO, w[29]); 
  FFV1_2(w[3], w[7], pars->GC_11, pars->ZERO, pars->ZERO, w[30]); 
  FFV1_2(w[3], w[20], pars->GC_11, pars->ZERO, pars->ZERO, w[31]); 
  FFV1_2(w[3], w[11], pars->GC_11, pars->ZERO, pars->ZERO, w[32]); 
  ...
  FFV1_0(w[9], w[1], w[11], pars->GC_11, amp[4]); 
  VVV1_0(w[6], w[11], w[13], pars->GC_10, amp[5]); 
  FFV1_0(w[14], w[2], w[13], pars->GC_11, amp[6]); 
  FFV1_0(w[4], w[8], w[13], pars->GC_11, amp[7]); 
  FFV1_0(w[14], w[1], w[10], pars->GC_11, amp[8]); 
  FFV1_0(w[4], w[12], w[10], pars->GC_11, amp[9]); 
  FFV1_0(w[5], w[17], w[16], pars->GC_11, amp[10]); 
  FFV1_0(w[18], w[2], w[16], pars->GC_11, amp[11]); 
  VVV1_0(w[15], w[16], w[10], pars->GC_10, amp[12]); 
  FFV1_0(w[5], w[19], w[11], pars->GC_11, amp[13]); 
  FFV1_0(w[18], w[0], w[11], pars->GC_11, amp[14]); 
  VVV1_0(w[15], w[11], w[20], pars->GC_10, amp[15]); 
  FFV1_0(w[21], w[2], w[20], pars->GC_11, amp[16]); 
  FFV1_0(w[4], w[17], w[20], pars->GC_11, amp[17]); 
  FFV1_0(w[21], w[0], w[10], pars->GC_11, amp[18]); 
  FFV1_0(w[4], w[19], w[10], pars->GC_11, amp[19]); 
  FFV1_0(w[5], w[23], w[16], pars->GC_11, amp[20]); 
  FFV1_0(w[24], w[1], w[16], pars->GC_11, amp[21]); 
  VVV1_0(w[22], w[16], w[13], pars->GC_10, amp[22]); 
  FFV1_0(w[5], w[25], w[7], pars->GC_11, amp[23]); 
  FFV1_0(w[24], w[0], w[7], pars->GC_11, amp[24]); 
  VVV1_0(w[22], w[7], w[20], pars->GC_10, amp[25]); 
  FFV1_0(w[26], w[1], w[20], pars->GC_11, amp[26]); 
  FFV1_0(w[4], w[23], w[20], pars->GC_11, amp[27]); 
  FFV1_0(w[26], w[0], w[13], pars->GC_11, amp[28]); 
  FFV1_0(w[4], w[25], w[13], pars->GC_11, amp[29]); 
  FFV1_0(w[27], w[2], w[13], pars->GC_11, amp[30]); 
  FFV1_0(w[28], w[2], w[16], pars->GC_11, amp[31]); 
  FFV1_0(w[27], w[1], w[10], pars->GC_11, amp[32]); 
  FFV1_0(w[29], w[1], w[16], pars->GC_11, amp[33]); 
  FFV1_0(w[30], w[2], w[20], pars->GC_11, amp[34]); 
  FFV1_0(w[31], w[2], w[7], pars->GC_11, amp[35]); 
  FFV1_0(w[30], w[0], w[10], pars->GC_11, amp[36]); 
  FFV1_0(w[29], w[0], w[7], pars->GC_11, amp[37]); 
  FFV1_0(w[32], w[1], w[20], pars->GC_11, amp[38]); 
  FFV1_0(w[31], w[1], w[11], pars->GC_11, amp[39]); 
  FFV1_0(w[32], w[0], w[13], pars->GC_11, amp[40]); 
  FFV1_0(w[28], w[0], w[11], pars->GC_11, amp[41]); 

}
double P0_Sigma_sm_uxux_uuxuxux_qcd_4j::matrix_uxux_uuxuxux() 
{
  int i, j; 
  // Local variables
