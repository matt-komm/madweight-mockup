...
#ifndef MG5_Sigma_sm_uc_gguc_H
#define MG5_Sigma_sm_uc_gguc_H
...
class P0_Sigma_sm_uc_gguc_qcd_4j
{
  public:

    // Constructor.
    P0_Sigma_sm_uc_gguc_qcd_4j() {}
