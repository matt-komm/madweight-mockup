...
#include "P0_Sigma_sm_gux_gggux_qcd_4j.h"
...
// Process: g u~ > g g g u~ WEIGHTED=4
// Process: g c~ > g g g c~ WEIGHTED=4
// Process: g d~ > g g g d~ WEIGHTED=4
// Process: g s~ > g g g s~ WEIGHTED=4

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_gux_gggux_qcd_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_gux_gggux_qcd_4j::sigmaKin() 
{
...
double P0_Sigma_sm_gux_gggux_qcd_4j::sigmaHat() 
{
...
void P0_Sigma_sm_gux_gggux_qcd_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  VVV1_1(w[3], w[4], pars->GC_10, pars->ZERO, pars->ZERO, w[7]); 
  ...
  VVV1_1(w[6], w[4], pars->GC_10, pars->ZERO, pars->ZERO, w[12]); 
  FFV1_2(w[5], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[13]); 
  FFV1_2(w[5], w[3], pars->GC_11, pars->ZERO, pars->ZERO, w[14]); 
  FFV1_1(w[1], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[15]); 
  VVV1_1(w[6], w[3], pars->GC_10, pars->ZERO, pars->ZERO, w[16]); 
  VVV1_1(w[0], w[3], pars->GC_10, pars->ZERO, pars->ZERO, w[17]); 
  VVV1_1(w[2], w[4], pars->GC_10, pars->ZERO, pars->ZERO, w[18]); 
  FFV1_1(w[1], w[17], pars->GC_11, pars->ZERO, pars->ZERO, w[19]); 
  FFV1_2(w[5], w[17], pars->GC_11, pars->ZERO, pars->ZERO, w[20]); 
  FFV1_1(w[1], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[21]); 
  VVV1_1(w[17], w[4], pars->GC_10, pars->ZERO, pars->ZERO, w[22]); 
  FFV1_2(w[5], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[23]); 
  VVV1_1(w[17], w[2], pars->GC_10, pars->ZERO, pars->ZERO, w[24]); 
  VVV1_1(w[0], w[4], pars->GC_10, pars->ZERO, pars->ZERO, w[25]); 
  VVV1_1(w[2], w[3], pars->GC_10, pars->ZERO, pars->ZERO, w[26]); 
  FFV1_1(w[1], w[25], pars->GC_11, pars->ZERO, pars->ZERO, w[27]); 
  FFV1_2(w[5], w[25], pars->GC_11, pars->ZERO, pars->ZERO, w[28]); 
  VVV1_1(w[25], w[3], pars->GC_10, pars->ZERO, pars->ZERO, w[29]); 
  VVV1_1(w[25], w[2], pars->GC_10, pars->ZERO, pars->ZERO, w[30]); 
  FFV1_1(w[1], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[31]); 
  ...
  VVVV1_1(w[2], w[3], w[4], pars->GC_12, pars->ZERO, pars->ZERO, w[36]); 
  VVVV3_1(w[2], w[3], w[4], pars->GC_12, pars->ZERO, pars->ZERO, w[37]); 
  VVVV4_1(w[2], w[3], w[4], pars->GC_12, pars->ZERO, pars->ZERO, w[38]); 
  ...
  VVVV1_1(w[0], w[2], w[3], pars->GC_12, pars->ZERO, pars->ZERO, w[54]); 
  VVVV3_1(w[0], w[2], w[3], pars->GC_12, pars->ZERO, pars->ZERO, w[55]); 
  VVVV4_1(w[0], w[2], w[3], pars->GC_12, pars->ZERO, pars->ZERO, w[56]); 
  VVVV1_1(w[0], w[2], w[4], pars->GC_12, pars->ZERO, pars->ZERO, w[57]); 
  VVVV3_1(w[0], w[2], w[4], pars->GC_12, pars->ZERO, pars->ZERO, w[58]); 
  VVVV4_1(w[0], w[2], w[4], pars->GC_12, pars->ZERO, pars->ZERO, w[59]); 
  VVVV1_1(w[0], w[3], w[4], pars->GC_12, pars->ZERO, pars->ZERO, w[60]); 
  VVVV3_1(w[0], w[3], w[4], pars->GC_12, pars->ZERO, pars->ZERO, w[61]); 
  VVVV4_1(w[0], w[3], w[4], pars->GC_12, pars->ZERO, pars->ZERO, w[62]); 
...
double P0_Sigma_sm_gux_gggux_qcd_4j::matrix_gux_gggux() 
{
  int i, j; 
  // Local variables
