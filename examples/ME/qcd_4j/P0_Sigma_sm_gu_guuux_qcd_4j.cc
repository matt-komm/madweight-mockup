...
#include "P0_Sigma_sm_gu_guuux_qcd_4j.h"
...
// Process: g u > g u u u~ WEIGHTED=4
// Process: g c > g c c c~ WEIGHTED=4
// Process: g d > g d d d~ WEIGHTED=4
// Process: g s > g s s s~ WEIGHTED=4

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_gu_guuux_qcd_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_gu_guuux_qcd_4j::sigmaKin() 
{
...
double P0_Sigma_sm_gu_guuux_qcd_4j::sigmaHat() 
{
...
void P0_Sigma_sm_gu_guuux_qcd_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[5], w[3], pars->GC_11, pars->ZERO, pars->ZERO, w[11]); 
  FFV1_2(w[1], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[12]); 
  FFV1_3(w[1], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[13]); 
  FFV1_1(w[3], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[14]); 
  FFV1_1(w[3], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[15]); 
  FFV1_1(w[4], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[16]); 
  FFV1_3(w[1], w[15], pars->GC_11, pars->ZERO, pars->ZERO, w[17]); 
  FFV1_3(w[5], w[15], pars->GC_11, pars->ZERO, pars->ZERO, w[18]); 
  FFV1_2(w[1], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[19]); 
  FFV1_2(w[5], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[20]); 
  FFV1_1(w[15], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[21]); 
  FFV1_1(w[4], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[22]); 
  FFV1_1(w[3], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[23]); 
  FFV1_3(w[1], w[22], pars->GC_11, pars->ZERO, pars->ZERO, w[24]); 
  FFV1_3(w[5], w[22], pars->GC_11, pars->ZERO, pars->ZERO, w[25]); 
  FFV1_1(w[22], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[26]); 
  FFV1_2(w[1], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[27]); 
  FFV1_3(w[27], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[28]); 
  FFV1_3(w[27], w[3], pars->GC_11, pars->ZERO, pars->ZERO, w[29]); 
  FFV1_2(w[27], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[30]); 
  FFV1_2(w[5], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[31]); 
  FFV1_3(w[31], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[32]); 
  FFV1_3(w[31], w[3], pars->GC_11, pars->ZERO, pars->ZERO, w[33]); 
  FFV1_2(w[31], w[2], pars->GC_11, pars->ZERO, pars->ZERO, w[34]); 
  FFV1_1(w[23], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[35]); 
  VVV1_1(w[0], w[13], pars->GC_10, pars->ZERO, pars->ZERO, w[36]); 
  VVV1_1(w[0], w[10], pars->GC_10, pars->ZERO, pars->ZERO, w[37]); 
  FFV1_1(w[16], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[38]); 
  VVV1_1(w[0], w[7], pars->GC_10, pars->ZERO, pars->ZERO, w[39]); 
  VVV1_1(w[0], w[11], pars->GC_10, pars->ZERO, pars->ZERO, w[40]); 
  FFV1_2(w[19], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[41]); 
  FFV1_2(w[20], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[42]); 
  ...
  FFV1_0(w[1], w[8], w[11], pars->GC_11, amp[3]); 
  FFV1_0(w[12], w[4], w[11], pars->GC_11, amp[4]); 
  VVV1_0(w[6], w[11], w[13], pars->GC_10, amp[5]); 
  FFV1_0(w[5], w[14], w[13], pars->GC_11, amp[6]); 
  FFV1_0(w[9], w[3], w[13], pars->GC_11, amp[7]); 
  FFV1_0(w[1], w[14], w[10], pars->GC_11, amp[8]); 
  FFV1_0(w[12], w[3], w[10], pars->GC_11, amp[9]); 
  FFV1_0(w[5], w[16], w[17], pars->GC_11, amp[10]); 
  FFV1_0(w[1], w[16], w[18], pars->GC_11, amp[11]); 
  FFV1_0(w[19], w[4], w[18], pars->GC_11, amp[12]); 
  FFV1_0(w[19], w[15], w[10], pars->GC_11, amp[13]); 
  FFV1_0(w[20], w[4], w[17], pars->GC_11, amp[14]); 
  FFV1_0(w[20], w[15], w[13], pars->GC_11, amp[15]); 
  FFV1_0(w[5], w[21], w[13], pars->GC_11, amp[16]); 
  VVV1_0(w[2], w[13], w[18], pars->GC_10, amp[17]); 
  FFV1_0(w[1], w[21], w[10], pars->GC_11, amp[18]); 
  VVV1_0(w[2], w[10], w[17], pars->GC_10, amp[19]); 
  FFV1_0(w[5], w[23], w[24], pars->GC_11, amp[20]); 
  FFV1_0(w[1], w[23], w[25], pars->GC_11, amp[21]); 
  FFV1_0(w[19], w[3], w[25], pars->GC_11, amp[22]); 
  FFV1_0(w[19], w[22], w[11], pars->GC_11, amp[23]); 
  FFV1_0(w[20], w[3], w[24], pars->GC_11, amp[24]); 
  FFV1_0(w[20], w[22], w[7], pars->GC_11, amp[25]); 
  FFV1_0(w[5], w[26], w[7], pars->GC_11, amp[26]); 
  VVV1_0(w[2], w[7], w[25], pars->GC_10, amp[27]); 
  FFV1_0(w[1], w[26], w[11], pars->GC_11, amp[28]); 
  VVV1_0(w[2], w[11], w[24], pars->GC_10, amp[29]); 
  ...
  FFV1_0(w[20], w[4], w[29], pars->GC_11, amp[34]); 
  FFV1_0(w[20], w[3], w[28], pars->GC_11, amp[35]); 
  FFV1_0(w[30], w[4], w[11], pars->GC_11, amp[36]); 
  VVV1_0(w[2], w[11], w[28], pars->GC_10, amp[37]); 
  FFV1_0(w[30], w[3], w[10], pars->GC_11, amp[38]); 
  VVV1_0(w[2], w[10], w[29], pars->GC_10, amp[39]); 
  FFV1_0(w[1], w[23], w[32], pars->GC_11, amp[40]); 
  FFV1_0(w[31], w[23], w[13], pars->GC_11, amp[41]); 
  FFV1_0(w[1], w[16], w[33], pars->GC_11, amp[42]); 
  FFV1_0(w[31], w[16], w[7], pars->GC_11, amp[43]); 
  FFV1_0(w[19], w[4], w[33], pars->GC_11, amp[44]); 
  FFV1_0(w[19], w[3], w[32], pars->GC_11, amp[45]); 
  FFV1_0(w[34], w[4], w[7], pars->GC_11, amp[46]); 
  VVV1_0(w[2], w[7], w[32], pars->GC_10, amp[47]); 
  FFV1_0(w[34], w[3], w[13], pars->GC_11, amp[48]); 
  VVV1_0(w[2], w[13], w[33], pars->GC_10, amp[49]); 
  FFV1_0(w[5], w[35], w[13], pars->GC_11, amp[50]); 
  FFV1_0(w[5], w[23], w[36], pars->GC_11, amp[51]); 
  FFV1_0(w[1], w[35], w[10], pars->GC_11, amp[52]); 
  FFV1_0(w[1], w[23], w[37], pars->GC_11, amp[53]); 
  FFV1_0(w[5], w[38], w[7], pars->GC_11, amp[54]); 
  FFV1_0(w[5], w[16], w[39], pars->GC_11, amp[55]); 
  FFV1_0(w[1], w[38], w[11], pars->GC_11, amp[56]); 
  FFV1_0(w[1], w[16], w[40], pars->GC_11, amp[57]); 
  FFV1_0(w[41], w[4], w[11], pars->GC_11, amp[58]); 
  FFV1_0(w[19], w[4], w[40], pars->GC_11, amp[59]); 
  FFV1_0(w[41], w[3], w[10], pars->GC_11, amp[60]); 
  FFV1_0(w[19], w[3], w[37], pars->GC_11, amp[61]); 
  FFV1_0(w[42], w[4], w[7], pars->GC_11, amp[62]); 
  FFV1_0(w[20], w[4], w[39], pars->GC_11, amp[63]); 
  FFV1_0(w[42], w[3], w[13], pars->GC_11, amp[64]); 
  FFV1_0(w[20], w[3], w[36], pars->GC_11, amp[65]); 
  VVVV1_0(w[0], w[2], w[7], w[10], pars->GC_12, amp[66]); 
  VVVV3_0(w[0], w[2], w[7], w[10], pars->GC_12, amp[67]); 
  VVVV4_0(w[0], w[2], w[7], w[10], pars->GC_12, amp[68]); 
  VVV1_0(w[2], w[10], w[39], pars->GC_10, amp[69]); 
  VVV1_0(w[2], w[7], w[37], pars->GC_10, amp[70]); 
  VVVV1_0(w[0], w[2], w[11], w[13], pars->GC_12, amp[71]); 
  VVVV3_0(w[0], w[2], w[11], w[13], pars->GC_12, amp[72]); 
  VVVV4_0(w[0], w[2], w[11], w[13], pars->GC_12, amp[73]); 
  VVV1_0(w[2], w[13], w[40], pars->GC_10, amp[74]); 
  VVV1_0(w[2], w[11], w[36], pars->GC_10, amp[75]); 

}
double P0_Sigma_sm_gu_guuux_qcd_4j::matrix_gu_guuux() 
{
  int i, j; 
  // Local variables
  ...
  jamp[0] = +1./2. * (-std::complex<double> (0, 1) * amp[4] + amp[5] -
  ...
  jamp[4] = +1./2. * (+1./3. * amp[10] + amp[11] + 1./3. * amp[14] + amp[15] +
  ...
  jamp[5] = +1./2. * (-amp[10] - 1./3. * amp[11] - 1./3. * amp[12] - amp[13] -
  ...
  jamp[6] = +1./2. * (-1./3. * amp[20] - amp[21] - 1./3. * amp[24] - amp[25] -
  ...
  jamp[7] = +1./2. * (+amp[20] + 1./3. * amp[21] + 1./3. * amp[22] + amp[23] +
  ...
  jamp[8] = +1./2. * (+std::complex<double> (0, 1) * amp[4] - amp[5] +
      std::complex<double> (0, 1) * amp[6] + 1./3. * std::complex<double> (0,
