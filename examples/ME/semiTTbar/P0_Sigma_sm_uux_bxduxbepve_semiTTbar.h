...
#ifndef MG5_Sigma_sm_uux_bxduxbepve_H
#define MG5_Sigma_sm_uux_bxduxbepve_H
...
class P0_Sigma_sm_uux_bxduxbepve_semiTTbar
{
  public:

    // Constructor.
    P0_Sigma_sm_uux_bxduxbepve_semiTTbar() {}
    ...
    virtual string name() const {return "u u~ > b~ d u~ b e+ ve (sm)";}
  ...
  private:
    ...
    double matrix_uux_txt_tx_bxdux_t_bepve(); 
...
#endif  // MG5_Sigma_sm_uux_bxduxbepve_H
