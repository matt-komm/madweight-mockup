...
#ifndef MG5_Sigma_sm_uux_budxbxemvex_H
#define MG5_Sigma_sm_uux_budxbxemvex_H
...
class P0_Sigma_sm_uux_budxbxemvex_semiTTbar
{
  public:

    // Constructor.
    P0_Sigma_sm_uux_budxbxemvex_semiTTbar() {}
    ...
    virtual string name() const {return "u u~ > b u d~ b~ e- ve~ (sm)";}
  ...
  private:
    ...
    double matrix_uux_ttx_t_budx_tx_bxemvex(); 
...
#endif  // MG5_Sigma_sm_uux_budxbxemvex_H
