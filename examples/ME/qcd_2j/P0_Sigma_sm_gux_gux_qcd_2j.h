...
#ifndef MG5_Sigma_sm_gux_gux_H
#define MG5_Sigma_sm_gux_gux_H
...
class P0_Sigma_sm_gux_gux_qcd_2j
{
  public:

    // Constructor.
    P0_Sigma_sm_gux_gux_qcd_2j() {}
