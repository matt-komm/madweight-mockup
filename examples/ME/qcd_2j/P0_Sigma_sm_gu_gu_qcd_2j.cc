...
#include "P0_Sigma_sm_gu_gu_qcd_2j.h"
...
void P0_Sigma_sm_gu_gu_qcd_2j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_gu_gu_qcd_2j::sigmaKin() 
{
...
double P0_Sigma_sm_gu_gu_qcd_2j::sigmaHat() 
{
...
void P0_Sigma_sm_gu_gu_qcd_2j::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double P0_Sigma_sm_gu_gu_qcd_2j::matrix_gu_gu() 
{
  int i, j; 
  // Local variables
  const int ngraphs = 3; 
