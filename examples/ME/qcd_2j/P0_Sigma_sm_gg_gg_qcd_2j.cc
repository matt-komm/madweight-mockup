...
// Process: g g > g g WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_gg_gg_qcd_2j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_gg_gg_qcd_2j::sigmaKin() 
{
...
double P0_Sigma_sm_gg_gg_qcd_2j::sigmaHat() 
{
...
void P0_Sigma_sm_gg_gg_qcd_2j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  VVV1_1(w[0], w[2], pars->GC_10, pars->ZERO, pars->ZERO, w[5]); 
  VVV1_1(w[0], w[3], pars->GC_10, pars->ZERO, pars->ZERO, w[6]); 
...
double P0_Sigma_sm_gg_gg_qcd_2j::matrix_gg_gg() 
{
  int i, j; 
  // Local variables
  const int ngraphs = 6; 
