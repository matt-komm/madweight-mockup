    ...
    complex<double> V4[], complex<double> COUP, complex<double> & vertex)
{
  ...
  TMP6 = (V4[2] * V1[2] - V4[3] * V1[3] - V4[4] * V1[4] - V4[5] * V1[5]); 
  TMP1 = (V3[2] * V1[2] - V3[3] * V1[3] - V3[4] * V1[4] - V3[5] * V1[5]); 
  TMP0 = (V4[2] * V2[2] - V4[3] * V2[3] - V4[4] * V2[4] - V4[5] * V2[5]); 
  vertex = COUP * (-cI * (TMP6 * TMP7) + cI * (TMP0 * TMP1)); 
}
    ...
    complex<double> COUP, complex<double> & vertex)
{
  ...
  vertex = COUP * (TMP1 * (-cI * (TMP11) + cI * (TMP10)) + (TMP3 * (-cI *
      (TMP8) + cI * (TMP9)) + TMP7 * (-cI * (TMP12) + cI * (TMP13))));
}
    ...
    complex<double> V4[], complex<double> COUP, complex<double> & vertex)
{
  ...
  TMP3 = (V2[2] * V1[2] - V2[3] * V1[3] - V2[4] * V1[4] - V2[5] * V1[5]); 
  TMP2 = (V4[2] * V3[2] - V4[3] * V3[3] - V4[4] * V3[4] - V4[5] * V3[5]); 
  vertex = COUP * (-cI * (TMP6 * TMP7) + cI * (TMP2 * TMP3)); 
}
    ...
    double M1, double W1, complex<double> V1[])
{
  ...
  denom = COUP/(pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) - pow(P1[3], 2) -
      M1 * (M1 - cI * W1));
  V1[2] = denom * (OM1 * P1[0] * (TMP7 * (-cI * (TMP15) + cI * (TMP14)) + (-cI
      * (TMP9 * TMP10) + cI * (TMP8 * TMP11))) + (TMP7 * (-cI * (P2[0]) + cI *
      (P3[0])) + (V2[2] * (-cI * (TMP8) + cI * (TMP9)) + V3[2] * (-cI * (TMP11)
      + cI * (TMP10)))));
  V1[3] = denom * (OM1 * P1[1] * (TMP7 * (-cI * (TMP15) + cI * (TMP14)) + (-cI
      * (TMP9 * TMP10) + cI * (TMP8 * TMP11))) + (TMP7 * (-cI * (P2[1]) + cI *
      (P3[1])) + (V2[3] * (-cI * (TMP8) + cI * (TMP9)) + V3[3] * (-cI * (TMP11)
      + cI * (TMP10)))));
  V1[4] = denom * (OM1 * P1[2] * (TMP7 * (-cI * (TMP15) + cI * (TMP14)) + (-cI
      * (TMP9 * TMP10) + cI * (TMP8 * TMP11))) + (TMP7 * (-cI * (P2[2]) + cI *
      (P3[2])) + (V2[4] * (-cI * (TMP8) + cI * (TMP9)) + V3[4] * (-cI * (TMP11)
      + cI * (TMP10)))));
  V1[5] = denom * (OM1 * P1[3] * (TMP7 * (-cI * (TMP15) + cI * (TMP14)) + (-cI
      * (TMP9 * TMP10) + cI * (TMP8 * TMP11))) + (TMP7 * (-cI * (P2[3]) + cI *
      (P3[3])) + (V2[5] * (-cI * (TMP8) + cI * (TMP9)) + V3[5] * (-cI * (TMP11)
      + cI * (TMP10)))));
}
