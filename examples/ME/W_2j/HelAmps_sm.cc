    ...
    double M1, double W1, complex<double> V1[])
{
  ...
  denom = COUP/(pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) - pow(P1[3], 2) -
      M1 * (M1 - cI * W1));
  V1[2] = denom * (OM1 * P1[0] * (TMP6 * (-cI * (TMP8) + cI * (TMP7)) + (-cI *
      (TMP3 * TMP4) + cI * (TMP2 * TMP5))) + (TMP6 * (-cI * (P2[0]) + cI *
      (P3[0])) + (V2[2] * (-cI * (TMP2) + cI * (TMP4)) + V3[2] * (-cI * (TMP5)
      + cI * (TMP3)))));
  V1[3] = denom * (OM1 * P1[1] * (TMP6 * (-cI * (TMP8) + cI * (TMP7)) + (-cI *
      (TMP3 * TMP4) + cI * (TMP2 * TMP5))) + (TMP6 * (-cI * (P2[1]) + cI *
      (P3[1])) + (V2[3] * (-cI * (TMP2) + cI * (TMP4)) + V3[3] * (-cI * (TMP5)
      + cI * (TMP3)))));
  V1[4] = denom * (OM1 * P1[2] * (TMP6 * (-cI * (TMP8) + cI * (TMP7)) + (-cI *
      (TMP3 * TMP4) + cI * (TMP2 * TMP5))) + (TMP6 * (-cI * (P2[2]) + cI *
      (P3[2])) + (V2[4] * (-cI * (TMP2) + cI * (TMP4)) + V3[4] * (-cI * (TMP5)
      + cI * (TMP3)))));
  V1[5] = denom * (OM1 * P1[3] * (TMP6 * (-cI * (TMP8) + cI * (TMP7)) + (-cI *
      (TMP3 * TMP4) + cI * (TMP2 * TMP5))) + (TMP6 * (-cI * (P2[3]) + cI *
      (P3[3])) + (V2[5] * (-cI * (TMP2) + cI * (TMP4)) + V3[5] * (-cI * (TMP5)
      + cI * (TMP3)))));
}
