...
#include "P0_Sigma_sm_udx_mupvmgg_W_2j.h"
...
// Process: u d~ > w+ g g WEIGHTED=4
// *   Decay: w+ > mu+ vm WEIGHTED=2
// Process: c s~ > w+ g g WEIGHTED=4
// *   Decay: w+ > mu+ vm WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_udx_mupvmgg_W_2j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_udx_mupvmgg_W_2j::sigmaKin() 
{
...
double P0_Sigma_sm_udx_mupvmgg_W_2j::sigmaHat() 
{
...
void P0_Sigma_sm_udx_mupvmgg_W_2j::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double P0_Sigma_sm_udx_mupvmgg_W_2j::matrix_udx_wpgg_wp_mupvm() 
{
  int i, j; 
  // Local variables
  const int ngraphs = 8; 
