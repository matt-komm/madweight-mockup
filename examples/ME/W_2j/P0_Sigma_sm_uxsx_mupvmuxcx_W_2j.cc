...
#include "P0_Sigma_sm_uxsx_mupvmuxcx_W_2j.h"
...
void P0_Sigma_sm_uxsx_mupvmuxcx_W_2j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_uxsx_mupvmuxcx_W_2j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_uxsx_wpuxcx_wp_mupvm(); 
        ...
        t[1] = matrix_uxsx_wpuxcx_wp_mupvm(); 
        double tsum = 0; 
...
double P0_Sigma_sm_uxsx_mupvmuxcx_W_2j::sigmaHat() 
{
...
void P0_Sigma_sm_uxsx_mupvmuxcx_W_2j::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double P0_Sigma_sm_uxsx_mupvmuxcx_W_2j::matrix_uxsx_wpuxcx_wp_mupvm() 
{
  int i, j; 
  // Local variables
  const int ngraphs = 2; 
