...
#ifndef MG5_Sigma_sm_dd_mumvmxud_H
#define MG5_Sigma_sm_dd_mumvmxud_H
...
class P0_Sigma_sm_dd_mumvmxud_W_2j
{
  public:

    // Constructor.
    P0_Sigma_sm_dd_mumvmxud_W_2j() {}
  ...
  private:
    ...
    double matrix_dd_wmud_wm_mumvmx(); 
...
#endif  // MG5_Sigma_sm_dd_mumvmxud_H
