...
#ifndef MG5_Sigma_sm_dxdx_mupvmuxdx_H
#define MG5_Sigma_sm_dxdx_mupvmuxdx_H
...
class P0_Sigma_sm_dxdx_mupvmuxdx_W_2j
{
  public:

    // Constructor.
    P0_Sigma_sm_dxdx_mupvmuxdx_W_2j() {}
  ...
  private:
    ...
    double matrix_dxdx_wpuxdx_wp_mupvm(); 
...
#endif  // MG5_Sigma_sm_dxdx_mupvmuxdx_H
