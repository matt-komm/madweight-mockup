...
#include "P0_Sigma_sm_gg_mumvmxudx_W_2j.h"
...
// Process: g g > w- u d~ WEIGHTED=4
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: g g > w- c s~ WEIGHTED=4
// *   Decay: w- > mu- vm~ WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_gg_mumvmxudx_W_2j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_gg_mumvmxudx_W_2j::sigmaKin() 
{
...
double P0_Sigma_sm_gg_mumvmxudx_W_2j::sigmaHat() 
{
...
void P0_Sigma_sm_gg_mumvmxudx_W_2j::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double P0_Sigma_sm_gg_mumvmxudx_W_2j::matrix_gg_wmudx_wm_mumvmx() 
{
  int i, j; 
  // Local variables
  const int ngraphs = 8; 
