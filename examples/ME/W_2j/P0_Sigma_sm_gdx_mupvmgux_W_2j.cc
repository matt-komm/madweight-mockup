...
#include "P0_Sigma_sm_gdx_mupvmgux_W_2j.h"
...
void P0_Sigma_sm_gdx_mupvmgux_W_2j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_gdx_mupvmgux_W_2j::sigmaKin() 
{
...
double P0_Sigma_sm_gdx_mupvmgux_W_2j::sigmaHat() 
{
...
void P0_Sigma_sm_gdx_mupvmgux_W_2j::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double P0_Sigma_sm_gdx_mupvmgux_W_2j::matrix_gdx_wpgux_wp_mupvm() 
{
  int i, j; 
  // Local variables
  const int ngraphs = 8; 
