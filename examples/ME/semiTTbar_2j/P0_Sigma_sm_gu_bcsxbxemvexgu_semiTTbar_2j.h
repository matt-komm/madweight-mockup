...
#ifndef MG5_Sigma_sm_gu_bcsxbxemvexgu_H
#define MG5_Sigma_sm_gu_bcsxbxemvexgu_H
...
class P0_Sigma_sm_gu_bcsxbxemvexgu_semiTTbar_2j
{
  public:

    // Constructor.
    P0_Sigma_sm_gu_bcsxbxemvexgu_semiTTbar_2j() {}
    ...
    virtual string name() const {return "g u > b c s~ b~ e- ve~ g u (sm)";}
  ...
  private:
    ...
    double matrix_gu_ttxgu_t_bcsx_tx_bxemvex(); 
...
#endif  // MG5_Sigma_sm_gu_bcsxbxemvexgu_H
