...
#ifndef MG5_Sigma_sm_uux_bxduxbepveuux_H
#define MG5_Sigma_sm_uux_bxduxbepveuux_H
...
class P0_Sigma_sm_uux_bxduxbepveuux_semiTTbar_2j
{
  public:

    // Constructor.
    P0_Sigma_sm_uux_bxduxbepveuux_semiTTbar_2j() {}
  ...
  private:
    ...
    double matrix_uux_txtuux_tx_bxdux_t_bepve(); 
...
#endif  // MG5_Sigma_sm_uux_bxduxbepveuux_H
