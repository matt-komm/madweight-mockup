...
#ifndef MG5_Sigma_sm_uxux_budxbxemvexuxux_H
#define MG5_Sigma_sm_uxux_budxbxemvexuxux_H
...
class P0_Sigma_sm_uxux_budxbxemvexuxux_semiTTbar_2j
{
  public:

    // Constructor.
    P0_Sigma_sm_uxux_budxbxemvexuxux_semiTTbar_2j() {}
    ...
    virtual string name() const {return "u~ u~ > b u d~ b~ e- ve~ u~ u~ (sm)";}
  ...
  private:
    ...
    double matrix_uxux_ttxuxux_t_budx_tx_bxemvex(); 
...
#endif  // MG5_Sigma_sm_uxux_budxbxemvexuxux_H
