...
#ifndef MG5_Sigma_sm_uxcx_bxscxbepveuxcx_H
#define MG5_Sigma_sm_uxcx_bxscxbepveuxcx_H
...
class P0_Sigma_sm_uxcx_bxscxbepveuxcx_semiTTbar_2j
{
  public:

    // Constructor.
    P0_Sigma_sm_uxcx_bxscxbepveuxcx_semiTTbar_2j() {}
  ...
  private:
    ...
    double matrix_uxcx_txtuxcx_tx_bxscx_t_bepve(); 
...
#endif  // MG5_Sigma_sm_uxcx_bxscxbepveuxcx_H
