    ...
    double M3, double W3, complex<double> V3[])
{
  ...
  denom = COUP/(pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) - pow(P3[3], 2) -
      M3 * (M3 - cI * W3));
  V3[2] = denom * - cI * (F2[4] * F1[2] + F2[5] * F1[3] - P3[0] * OM3 * TMP11); 
  V3[3] = denom * - cI * (-F2[4] * F1[3] - F2[5] * F1[2] - P3[1] * OM3 *
      TMP11);
  V3[4] = denom * - cI * (-cI * (F2[5] * F1[2]) + cI * (F2[4] * F1[3]) - P3[2]
      * OM3 * TMP11);
  V3[5] = denom * - cI * (F2[5] * F1[3] - F2[4] * F1[2] - P3[3] * OM3 * TMP11); 
}
    ...
    complex<double> COUP, double M1, double W1, complex<double> V1[])
{
  ...
  P1[2] = -V1[1].imag(); 
  P1[3] = -V1[0].imag(); 
  TMP17 = (P1[0] * V4[2] - P1[1] * V4[3] - P1[2] * V4[4] - P1[3] * V4[5]); 
  TMP6 = (V3[2] * V2[2] - V3[3] * V2[3] - V3[4] * V2[4] - V3[5] * V2[5]); 
  TMP0 = (V3[2] * P1[0] - V3[3] * P1[1] - V3[4] * P1[2] - V3[5] * P1[3]); 
  TMP12 = (V2[2] * V4[2] - V2[3] * V4[3] - V2[4] * V4[4] - V2[5] * V4[5]); 
  denom = COUP/(pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) - pow(P1[3], 2) -
      M1 * (M1 - cI * W1));
  V1[2] = denom * (OM1 * P1[0] * (-cI * (TMP0 * TMP12) + cI * (TMP6 * TMP17)) +
      (-cI * (TMP6 * V4[2]) + cI * (V3[2] * TMP12)));
  V1[3] = denom * (OM1 * P1[1] * (-cI * (TMP0 * TMP12) + cI * (TMP6 * TMP17)) +
      (-cI * (TMP6 * V4[3]) + cI * (V3[3] * TMP12)));
  V1[4] = denom * (OM1 * P1[2] * (-cI * (TMP0 * TMP12) + cI * (TMP6 * TMP17)) +
      (-cI * (TMP6 * V4[4]) + cI * (V3[4] * TMP12)));
  V1[5] = denom * (OM1 * P1[3] * (-cI * (TMP0 * TMP12) + cI * (TMP6 * TMP17)) +
      (-cI * (TMP6 * V4[5]) + cI * (V3[5] * TMP12)));
}
    ...
    complex<double> V4[], complex<double> COUP, complex<double> & vertex)
{
  ...
  complex<double> TMP3; 
  TMP16 = (V1[2] * V4[2] - V1[3] * V4[3] - V1[4] * V4[4] - V1[5] * V4[5]); 
  TMP6 = (V3[2] * V2[2] - V3[3] * V2[3] - V3[4] * V2[4] - V3[5] * V2[5]); 
  TMP3 = (V3[2] * V1[2] - V3[3] * V1[3] - V3[4] * V1[4] - V3[5] * V1[5]); 
  TMP12 = (V2[2] * V4[2] - V2[3] * V4[3] - V2[4] * V4[4] - V2[5] * V4[5]); 
  vertex = COUP * (-cI * (TMP6 * TMP16) + cI * (TMP3 * TMP12)); 
}
    ...
    complex<double> V4[], complex<double> COUP, complex<double> & vertex)
{
  ...
  TMP1 = (V2[2] * V1[2] - V2[3] * V1[3] - V2[4] * V1[4] - V2[5] * V1[5]); 
  TMP3 = (V3[2] * V1[2] - V3[3] * V1[3] - V3[4] * V1[4] - V3[5] * V1[5]); 
  TMP13 = (V3[2] * V4[2] - V3[3] * V4[3] - V3[4] * V4[4] - V3[5] * V4[5]); 
  TMP12 = (V2[2] * V4[2] - V2[3] * V4[3] - V2[4] * V4[4] - V2[5] * V4[5]); 
  vertex = COUP * (-cI * (TMP3 * TMP12) + cI * (TMP1 * TMP13)); 
}
    ...
    double M3, double W3, complex<double> V3[])
{
  ...
  V3[2] = denom * - cI * (F2[2] * F1[4] + F2[3] * F1[5] + F2[4] * F1[2] + F2[5]
      * F1[3] - P3[0] * OM3 * TMP15);
  V3[3] = denom * - cI * (F2[2] * F1[5] + F2[3] * F1[4] - F2[4] * F1[3] - F2[5]
      * F1[2] - P3[1] * OM3 * TMP15);
  V3[4] = denom * - cI * (-cI * (F2[2] * F1[5] + F2[5] * F1[2]) + cI * (F2[3] *
      F1[4] + F2[4] * F1[3]) - P3[2] * OM3 * TMP15);
  V3[5] = denom * - cI * (F2[2] * F1[4] + F2[5] * F1[3] - F2[3] * F1[5] - F2[4]
      * F1[2] - P3[3] * OM3 * TMP15);
}
    ...
    complex<double> COUP, double M1, double W1, complex<double> V1[])
{
  ...
  denom = COUP/(pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) - pow(P1[3], 2) -
      M1 * (M1 - cI * W1));
  V1[2] = denom * (OM1 * P1[0] * (-cI * (TMP4 * TMP13) + cI * (TMP6 * TMP17)) +
      (-cI * (TMP6 * V4[2]) + cI * (V2[2] * TMP13)));
  V1[3] = denom * (OM1 * P1[1] * (-cI * (TMP4 * TMP13) + cI * (TMP6 * TMP17)) +
      (-cI * (TMP6 * V4[3]) + cI * (V2[3] * TMP13)));
  V1[4] = denom * (OM1 * P1[2] * (-cI * (TMP4 * TMP13) + cI * (TMP6 * TMP17)) +
      (-cI * (TMP6 * V4[4]) + cI * (V2[4] * TMP13)));
  V1[5] = denom * (OM1 * P1[3] * (-cI * (TMP4 * TMP13) + cI * (TMP6 * TMP17)) +
      (-cI * (TMP6 * V4[5]) + cI * (V2[5] * TMP13)));
}
    ...
    complex<double> V4[], complex<double> COUP, complex<double> & vertex)
{
  ...
  TMP13 = (V3[2] * V4[2] - V3[3] * V4[3] - V3[4] * V4[4] - V3[5] * V4[5]); 
  TMP6 = (V3[2] * V2[2] - V3[3] * V2[3] - V3[4] * V2[4] - V3[5] * V2[5]); 
  vertex = COUP * (-cI * (TMP6 * TMP16) + cI * (TMP1 * TMP13)); 
}
    ...
    double M1, double W1, complex<double> V1[])
{
  ...
  denom = COUP/(pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) - pow(P1[3], 2) -
      M1 * (M1 - cI * W1));
  V1[2] = denom * (OM1 * P1[0] * (TMP6 * (-cI * (TMP10) + cI * (TMP9)) + (-cI *
      (TMP2 * TMP4) + cI * (TMP0 * TMP5))) + (TMP6 * (-cI * (P2[0]) + cI *
      (P3[0])) + (V2[2] * (-cI * (TMP0) + cI * (TMP2)) + V3[2] * (-cI * (TMP5)
      + cI * (TMP4)))));
  V1[3] = denom * (OM1 * P1[1] * (TMP6 * (-cI * (TMP10) + cI * (TMP9)) + (-cI *
      (TMP2 * TMP4) + cI * (TMP0 * TMP5))) + (TMP6 * (-cI * (P2[1]) + cI *
      (P3[1])) + (V2[3] * (-cI * (TMP0) + cI * (TMP2)) + V3[3] * (-cI * (TMP5)
      + cI * (TMP4)))));
  V1[4] = denom * (OM1 * P1[2] * (TMP6 * (-cI * (TMP10) + cI * (TMP9)) + (-cI *
      (TMP2 * TMP4) + cI * (TMP0 * TMP5))) + (TMP6 * (-cI * (P2[2]) + cI *
      (P3[2])) + (V2[4] * (-cI * (TMP0) + cI * (TMP2)) + V3[4] * (-cI * (TMP5)
      + cI * (TMP4)))));
  V1[5] = denom * (OM1 * P1[3] * (TMP6 * (-cI * (TMP10) + cI * (TMP9)) + (-cI *
      (TMP2 * TMP4) + cI * (TMP0 * TMP5))) + (TMP6 * (-cI * (P2[3]) + cI *
      (P3[3])) + (V2[5] * (-cI * (TMP0) + cI * (TMP2)) + V3[5] * (-cI * (TMP5)
      + cI * (TMP4)))));
}
    ...
    complex<double> COUP, double M1, double W1, complex<double> V1[])
{
  ...
  denom = COUP/(pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) - pow(P1[3], 2) -
      M1 * (M1 - cI * W1));
  V1[2] = denom * (OM1 * P1[0] * (-cI * (TMP4 * TMP13) + cI * (TMP0 * TMP12)) +
      (-cI * (V3[2] * TMP12) + cI * (V2[2] * TMP13)));
  V1[3] = denom * (OM1 * P1[1] * (-cI * (TMP4 * TMP13) + cI * (TMP0 * TMP12)) +
      (-cI * (V3[3] * TMP12) + cI * (V2[3] * TMP13)));
  V1[4] = denom * (OM1 * P1[2] * (-cI * (TMP4 * TMP13) + cI * (TMP0 * TMP12)) +
      (-cI * (V3[4] * TMP12) + cI * (V2[4] * TMP13)));
  V1[5] = denom * (OM1 * P1[3] * (-cI * (TMP4 * TMP13) + cI * (TMP0 * TMP12)) +
      (-cI * (V3[5] * TMP12) + cI * (V2[5] * TMP13)));
}
