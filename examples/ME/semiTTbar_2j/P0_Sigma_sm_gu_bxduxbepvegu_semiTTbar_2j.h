...
#ifndef MG5_Sigma_sm_gu_bxduxbepvegu_H
#define MG5_Sigma_sm_gu_bxduxbepvegu_H
...
class P0_Sigma_sm_gu_bxduxbepvegu_semiTTbar_2j
{
  public:

    // Constructor.
    P0_Sigma_sm_gu_bxduxbepvegu_semiTTbar_2j() {}
  ...
  private:
    ...
    double matrix_gu_txtgu_tx_bxdux_t_bepve(); 
...
#endif  // MG5_Sigma_sm_gu_bxduxbepvegu_H
