...
#ifndef MG5_Sigma_sm_uux_bxscxbepveuux_H
#define MG5_Sigma_sm_uux_bxscxbepveuux_H
...
class P0_Sigma_sm_uux_bxscxbepveuux_semiTTbar_2j
{
  public:

    // Constructor.
    P0_Sigma_sm_uux_bxscxbepveuux_semiTTbar_2j() {}
  ...
  private:
    ...
    double matrix_uux_txtuux_tx_bxscx_t_bepve(); 
...
#endif  // MG5_Sigma_sm_uux_bxscxbepveuux_H
