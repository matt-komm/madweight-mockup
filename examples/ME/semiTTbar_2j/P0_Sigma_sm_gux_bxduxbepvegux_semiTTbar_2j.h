...
#ifndef MG5_Sigma_sm_gux_bxduxbepvegux_H
#define MG5_Sigma_sm_gux_bxduxbepvegux_H
...
class P0_Sigma_sm_gux_bxduxbepvegux_semiTTbar_2j
{
  public:

    // Constructor.
    P0_Sigma_sm_gux_bxduxbepvegux_semiTTbar_2j() {}
    ...
    virtual string name() const {return "g u~ > b~ d u~ b e+ ve g u~ (sm)";}
  ...
  private:
    ...
    double matrix_gux_txtgux_tx_bxdux_t_bepve(); 
...
#endif  // MG5_Sigma_sm_gux_bxduxbepvegux_H
