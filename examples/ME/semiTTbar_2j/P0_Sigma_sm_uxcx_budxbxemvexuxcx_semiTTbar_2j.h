...
#ifndef MG5_Sigma_sm_uxcx_budxbxemvexuxcx_H
#define MG5_Sigma_sm_uxcx_budxbxemvexuxcx_H
...
class P0_Sigma_sm_uxcx_budxbxemvexuxcx_semiTTbar_2j
{
  public:

    // Constructor.
    P0_Sigma_sm_uxcx_budxbxemvexuxcx_semiTTbar_2j() {}
  ...
  private:
    ...
    double matrix_uxcx_ttxuxcx_t_budx_tx_bxemvex(); 
...
#endif  // MG5_Sigma_sm_uxcx_budxbxemvexuxcx_H
