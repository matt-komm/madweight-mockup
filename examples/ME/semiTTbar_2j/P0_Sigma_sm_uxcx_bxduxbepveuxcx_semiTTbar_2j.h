...
#ifndef MG5_Sigma_sm_uxcx_bxduxbepveuxcx_H
#define MG5_Sigma_sm_uxcx_bxduxbepveuxcx_H
...
class P0_Sigma_sm_uxcx_bxduxbepveuxcx_semiTTbar_2j
{
  public:

    // Constructor.
    P0_Sigma_sm_uxcx_bxduxbepveuxcx_semiTTbar_2j() {}
  ...
  private:
    ...
    double matrix_uxcx_txtuxcx_tx_bxdux_t_bepve(); 
...
#endif  // MG5_Sigma_sm_uxcx_bxduxbepveuxcx_H
