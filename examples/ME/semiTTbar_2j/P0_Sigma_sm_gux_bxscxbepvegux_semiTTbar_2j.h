...
#ifndef MG5_Sigma_sm_gux_bxscxbepvegux_H
#define MG5_Sigma_sm_gux_bxscxbepvegux_H
...
class P0_Sigma_sm_gux_bxscxbepvegux_semiTTbar_2j
{
  public:

    // Constructor.
    P0_Sigma_sm_gux_bxscxbepvegux_semiTTbar_2j() {}
    ...
    virtual string name() const {return "g u~ > b~ s c~ b e+ ve g u~ (sm)";}
  ...
  private:
    ...
    double matrix_gux_txtgux_tx_bxscx_t_bepve(); 
...
#endif  // MG5_Sigma_sm_gux_bxscxbepvegux_H
