...
#include "P0_Sigma_sm_uc_bcsxbxemvexuc_semiTTbar_2j.h"
...
void P0_Sigma_sm_uc_bcsxbxemvexuc_semiTTbar_2j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_uc_bcsxbxemvexuc_semiTTbar_2j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_uc_ttxuc_t_bcsx_tx_bxemvex(); 
        ...
        t[1] = matrix_uc_ttxuc_t_bcsx_tx_bxemvex(); 
        double tsum = 0; 
...
double P0_Sigma_sm_uc_bcsxbxemvexuc_semiTTbar_2j::sigmaHat() 
{
...
void P0_Sigma_sm_uc_bcsxbxemvexuc_semiTTbar_2j::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double P0_Sigma_sm_uc_bcsxbxemvexuc_semiTTbar_2j::matrix_uc_ttxuc_t_bcsx_tx_bxemvex() 
{
  int i, j; 
  // Local variables
  const int ngraphs = 7; 
