...
#ifndef MG5_Sigma_sm_ucx_bxduxbepveucx_H
#define MG5_Sigma_sm_ucx_bxduxbepveucx_H
...
class P0_Sigma_sm_ucx_bxduxbepveucx_semiTTbar_2j
{
  public:

    // Constructor.
    P0_Sigma_sm_ucx_bxduxbepveucx_semiTTbar_2j() {}
  ...
  private:
    ...
    double matrix_ucx_txtucx_tx_bxdux_t_bepve(); 
...
#endif  // MG5_Sigma_sm_ucx_bxduxbepveucx_H
