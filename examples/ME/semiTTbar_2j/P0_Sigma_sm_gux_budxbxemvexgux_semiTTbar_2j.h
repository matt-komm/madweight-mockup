...
#ifndef MG5_Sigma_sm_gux_budxbxemvexgux_H
#define MG5_Sigma_sm_gux_budxbxemvexgux_H
...
class P0_Sigma_sm_gux_budxbxemvexgux_semiTTbar_2j
{
  public:

    // Constructor.
    P0_Sigma_sm_gux_budxbxemvexgux_semiTTbar_2j() {}
  ...
  private:
    ...
    double matrix_gux_ttxgux_t_budx_tx_bxemvex(); 
...
#endif  // MG5_Sigma_sm_gux_budxbxemvexgux_H
