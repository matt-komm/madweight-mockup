...
#ifndef MG5_Sigma_sm_uu_bxduxbepveuu_H
#define MG5_Sigma_sm_uu_bxduxbepveuu_H
...
class P0_Sigma_sm_uu_bxduxbepveuu_semiTTbar_2j
{
  public:

    // Constructor.
    P0_Sigma_sm_uu_bxduxbepveuu_semiTTbar_2j() {}
  ...
  private:
    ...
    double matrix_uu_txtuu_tx_bxdux_t_bepve(); 
...
#endif  // MG5_Sigma_sm_uu_bxduxbepveuu_H
