...
#ifndef MG5_Sigma_sm_uxux_bxduxbepveuxux_H
#define MG5_Sigma_sm_uxux_bxduxbepveuxux_H
...
class P0_Sigma_sm_uxux_bxduxbepveuxux_semiTTbar_2j
{
  public:

    // Constructor.
    P0_Sigma_sm_uxux_bxduxbepveuxux_semiTTbar_2j() {}
    ...
    virtual string name() const {return "u~ u~ > b~ d u~ b e+ ve u~ u~ (sm)";}
  ...
  private:
    ...
    double matrix_uxux_txtuxux_tx_bxdux_t_bepve(); 
...
#endif  // MG5_Sigma_sm_uxux_bxduxbepveuxux_H
