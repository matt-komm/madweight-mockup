...
#include "P0_Sigma_sm_uux_budxbxemvexbbx_semiTTbar_Hbb.h"
...
void P0_Sigma_sm_uux_budxbxemvexbbx_semiTTbar_Hbb::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_uux_budxbxemvexbbx_semiTTbar_Hbb::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_uux_ttxh_t_budx_tx_bxemvex_h_bbx(); 
        ...
        t[1] = matrix_uux_ttxh_t_budx_tx_bxemvex_h_bbx(); 
        double tsum = 0; 
...
double P0_Sigma_sm_uux_budxbxemvexbbx_semiTTbar_Hbb::sigmaHat() 
{
...
void P0_Sigma_sm_uux_budxbxemvexbbx_semiTTbar_Hbb::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double P0_Sigma_sm_uux_budxbxemvexbbx_semiTTbar_Hbb::matrix_uux_ttxh_t_budx_tx_bxemvex_h_bbx() 
{
  int i, j; 
  // Local variables
  const int ngraphs = 2; 
