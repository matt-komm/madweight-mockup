    ...
    double M3, double W3, complex<double> V3[])
{
  ...
  P3[2] = -V3[1].imag(); 
  P3[3] = -V3[0].imag(); 
  TMP9 = (F1[2] * (F2[4] * (P3[0] + P3[3]) + F2[5] * (P3[1] + cI * (P3[2]))) +
      (F1[3] * (F2[4] * (P3[1] - cI * (P3[2])) + F2[5] * (P3[0] - P3[3])) +
    ...
    complex<double> COUP, complex<double> & vertex)
{
  ...
  TMP11 = (F2[4] * F1[4] + F2[5] * F1[5]); 
  TMP10 = (F2[2] * F1[2] + F2[3] * F1[3]); 
  vertex = COUP * - S3[2] * (+cI * (TMP10 + TMP11)); 
}
    ...
    double M1, double W1, complex<double> V1[])
{
  ...
  TMP4 = (P3[0] * V2[2] - P3[1] * V2[3] - P3[2] * V2[4] - P3[3] * V2[5]); 
  ...
  denom = COUP/(pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) - pow(P1[3], 2) -
      M1 * (M1 - cI * W1));
  V1[2] = denom * (OM1 * P1[0] * (TMP5 * (-cI * (TMP7) + cI * (TMP6)) + (-cI *
      (TMP2 * TMP3) + cI * (TMP1 * TMP4))) + (TMP5 * (-cI * (P2[0]) + cI *
      (P3[0])) + (V2[2] * (-cI * (TMP1) + cI * (TMP3)) + V3[2] * (-cI * (TMP4)
      + cI * (TMP2)))));
  V1[3] = denom * (OM1 * P1[1] * (TMP5 * (-cI * (TMP7) + cI * (TMP6)) + (-cI *
      (TMP2 * TMP3) + cI * (TMP1 * TMP4))) + (TMP5 * (-cI * (P2[1]) + cI *
      (P3[1])) + (V2[3] * (-cI * (TMP1) + cI * (TMP3)) + V3[3] * (-cI * (TMP4)
      + cI * (TMP2)))));
  V1[4] = denom * (OM1 * P1[2] * (TMP5 * (-cI * (TMP7) + cI * (TMP6)) + (-cI *
      (TMP2 * TMP3) + cI * (TMP1 * TMP4))) + (TMP5 * (-cI * (P2[2]) + cI *
      (P3[2])) + (V2[4] * (-cI * (TMP1) + cI * (TMP3)) + V3[4] * (-cI * (TMP4)
      + cI * (TMP2)))));
  V1[5] = denom * (OM1 * P1[3] * (TMP5 * (-cI * (TMP7) + cI * (TMP6)) + (-cI *
      (TMP2 * TMP3) + cI * (TMP1 * TMP4))) + (TMP5 * (-cI * (P2[3]) + cI *
      (P3[3])) + (V2[5] * (-cI * (TMP1) + cI * (TMP3)) + V3[5] * (-cI * (TMP4)
      + cI * (TMP2)))));
}
