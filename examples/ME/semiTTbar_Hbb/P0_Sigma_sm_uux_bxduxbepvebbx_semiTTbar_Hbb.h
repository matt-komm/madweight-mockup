...
#ifndef MG5_Sigma_sm_uux_bxduxbepvebbx_H
#define MG5_Sigma_sm_uux_bxduxbepvebbx_H
...
class P0_Sigma_sm_uux_bxduxbepvebbx_semiTTbar_Hbb
{
  public:

    // Constructor.
    P0_Sigma_sm_uux_bxduxbepvebbx_semiTTbar_Hbb() {}
    ...
    virtual string name() const {return "u u~ > b~ d u~ b e+ ve b b~ (sm)";}
  ...
  private:
    ...
    double matrix_uux_txth_tx_bxdux_t_bepve_h_bbx(); 
...
#endif  // MG5_Sigma_sm_uux_bxduxbepvebbx_H
