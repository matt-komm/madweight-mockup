...
#include "P0_Sigma_sm_dcx_mumvmxuccxcx_W_4j.h"
...
// Process: d c~ > w- u c c~ c~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: d s~ > w- u s s~ s~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: s u~ > w- c u u~ u~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: s d~ > w- c d d~ d~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_dcx_mumvmxuccxcx_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_dcx_mumvmxuccxcx_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_dcx_wmuccxcx_wm_mumvmx(); 
        ...
        t[1] = matrix_dcx_wmuccxcx_wm_mumvmx(); 
        double tsum = 0; 
...
double P0_Sigma_sm_dcx_mumvmxuccxcx_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_dcx_mumvmxuccxcx_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[8], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[25]); 
  FFV1_1(w[5], w[24], pars->GC_11, pars->ZERO, pars->ZERO, w[26]); 
  FFV1_2(w[0], w[25], pars->GC_11, pars->ZERO, pars->ZERO, w[27]); 
  FFV1_2(w[0], w[24], pars->GC_11, pars->ZERO, pars->ZERO, w[28]); 
  ...
  FFV1_2(w[7], w[25], pars->GC_11, pars->ZERO, pars->ZERO, w[35]); 
  FFV1_1(w[6], w[25], pars->GC_11, pars->ZERO, pars->ZERO, w[36]); 
  FFV1_2(w[7], w[10], pars->GC_11, pars->ZERO, pars->ZERO, w[37]); 
  FFV1_1(w[1], w[10], pars->GC_11, pars->ZERO, pars->ZERO, w[38]); 
  ...
  FFV1_0(w[0], w[15], w[30], pars->GC_11, amp[14]); 
  FFV1_0(w[0], w[31], w[25], pars->GC_11, amp[15]); 
  FFV1_0(w[28], w[15], w[25], pars->GC_11, amp[16]); 
  FFV1_0(w[18], w[5], w[30], pars->GC_11, amp[17]); 
  FFV1_0(w[32], w[5], w[25], pars->GC_11, amp[18]); 
  FFV1_0(w[18], w[26], w[25], pars->GC_11, amp[19]); 
  FFV1_0(w[33], w[1], w[21], pars->GC_11, amp[20]); 
  FFV1_0(w[8], w[34], w[21], pars->GC_11, amp[21]); 
  FFV1_0(w[33], w[1], w[23], pars->GC_11, amp[22]); 
  FFV1_0(w[8], w[34], w[23], pars->GC_11, amp[23]); 
  FFV1_0(w[35], w[6], w[21], pars->GC_11, amp[24]); 
  FFV1_0(w[7], w[36], w[21], pars->GC_11, amp[25]); 
  FFV1_0(w[35], w[6], w[23], pars->GC_11, amp[26]); 
  FFV1_0(w[7], w[36], w[23], pars->GC_11, amp[27]); 
  FFV1_0(w[37], w[1], w[21], pars->GC_11, amp[28]); 
  FFV1_0(w[7], w[38], w[21], pars->GC_11, amp[29]); 
  FFV1_0(w[37], w[1], w[23], pars->GC_11, amp[30]); 
  FFV1_0(w[7], w[38], w[23], pars->GC_11, amp[31]); 

}
double P0_Sigma_sm_dcx_mumvmxuccxcx_W_4j::matrix_dcx_wmuccxcx_wm_mumvmx() 
{
  int i, j; 
  // Local variables
