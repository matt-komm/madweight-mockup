...
#include "P0_Sigma_sm_uux_mumvmxggudx_W_4j.h"
...
void P0_Sigma_sm_uux_mumvmxggudx_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_uux_mumvmxggudx_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_uux_wmggudx_wm_mumvmx(); 
        ...
        t[1] = matrix_uux_wmggudx_wm_mumvmx(); 
        double tsum = 0; 
...
double P0_Sigma_sm_uux_mumvmxggudx_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_uux_mumvmxggudx_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[39], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[56]); 
  ...
  FFV1_3(w[62], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[65]); 
  ...
  FFV1_0(w[24], w[1], w[57], pars->GC_11, amp[54]); 
  FFV1_0(w[39], w[1], w[55], pars->GC_11, amp[55]); 
  FFV1_0(w[43], w[1], w[53], pars->GC_11, amp[56]); 
  ...
  FFV1_0(w[69], w[1], w[48], pars->GC_11, amp[118]); 
  ...
  FFV1_0(w[43], w[1], w[78], pars->GC_11, amp[166]); 
...
double P0_Sigma_sm_uux_mumvmxggudx_W_4j::matrix_uux_wmggudx_wm_mumvmx() 
{
  int i, j; 
  // Local variables
