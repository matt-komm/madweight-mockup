...
#include "P0_Sigma_sm_us_mumvmxuucux_W_4j.h"
...
// Process: u s > w- u u c u~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: c d > w- c u c c~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: d s > w- d c d d~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_us_mumvmxuucux_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_us_mumvmxuucux_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_us_wmuucux_wm_mumvmx(); 
        ...
        t[1] = matrix_us_wmuucux_wm_mumvmx(); 
        double tsum = 0; 
...
double P0_Sigma_sm_us_mumvmxuucux_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_us_mumvmxuucux_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[18], w[7], pars->GC_11, pars->ZERO, pars->ZERO, w[23]); 
  FFV1_3(w[0], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[24]); 
  FFV1_3(w[8], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[25]); 
  FFV1_1(w[7], w[24], pars->GC_11, pars->ZERO, pars->ZERO, w[26]); 
  FFV1_2(w[1], w[25], pars->GC_11, pars->ZERO, pars->ZERO, w[27]); 
  FFV1_2(w[1], w[24], pars->GC_11, pars->ZERO, pars->ZERO, w[28]); 
  ...
  FFV1_2(w[8], w[24], pars->GC_11, pars->ZERO, pars->ZERO, w[33]); 
  FFV1_1(w[5], w[24], pars->GC_11, pars->ZERO, pars->ZERO, w[34]); 
  FFV1_2(w[0], w[25], pars->GC_11, pars->ZERO, pars->ZERO, w[35]); 
  FFV1_1(w[6], w[25], pars->GC_11, pars->ZERO, pars->ZERO, w[36]); 
  FFV1_2(w[0], w[10], pars->GC_11, pars->ZERO, pars->ZERO, w[37]); 
  FFV1_1(w[5], w[10], pars->GC_11, pars->ZERO, pars->ZERO, w[38]); 
  ...
  FFV1_0(w[1], w[15], w[30], pars->GC_11, amp[14]); 
  FFV1_0(w[1], w[31], w[25], pars->GC_11, amp[15]); 
  FFV1_0(w[28], w[15], w[25], pars->GC_11, amp[16]); 
  FFV1_0(w[18], w[7], w[30], pars->GC_11, amp[17]); 
  FFV1_0(w[32], w[7], w[25], pars->GC_11, amp[18]); 
  FFV1_0(w[18], w[26], w[25], pars->GC_11, amp[19]); 
  FFV1_0(w[33], w[5], w[21], pars->GC_11, amp[20]); 
  FFV1_0(w[8], w[34], w[21], pars->GC_11, amp[21]); 
  FFV1_0(w[33], w[5], w[23], pars->GC_11, amp[22]); 
  FFV1_0(w[8], w[34], w[23], pars->GC_11, amp[23]); 
  FFV1_0(w[35], w[6], w[21], pars->GC_11, amp[24]); 
  FFV1_0(w[0], w[36], w[21], pars->GC_11, amp[25]); 
  FFV1_0(w[35], w[6], w[23], pars->GC_11, amp[26]); 
  FFV1_0(w[0], w[36], w[23], pars->GC_11, amp[27]); 
  FFV1_0(w[37], w[5], w[21], pars->GC_11, amp[28]); 
  FFV1_0(w[0], w[38], w[21], pars->GC_11, amp[29]); 
  FFV1_0(w[37], w[5], w[23], pars->GC_11, amp[30]); 
  FFV1_0(w[0], w[38], w[23], pars->GC_11, amp[31]); 

}
double P0_Sigma_sm_us_mumvmxuucux_W_4j::matrix_us_wmuucux_wm_mumvmx() 
{
  int i, j; 
  // Local variables
