...
#include "P0_Sigma_sm_ud_mumvmxuuddx_W_4j.h"
...
void P0_Sigma_sm_ud_mumvmxuuddx_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_ud_mumvmxuuddx_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_ud_wmuuddx_wm_mumvmx(); 
        ...
        t[1] = matrix_ud_wmuuddx_wm_mumvmx(); 
        double tsum = 0; 
...
double P0_Sigma_sm_ud_mumvmxuuddx_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_ud_mumvmxuuddx_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[1], w[7], pars->GC_11, pars->ZERO, pars->ZERO, w[18]); 
  ...
  FFV1_2(w[1], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[26]); 
  FFV1_3(w[8], w[21], pars->GC_11, pars->ZERO, pars->ZERO, w[27]); 
  FFV1_3(w[1], w[21], pars->GC_11, pars->ZERO, pars->ZERO, w[28]); 
  FFV1_3(w[24], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[29]); 
  FFV1_1(w[6], w[14], pars->GC_11, pars->ZERO, pars->ZERO, w[30]); 
  FFV1_2(w[1], w[14], pars->GC_11, pars->ZERO, pars->ZERO, w[31]); 
  FFV1_3(w[0], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[32]); 
  FFV1_1(w[7], w[32], pars->GC_11, pars->ZERO, pars->ZERO, w[33]); 
  ...
  FFV1_2(w[1], w[32], pars->GC_11, pars->ZERO, pars->ZERO, w[44]); 
  FFV1_3(w[8], w[40], pars->GC_11, pars->ZERO, pars->ZERO, w[45]); 
  FFV1_3(w[1], w[40], pars->GC_11, pars->ZERO, pars->ZERO, w[46]); 
  ...
  FFV1_0(w[26], w[7], w[27], pars->GC_11, amp[13]); 
  FFV1_0(w[8], w[11], w[28], pars->GC_11, amp[14]); 
  FFV1_0(w[1], w[11], w[27], pars->GC_11, amp[15]); 
  FFV1_0(w[13], w[7], w[28], pars->GC_11, amp[16]); 
  FFV1_0(w[26], w[21], w[14], pars->GC_11, amp[17]); 
  FFV1_0(w[1], w[23], w[14], pars->GC_11, amp[18]); 
  FFV1_0(w[1], w[21], w[17], pars->GC_11, amp[19]); 
  FFV1_0(w[26], w[7], w[29], pars->GC_11, amp[20]); 
  FFV1_0(w[1], w[11], w[29], pars->GC_11, amp[21]); 
  FFV2_0(w[26], w[30], w[4], pars->GC_100, amp[22]); 
  FFV2_0(w[31], w[16], w[4], pars->GC_100, amp[23]); 
  FFV1_0(w[8], w[33], w[34], pars->GC_11, amp[24]); 
  FFV1_0(w[35], w[7], w[34], pars->GC_11, amp[25]); 
  ...
  FFV1_0(w[44], w[7], w[45], pars->GC_11, amp[37]); 
  FFV1_0(w[8], w[33], w[46], pars->GC_11, amp[38]); 
  FFV1_0(w[1], w[33], w[45], pars->GC_11, amp[39]); 
  FFV1_0(w[35], w[7], w[46], pars->GC_11, amp[40]); 
  FFV1_0(w[44], w[40], w[14], pars->GC_11, amp[41]); 
  FFV1_0(w[1], w[42], w[14], pars->GC_11, amp[42]); 
  FFV1_0(w[1], w[40], w[38], pars->GC_11, amp[43]); 
  FFV1_0(w[44], w[7], w[47], pars->GC_11, amp[44]); 
  FFV1_0(w[1], w[33], w[47], pars->GC_11, amp[45]); 
...
double P0_Sigma_sm_ud_mumvmxuuddx_W_4j::matrix_ud_wmuuddx_wm_mumvmx() 
{
  int i, j; 
  // Local variables
