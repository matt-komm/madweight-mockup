...
#include "P0_Sigma_sm_uu_mupvmudddx_W_4j.h"
...
// Process: u u > w+ u d d d~ WEIGHTED=6
// *   Decay: w+ > mu+ vm WEIGHTED=2
// Process: c c > w+ c s s s~ WEIGHTED=6
// *   Decay: w+ > mu+ vm WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_uu_mupvmudddx_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_uu_mupvmudddx_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_uu_wpudddx_wp_mupvm(); 
...
double P0_Sigma_sm_uu_mupvmudddx_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_uu_mupvmudddx_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_2(w[1], w[16], pars->GC_11, pars->ZERO, pars->ZERO, w[21]); 
  ...
  FFV2_2(w[1], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[26]); 
  ...
  FFV1_3(w[1], w[35], pars->GC_11, pars->ZERO, pars->ZERO, w[36]); 
  FFV1_2(w[1], w[25], pars->GC_11, pars->ZERO, pars->ZERO, w[37]); 
  FFV1_1(w[35], w[25], pars->GC_11, pars->ZERO, pars->ZERO, w[38]); 
  FFV2_1(w[7], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[39]); 
  FFV1_3(w[1], w[39], pars->GC_11, pars->ZERO, pars->ZERO, w[40]); 
  ...
  FFV1_0(w[1], w[22], w[14], pars->GC_11, amp[11]); 
  FFV1_0(w[23], w[5], w[11], pars->GC_11, amp[12]); 
  FFV1_0(w[1], w[24], w[11], pars->GC_11, amp[13]); 
  ...
  FFV1_0(w[1], w[38], w[19], pars->GC_11, amp[27]); 
  FFV1_0(w[1], w[35], w[34], pars->GC_11, amp[28]); 
  FFV1_0(w[8], w[27], w[40], pars->GC_11, amp[29]); 
  FFV1_0(w[31], w[6], w[40], pars->GC_11, amp[30]); 
  FFV1_0(w[37], w[39], w[16], pars->GC_11, amp[31]); 
  FFV1_0(w[1], w[41], w[16], pars->GC_11, amp[32]); 
  FFV1_0(w[1], w[39], w[33], pars->GC_11, amp[33]); 
