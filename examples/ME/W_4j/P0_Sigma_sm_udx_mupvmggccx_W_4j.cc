...
#include "P0_Sigma_sm_udx_mupvmggccx_W_4j.h"
...
// Process: u d~ > w+ g g c c~ WEIGHTED=6
// *   Decay: w+ > mu+ vm WEIGHTED=2
// Process: u d~ > w+ g g s s~ WEIGHTED=6
// *   Decay: w+ > mu+ vm WEIGHTED=2
// Process: c s~ > w+ g g u u~ WEIGHTED=6
// *   Decay: w+ > mu+ vm WEIGHTED=2
// Process: c s~ > w+ g g d d~ WEIGHTED=6
// *   Decay: w+ > mu+ vm WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_udx_mupvmggccx_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_udx_mupvmggccx_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_udx_wpggccx_wp_mupvm(); 
        ...
        t[1] = matrix_udx_wpggccx_wp_mupvm(); 
        double tsum = 0; 
...
double P0_Sigma_sm_udx_mupvmggccx_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_udx_mupvmggccx_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[30], w[7], pars->GC_11, pars->ZERO, pars->ZERO, w[41]); 
  ...
  FFV1_3(w[49], w[7], pars->GC_11, pars->ZERO, pars->ZERO, w[51]); 
  ...
  FFV1_0(w[30], w[7], w[39], pars->GC_11, amp[29]); 
  ...
  FFV1_0(w[30], w[7], w[46], pars->GC_11, amp[41]); 
  ...
  FFV1_0(w[52], w[7], w[12], pars->GC_11, amp[54]); 
  FFV1_0(w[0], w[33], w[51], pars->GC_11, amp[55]); 
  VVV1_0(w[51], w[6], w[12], pars->GC_10, amp[56]); 
  FFV1_0(w[52], w[7], w[19], pars->GC_11, amp[57]); 
  ...
  FFV1_0(w[59], w[7], w[12], pars->GC_11, amp[78]); 
  FFV1_0(w[0], w[54], w[41], pars->GC_11, amp[79]); 
  VVV1_0(w[5], w[41], w[12], pars->GC_10, amp[80]); 
  FFV1_0(w[59], w[7], w[19], pars->GC_11, amp[81]); 
...
double P0_Sigma_sm_udx_mupvmggccx_W_4j::matrix_udx_wpggccx_wp_mupvm() 
{
  int i, j; 
  // Local variables
  ...
  jamp[8] = +1./2. * (-amp[12] - amp[13] - amp[16] - amp[17] - amp[19] -
  ...
  jamp[9] = +1./2. * (+1./3. * amp[12] + 1./3. * amp[13] + 1./3. * amp[14] +
