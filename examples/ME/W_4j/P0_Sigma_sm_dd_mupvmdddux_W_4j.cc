...
#include "P0_Sigma_sm_dd_mupvmdddux_W_4j.h"
...
// Process: d d > w+ d d d u~ WEIGHTED=6
// *   Decay: w+ > mu+ vm WEIGHTED=2
// Process: s s > w+ s s s c~ WEIGHTED=6
// *   Decay: w+ > mu+ vm WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_dd_mupvmdddux_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_dd_mupvmdddux_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_dd_wpdddux_wp_mupvm(); 
...
double P0_Sigma_sm_dd_mupvmdddux_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_dd_mupvmdddux_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV2_2(w[8], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[9]); 
  FFV1_3(w[0], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[10]); 
  FFV1_3(w[9], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[11]); 
  FFV1_1(w[7], w[10], pars->GC_11, pars->ZERO, pars->ZERO, w[12]); 
  FFV1_2(w[1], w[10], pars->GC_11, pars->ZERO, pars->ZERO, w[13]); 
  FFV1_3(w[9], w[7], pars->GC_11, pars->ZERO, pars->ZERO, w[14]); 
  FFV1_1(w[6], w[10], pars->GC_11, pars->ZERO, pars->ZERO, w[15]); 
  ...
  FFV1_3(w[0], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[21]); 
  FFV1_3(w[9], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[22]); 
  FFV1_1(w[7], w[21], pars->GC_11, pars->ZERO, pars->ZERO, w[23]); 
  FFV1_2(w[1], w[21], pars->GC_11, pars->ZERO, pars->ZERO, w[24]); 
  FFV1_1(w[5], w[21], pars->GC_11, pars->ZERO, pars->ZERO, w[25]); 
  FFV1_3(w[1], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[26]); 
  FFV1_2(w[9], w[21], pars->GC_11, pars->ZERO, pars->ZERO, w[27]); 
  FFV1_2(w[9], w[26], pars->GC_11, pars->ZERO, pars->ZERO, w[28]); 
  FFV1_3(w[0], w[7], pars->GC_11, pars->ZERO, pars->ZERO, w[29]); 
  FFV1_1(w[6], w[29], pars->GC_11, pars->ZERO, pars->ZERO, w[30]); 
  FFV1_2(w[1], w[29], pars->GC_11, pars->ZERO, pars->ZERO, w[31]); 
  FFV1_1(w[5], w[29], pars->GC_11, pars->ZERO, pars->ZERO, w[32]); 
  FFV1_2(w[9], w[29], pars->GC_11, pars->ZERO, pars->ZERO, w[33]); 
  FFV1_2(w[0], w[26], pars->GC_11, pars->ZERO, pars->ZERO, w[34]); 
  FFV1_1(w[7], w[26], pars->GC_11, pars->ZERO, pars->ZERO, w[35]); 
  FFV1_1(w[6], w[26], pars->GC_11, pars->ZERO, pars->ZERO, w[36]); 
  FFV1_2(w[0], w[16], pars->GC_11, pars->ZERO, pars->ZERO, w[37]); 
  FFV1_1(w[7], w[16], pars->GC_11, pars->ZERO, pars->ZERO, w[38]); 
  FFV1_1(w[5], w[16], pars->GC_11, pars->ZERO, pars->ZERO, w[39]); 
  FFV1_2(w[0], w[19], pars->GC_11, pars->ZERO, pars->ZERO, w[40]); 
  FFV1_1(w[6], w[19], pars->GC_11, pars->ZERO, pars->ZERO, w[41]); 
  FFV1_1(w[5], w[19], pars->GC_11, pars->ZERO, pars->ZERO, w[42]); 
  FFV2_1(w[6], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[43]); 
  FFV1_3(w[8], w[43], pars->GC_11, pars->ZERO, pars->ZERO, w[44]); 
  FFV1_2(w[8], w[10], pars->GC_11, pars->ZERO, pars->ZERO, w[45]); 
  FFV1_2(w[8], w[19], pars->GC_11, pars->ZERO, pars->ZERO, w[46]); 
  FFV2_1(w[7], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[47]); 
  FFV1_3(w[8], w[47], pars->GC_11, pars->ZERO, pars->ZERO, w[48]); 
  FFV1_2(w[8], w[16], pars->GC_11, pars->ZERO, pars->ZERO, w[49]); 
  FFV2_1(w[5], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[50]); 
  FFV1_3(w[8], w[50], pars->GC_11, pars->ZERO, pars->ZERO, w[51]); 
  FFV1_2(w[8], w[21], pars->GC_11, pars->ZERO, pars->ZERO, w[52]); 
  FFV1_2(w[8], w[26], pars->GC_11, pars->ZERO, pars->ZERO, w[53]); 
  FFV1_2(w[8], w[29], pars->GC_11, pars->ZERO, pars->ZERO, w[54]); 
  ...
  FFV1_0(w[13], w[6], w[14], pars->GC_11, amp[3]); 
  FFV1_0(w[17], w[7], w[16], pars->GC_11, amp[4]); 
  FFV1_0(w[18], w[7], w[10], pars->GC_11, amp[5]); 
  VVV1_0(w[10], w[16], w[14], pars->GC_10, amp[6]); 
  FFV1_0(w[17], w[6], w[19], pars->GC_11, amp[7]); 
  VVV1_0(w[10], w[19], w[11], pars->GC_10, amp[8]); 
  FFV1_0(w[20], w[6], w[10], pars->GC_11, amp[9]); 
  FFV1_0(w[1], w[23], w[22], pars->GC_11, amp[10]); 
  FFV1_0(w[24], w[7], w[22], pars->GC_11, amp[11]); 
  FFV1_0(w[1], w[25], w[14], pars->GC_11, amp[12]); 
  FFV1_0(w[24], w[5], w[14], pars->GC_11, amp[13]); 
  FFV1_0(w[27], w[7], w[26], pars->GC_11, amp[14]); 
  FFV1_0(w[28], w[7], w[21], pars->GC_11, amp[15]); 
  VVV1_0(w[21], w[26], w[14], pars->GC_10, amp[16]); 
  FFV1_0(w[27], w[5], w[19], pars->GC_11, amp[17]); 
  VVV1_0(w[21], w[19], w[22], pars->GC_10, amp[18]); 
  FFV1_0(w[20], w[5], w[21], pars->GC_11, amp[19]); 
  FFV1_0(w[1], w[30], w[22], pars->GC_11, amp[20]); 
  FFV1_0(w[31], w[6], w[22], pars->GC_11, amp[21]); 
  FFV1_0(w[1], w[32], w[11], pars->GC_11, amp[22]); 
  FFV1_0(w[31], w[5], w[11], pars->GC_11, amp[23]); 
  FFV1_0(w[33], w[6], w[26], pars->GC_11, amp[24]); 
  FFV1_0(w[28], w[6], w[29], pars->GC_11, amp[25]); 
  VVV1_0(w[29], w[26], w[11], pars->GC_10, amp[26]); 
  FFV1_0(w[33], w[5], w[16], pars->GC_11, amp[27]); 
  VVV1_0(w[29], w[16], w[22], pars->GC_10, amp[28]); 
  FFV1_0(w[18], w[5], w[29], pars->GC_11, amp[29]); 
  FFV1_0(w[34], w[7], w[11], pars->GC_11, amp[30]); 
  FFV1_0(w[0], w[35], w[11], pars->GC_11, amp[31]); 
  FFV1_0(w[34], w[6], w[14], pars->GC_11, amp[32]); 
  FFV1_0(w[0], w[36], w[14], pars->GC_11, amp[33]); 
  FFV1_0(w[37], w[7], w[22], pars->GC_11, amp[34]); 
  FFV1_0(w[0], w[38], w[22], pars->GC_11, amp[35]); 
  FFV1_0(w[37], w[5], w[14], pars->GC_11, amp[36]); 
  FFV1_0(w[0], w[39], w[14], pars->GC_11, amp[37]); 
  FFV1_0(w[40], w[6], w[22], pars->GC_11, amp[38]); 
  FFV1_0(w[0], w[41], w[22], pars->GC_11, amp[39]); 
  FFV1_0(w[40], w[5], w[11], pars->GC_11, amp[40]); 
  FFV1_0(w[0], w[42], w[11], pars->GC_11, amp[41]); 
  FFV1_0(w[1], w[12], w[44], pars->GC_11, amp[42]); 
  FFV1_0(w[13], w[7], w[44], pars->GC_11, amp[43]); 
  FFV1_0(w[45], w[43], w[19], pars->GC_11, amp[44]); 
  VVV1_0(w[10], w[19], w[44], pars->GC_10, amp[45]); 
  FFV1_0(w[46], w[43], w[10], pars->GC_11, amp[46]); 
  FFV1_0(w[1], w[15], w[48], pars->GC_11, amp[47]); 
  FFV1_0(w[13], w[6], w[48], pars->GC_11, amp[48]); 
  ...
  FFV1_0(w[1], w[23], w[51], pars->GC_11, amp[56]); 
  FFV1_0(w[24], w[7], w[51], pars->GC_11, amp[57]); 
  FFV1_0(w[52], w[50], w[19], pars->GC_11, amp[58]); 
  VVV1_0(w[21], w[19], w[51], pars->GC_10, amp[59]); 
  FFV1_0(w[46], w[50], w[21], pars->GC_11, amp[60]); 
  FFV1_0(w[1], w[25], w[48], pars->GC_11, amp[61]); 
  FFV1_0(w[24], w[5], w[48], pars->GC_11, amp[62]); 
  ...
  FFV1_0(w[1], w[30], w[51], pars->GC_11, amp[70]); 
  FFV1_0(w[31], w[6], w[51], pars->GC_11, amp[71]); 
  FFV1_0(w[54], w[50], w[16], pars->GC_11, amp[72]); 
  VVV1_0(w[29], w[16], w[51], pars->GC_10, amp[73]); 
  FFV1_0(w[49], w[50], w[29], pars->GC_11, amp[74]); 
  FFV1_0(w[1], w[32], w[44], pars->GC_11, amp[75]); 
  FFV1_0(w[31], w[5], w[44], pars->GC_11, amp[76]); 
  ...
  FFV1_0(w[37], w[7], w[51], pars->GC_11, amp[84]); 
  FFV1_0(w[0], w[38], w[51], pars->GC_11, amp[85]); 
  FFV1_0(w[40], w[6], w[51], pars->GC_11, amp[86]); 
  FFV1_0(w[0], w[41], w[51], pars->GC_11, amp[87]); 
  FFV1_0(w[34], w[7], w[44], pars->GC_11, amp[88]); 
  FFV1_0(w[0], w[35], w[44], pars->GC_11, amp[89]); 
  FFV1_0(w[40], w[5], w[44], pars->GC_11, amp[90]); 
  FFV1_0(w[0], w[42], w[44], pars->GC_11, amp[91]); 
  FFV1_0(w[34], w[6], w[48], pars->GC_11, amp[92]); 
  FFV1_0(w[0], w[36], w[48], pars->GC_11, amp[93]); 
  FFV1_0(w[37], w[5], w[48], pars->GC_11, amp[94]); 
  FFV1_0(w[0], w[39], w[48], pars->GC_11, amp[95]); 

}
double P0_Sigma_sm_dd_mupvmdddux_W_4j::matrix_dd_wpdddux_wp_mupvm() 
{
  int i, j; 
  // Local variables
  ...
  jamp[0] = +1./4. * (+1./3. * amp[0] + 1./3. * amp[1] + 1./9. * amp[2] + 1./9.
      ...
      * amp[62] + amp[69] + 1./3. * amp[72] + 1./3. * amp[74] + amp[75] +
      ...
      amp[95]);
  jamp[1] = +1./4. * (-1./9. * amp[0] - 1./9. * amp[1] - 1./3. * amp[2] - 1./3.
      ...
      * amp[88] - 1./3. * amp[89] - 1./9. * amp[90] - 1./9. * amp[91] -
      amp[92]);
  jamp[2] = +1./4. * (-amp[1] - 1./3. * amp[2] - 1./3. * amp[3] +
  ...
  jamp[3] = +1./4. * (+1./3. * amp[0] + 1./3. * amp[1] + amp[3] + amp[5] -
  ...
  jamp[4] = +1./4. * (+amp[2] + amp[4] + std::complex<double> (0, 1) * amp[6] +
  ...
  jamp[5] = +1./4. * (-amp[0] - 1./3. * amp[4] - 1./3. * amp[5] - amp[7] -
