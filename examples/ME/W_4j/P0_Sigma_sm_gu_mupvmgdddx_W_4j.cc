...
#include "P0_Sigma_sm_gu_mupvmgdddx_W_4j.h"
...
void P0_Sigma_sm_gu_mupvmgdddx_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_gu_mupvmgdddx_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_gu_wpgdddx_wp_mupvm(); 
        ...
        t[1] = matrix_gu_wpgdddx_wp_mupvm(); 
        double tsum = 0; 
...
double P0_Sigma_sm_gu_mupvmgdddx_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_gu_mupvmgdddx_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_2(w[1], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[39]); 
  ...
  FFV1_2(w[1], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[62]); 
  ...
  FFV1_0(w[1], w[34], w[43], pars->GC_11, amp[32]); 
  FFV1_0(w[1], w[18], w[44], pars->GC_11, amp[33]); 
  ...
  FFV1_0(w[1], w[51], w[57], pars->GC_11, amp[56]); 
  FFV1_0(w[1], w[10], w[58], pars->GC_11, amp[57]); 
  ...
  FFV1_0(w[1], w[54], w[70], pars->GC_11, amp[96]); 
  FFV1_0(w[1], w[18], w[71], pars->GC_11, amp[97]); 
  FFV1_0(w[24], w[7], w[71], pars->GC_11, amp[98]); 
  FFV1_0(w[24], w[50], w[70], pars->GC_11, amp[99]); 
  FFV1_0(w[1], w[37], w[72], pars->GC_11, amp[100]); 
  FFV1_0(w[1], w[10], w[73], pars->GC_11, amp[101]); 
  ...
  FFV1_0(w[1], w[60], w[70], pars->GC_11, amp[109]); 
  VVV1_0(w[70], w[5], w[12], pars->GC_10, amp[110]); 
  FFV1_0(w[74], w[6], w[20], pars->GC_11, amp[111]); 
  FFV1_0(w[1], w[46], w[72], pars->GC_11, amp[112]); 
  ...
  FFV1_0(w[1], w[80], w[43], pars->GC_11, amp[157]); 
  VVV1_0(w[0], w[43], w[12], pars->GC_10, amp[158]); 
  FFV1_0(w[83], w[6], w[20], pars->GC_11, amp[159]); 
  FFV1_0(w[1], w[76], w[57], pars->GC_11, amp[160]); 
...
double P0_Sigma_sm_gu_mupvmgdddx_W_4j::matrix_gu_wpgdddx_wp_mupvm() 
{
  int i, j; 
  // Local variables
