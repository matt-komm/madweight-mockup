...
#ifndef MG5_Sigma_sm_usx_mupvmggucx_H
#define MG5_Sigma_sm_usx_mupvmggucx_H
...
class P0_Sigma_sm_usx_mupvmggucx_W_4j
{
  public:

    // Constructor.
    P0_Sigma_sm_usx_mupvmggucx_W_4j() {}
  ...
  private:
    ...
    double matrix_usx_wpggucx_wp_mupvm(); 
...
#endif  // MG5_Sigma_sm_usx_mupvmggucx_H
