...
#include "P0_Sigma_sm_gdx_mupvmguuxux_W_4j.h"
...
void P0_Sigma_sm_gdx_mupvmguuxux_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_gdx_mupvmguuxux_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_gdx_wpguuxux_wp_mupvm(); 
        ...
        t[1] = matrix_gdx_wpguuxux_wp_mupvm(); 
        double tsum = 0; 
...
double P0_Sigma_sm_gdx_mupvmguuxux_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_gdx_mupvmguuxux_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_1(w[1], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[33]); 
  ...
  FFV1_1(w[1], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[47]); 
  ...
  FFV1_0(w[21], w[1], w[20], pars->GC_11, amp[13]); 
  ...
  FFV1_0(w[25], w[1], w[18], pars->GC_11, amp[18]); 
  ...
  FFV1_0(w[45], w[1], w[36], pars->GC_11, amp[43]); 
  VVV1_0(w[36], w[5], w[22], pars->GC_10, amp[44]); 
  FFV1_0(w[7], w[43], w[26], pars->GC_11, amp[45]); 
  FFV1_0(w[46], w[1], w[34], pars->GC_11, amp[46]); 
  ...
  FFV1_0(w[62], w[1], w[51], pars->GC_11, amp[72]); 
  FFV1_0(w[8], w[10], w[63], pars->GC_11, amp[73]); 
  FFV1_0(w[8], w[48], w[64], pars->GC_11, amp[74]); 
  FFV1_0(w[25], w[1], w[63], pars->GC_11, amp[75]); 
  ...
  FFV1_0(w[62], w[1], w[56], pars->GC_11, amp[80]); 
  FFV1_0(w[41], w[1], w[65], pars->GC_11, amp[81]); 
  ...
  FFV1_0(w[69], w[1], w[54], pars->GC_11, amp[104]); 
  FFV1_0(w[38], w[1], w[72], pars->GC_11, amp[105]); 
  ...
  FFV1_0(w[77], w[1], w[51], pars->GC_11, amp[127]); 
  VVV1_0(w[0], w[51], w[22], pars->GC_10, amp[128]); 
  FFV1_0(w[7], w[75], w[26], pars->GC_11, amp[129]); 
  FFV1_0(w[78], w[1], w[50], pars->GC_11, amp[130]); 
  ...
  FFV1_0(w[77], w[1], w[60], pars->GC_11, amp[186]); 
  FFV1_0(w[77], w[31], w[5], pars->GC_11, amp[187]); 
  FFV1_0(w[45], w[1], w[80], pars->GC_11, amp[188]); 
  ...
  FFV1_0(w[78], w[1], w[59], pars->GC_11, amp[195]); 
  FFV1_0(w[78], w[29], w[5], pars->GC_11, amp[196]); 
  FFV1_0(w[46], w[1], w[81], pars->GC_11, amp[197]); 
...
double P0_Sigma_sm_gdx_mupvmguuxux_W_4j::matrix_gdx_wpguuxux_wp_mupvm() 
{
  int i, j; 
  // Local variables
  ...
  jamp[0] = +1./2. * (+amp[48] + 1./3. * amp[49] + 1./3. * amp[50] + amp[51] +
      ...
      amp[201] + amp[202]);
  jamp[1] = +1./2. * (-1./3. * amp[48] - amp[49] - amp[50] - 1./3. * amp[51] -
  ...
  jamp[5] = +1./2. * (-1./3. * std::complex<double> (0, 1) * amp[0] -
      ...
      amp[202]);
  jamp[6] = +1./2. * (-1./3. * amp[24] - amp[25] - amp[26] - 1./3. * amp[27] -
      ...
      amp[193]);
  jamp[7] = +1./2. * (+amp[24] + 1./3. * amp[25] + 1./3. * amp[26] + amp[27] +
