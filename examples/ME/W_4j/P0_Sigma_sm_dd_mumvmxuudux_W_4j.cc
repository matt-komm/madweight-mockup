...
#include "P0_Sigma_sm_dd_mumvmxuudux_W_4j.h"
...
// Process: d d > w- u u d u~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: s s > w- c c s c~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_dd_mumvmxuudux_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_dd_mumvmxuudux_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_dd_wmuudux_wm_mumvmx(); 
...
double P0_Sigma_sm_dd_mumvmxuudux_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_dd_mumvmxuudux_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[0], w[7], pars->GC_11, pars->ZERO, pars->ZERO, w[18]); 
  ...
  FFV1_3(w[1], w[21], pars->GC_11, pars->ZERO, pars->ZERO, w[27]); 
  ...
  FFV1_3(w[1], w[40], pars->GC_11, pars->ZERO, pars->ZERO, w[45]); 
  ...
  FFV1_2(w[8], w[14], pars->GC_11, pars->ZERO, pars->ZERO, w[49]); 
  FFV1_2(w[8], w[18], pars->GC_11, pars->ZERO, pars->ZERO, w[50]); 
  ...
  FFV1_0(w[1], w[23], w[18], pars->GC_11, amp[8]); 
  ...
  FFV1_0(w[1], w[33], w[34], pars->GC_11, amp[24]); 
  ...
  FFV1_0(w[1], w[40], w[41], pars->GC_11, amp[31]); 
  FFV1_0(w[1], w[42], w[18], pars->GC_11, amp[32]); 
  ...
  FFV1_0(w[1], w[33], w[46], pars->GC_11, amp[38]); 
  ...
  FFV1_0(w[8], w[30], w[34], pars->GC_11, amp[50]); 
  FFV1_0(w[8], w[48], w[12], pars->GC_11, amp[51]); 
  FFV1_0(w[50], w[6], w[45], pars->GC_11, amp[52]); 
  FFV1_0(w[8], w[20], w[45], pars->GC_11, amp[53]); 
  FFV1_0(w[50], w[5], w[27], pars->GC_11, amp[54]); 
  FFV1_0(w[8], w[39], w[27], pars->GC_11, amp[55]); 
  FFV1_0(w[50], w[6], w[47], pars->GC_11, amp[56]); 
  FFV1_0(w[50], w[5], w[29], pars->GC_11, amp[57]); 
  FFV1_0(w[8], w[39], w[29], pars->GC_11, amp[58]); 
  FFV1_0(w[8], w[20], w[47], pars->GC_11, amp[59]); 
  FFV1_0(w[49], w[6], w[46], pars->GC_11, amp[60]); 
  FFV1_0(w[8], w[30], w[46], pars->GC_11, amp[61]); 
  FFV1_0(w[49], w[5], w[28], pars->GC_11, amp[62]); 
  FFV1_0(w[8], w[48], w[28], pars->GC_11, amp[63]); 

}
double P0_Sigma_sm_dd_mumvmxuudux_W_4j::matrix_dd_wmuudux_wm_mumvmx() 
{
  int i, j; 
  // Local variables
  ...
  jamp[1] = +1./4. * (+1./3. * amp[2] + 1./3. * amp[3] + amp[5] -
  ...
  jamp[2] = +1./4. * (+1./3. * amp[0] + 1./3. * amp[1] + amp[6] +
