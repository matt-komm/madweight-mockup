...
#include "P0_Sigma_sm_gg_mumvmxucuxsx_W_4j.h"
...
// Process: g g > w- u c u~ s~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: g g > w- c u c~ d~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: g g > w- s u s~ d~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: g g > w- d c d~ s~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_gg_mumvmxucuxsx_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_gg_mumvmxucuxsx_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_gg_wmucuxsx_wm_mumvmx(); 
...
double P0_Sigma_sm_gg_mumvmxucuxsx_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_gg_mumvmxucuxsx_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[7], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[14]); 
  ...
  FFV1_1(w[5], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[24]); 
  FFV1_1(w[6], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[25]); 
  FFV1_3(w[7], w[24], pars->GC_11, pars->ZERO, pars->ZERO, w[26]); 
  FFV2_1(w[25], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[27]); 
  FFV1_2(w[7], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[28]); 
  FFV1_3(w[28], w[24], pars->GC_11, pars->ZERO, pars->ZERO, w[29]); 
  FFV1_2(w[8], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[30]); 
  FFV2_2(w[30], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[31]); 
  FFV1_1(w[24], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[32]); 
  FFV1_1(w[10], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[33]); 
  FFV1_2(w[18], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[34]); 
  FFV1_1(w[6], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[35]); 
  FFV1_1(w[5], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[36]); 
  ...
  FFV1_3(w[28], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[40]); 
  FFV1_1(w[35], w[14], pars->GC_11, pars->ZERO, pars->ZERO, w[41]); 
  FFV1_1(w[35], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[42]); 
  VVV1_1(w[1], w[14], pars->GC_10, pars->ZERO, pars->ZERO, w[43]); 
  FFV1_2(w[7], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[44]); 
  FFV1_3(w[44], w[36], pars->GC_11, pars->ZERO, pars->ZERO, w[45]); 
  FFV1_3(w[44], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[46]); 
  FFV1_2(w[44], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[47]); 
  ...
  FFV1_2(w[48], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[52]); 
  ...
  VVVV1_1(w[0], w[1], w[14], pars->GC_12, pars->ZERO, pars->ZERO, w[60]); 
  VVVV3_1(w[0], w[1], w[14], pars->GC_12, pars->ZERO, pars->ZERO, w[61]); 
  VVVV4_1(w[0], w[1], w[14], pars->GC_12, pars->ZERO, pars->ZERO, w[62]); 

  // Calculate all amplitudes
  // Amplitude(s) for diagram number 0
  FFV1_0(w[7], w[11], w[12], pars->GC_11, amp[0]); 
  FFV1_0(w[13], w[5], w[12], pars->GC_11, amp[1]); 
  ...
  FFV1_0(w[13], w[5], w[19], pars->GC_11, amp[6]); 
  ...
  FFV1_0(w[47], w[5], w[12], pars->GC_11, amp[42]); 
  FFV1_0(w[8], w[33], w[46], pars->GC_11, amp[43]); 
  VVV1_0(w[46], w[1], w[12], pars->GC_10, amp[44]); 
  FFV1_0(w[47], w[5], w[19], pars->GC_11, amp[45]); 
  FFV1_0(w[34], w[6], w[46], pars->GC_11, amp[46]); 
  VVV1_0(w[46], w[1], w[19], pars->GC_10, amp[47]); 
  ...
  FFV1_0(w[28], w[5], w[50], pars->GC_11, amp[53]); 
  FFV1_0(w[52], w[10], w[14], pars->GC_11, amp[54]); 
  VVV1_0(w[1], w[14], w[50], pars->GC_10, amp[55]); 
  FFV1_0(w[51], w[10], w[1], pars->GC_11, amp[56]); 
  FFV2_0(w[52], w[23], w[4], pars->GC_100, amp[57]); 
  FFV1_0(w[49], w[6], w[43], pars->GC_11, amp[58]); 
  FFV1_0(w[49], w[23], w[1], pars->GC_11, amp[59]); 
  ...
  FFV1_0(w[58], w[5], w[12], pars->GC_11, amp[72]); 
  FFV1_0(w[8], w[54], w[40], pars->GC_11, amp[73]); 
  VVV1_0(w[0], w[40], w[12], pars->GC_10, amp[74]); 
  FFV1_0(w[58], w[5], w[19], pars->GC_11, amp[75]); 
  ...
  FFV1_0(w[22], w[54], w[1], pars->GC_11, amp[85]); 
  FFV1_0(w[8], w[33], w[57], pars->GC_11, amp[86]); 
  VVV1_0(w[57], w[1], w[12], pars->GC_10, amp[87]); 
  ...
  FFV1_0(w[55], w[23], w[1], pars->GC_11, amp[94]); 
  FFV1_0(w[34], w[6], w[57], pars->GC_11, amp[95]); 
  VVV1_0(w[57], w[1], w[19], pars->GC_10, amp[96]); 
...
double P0_Sigma_sm_gg_mumvmxucuxsx_W_4j::matrix_gg_wmucuxsx_wm_mumvmx() 
{
  int i, j; 
  // Local variables
