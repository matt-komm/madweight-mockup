...
#include "P0_Sigma_sm_gux_mupvmgduxux_W_4j.h"
...
// Process: g u~ > w+ g d u~ u~ WEIGHTED=6
// *   Decay: w+ > mu+ vm WEIGHTED=2
// Process: g c~ > w+ g s c~ c~ WEIGHTED=6
// *   Decay: w+ > mu+ vm WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_gux_mupvmgduxux_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_gux_mupvmgduxux_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_gux_wpgduxux_wp_mupvm(); 
        ...
        t[1] = matrix_gux_wpgduxux_wp_mupvm(); 
        double tsum = 0; 
...
double P0_Sigma_sm_gux_mupvmgduxux_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_gux_mupvmgduxux_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[37], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[54]); 
  FFV1_1(w[47], w[19], pars->GC_11, pars->ZERO, pars->ZERO, w[55]); 
  FFV1_3(w[40], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[56]); 
  FFV1_1(w[47], w[16], pars->GC_11, pars->ZERO, pars->ZERO, w[57]); 
  FFV1_1(w[47], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[58]); 
  VVV1_1(w[5], w[16], pars->GC_10, pars->ZERO, pars->ZERO, w[59]); 
  VVV1_1(w[5], w[19], pars->GC_10, pars->ZERO, pars->ZERO, w[60]); 
  ...
  FFV1_3(w[61], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[65]); 
  ...
  FFV1_3(w[68], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[72]); 
  ...
  FFV1_0(w[14], w[1], w[13], pars->GC_11, amp[2]); 
  FFV1_0(w[15], w[1], w[12], pars->GC_11, amp[3]); 
  ...
  FFV1_0(w[15], w[1], w[22], pars->GC_11, amp[11]); 
  ...
  FFV1_0(w[14], w[1], w[26], pars->GC_11, amp[16]); 
  ...
  FFV1_0(w[82], w[1], w[13], pars->GC_11, amp[144]); 
  ...
  FFV1_0(w[83], w[1], w[22], pars->GC_11, amp[162]); 
  ...
  FFV1_0(w[28], w[76], w[5], pars->GC_11, amp[169]); 
  FFV1_0(w[8], w[44], w[81], pars->GC_11, amp[170]); 
  VVV1_0(w[81], w[5], w[13], pars->GC_10, amp[171]); 
  ...
  FFV1_0(w[30], w[76], w[5], pars->GC_11, amp[178]); 
  FFV1_0(w[7], w[44], w[80], pars->GC_11, amp[179]); 
  VVV1_0(w[80], w[5], w[12], pars->GC_10, amp[180]); 
  ...
  FFV1_0(w[77], w[31], w[5], pars->GC_11, amp[187]); 
  FFV1_0(w[45], w[6], w[80], pars->GC_11, amp[188]); 
  VVV1_0(w[80], w[5], w[22], pars->GC_10, amp[189]); 
  ...
  VVV1_0(w[81], w[5], w[26], pars->GC_10, amp[198]); 
...
double P0_Sigma_sm_gux_mupvmgduxux_W_4j::matrix_gux_wpgduxux_wp_mupvm() 
{
  int i, j; 
  // Local variables
  ...
  jamp[0] = +1./2. * (+1./3. * amp[24] + amp[25] + amp[26] + 1./3. * amp[27] +
      ...
      amp[193]);
  jamp[1] = +1./2. * (-amp[24] - 1./3. * amp[25] - 1./3. * amp[26] - amp[27] -
  ...
  jamp[3] = +1./2. * (+1./3. * std::complex<double> (0, 1) * amp[0] +
      ...
      amp[202]);
  jamp[4] = +1./2. * (+std::complex<double> (0, 1) * amp[2] +
      ...
      * amp[71] - amp[144] - amp[145] + std::complex<double> (0, 1) * amp[146]
      ...
      amp[201]);
  jamp[5] = +1./2. * (-std::complex<double> (0, 1) * amp[3] - 1./3. *
  ...
  jamp[7] = +1./2. * (+1./3. * amp[48] + amp[49] + amp[50] + 1./3. * amp[51] +
      ...
      amp[192] + amp[193]);
  jamp[8] = +1./2. * (+std::complex<double> (0, 1) * amp[3] + 1./3. *
      std::complex<double> (0, 1) * amp[4] + 1./3. * std::complex<double> (0,
      1) * amp[6] + std::complex<double> (0, 1) * amp[7] + amp[8] +
      std::complex<double> (0, 1) * amp[11] + amp[13] + std::complex<double>
      (0, 1) * amp[14] + 1./3. * std::complex<double> (0, 1) * amp[17] + 1./3.
  ...
  jamp[9] = +1./2. * (-std::complex<double> (0, 1) * amp[2] -
      std::complex<double> (0, 1) * amp[4] - amp[5] - 1./3. *
      std::complex<double> (0, 1) * amp[7] - 1./3. * std::complex<double> (0,
      1) * amp[9] - 1./3. * std::complex<double> (0, 1) * amp[12] - 1./3. *
      std::complex<double> (0, 1) * amp[14] - std::complex<double> (0, 1) *
