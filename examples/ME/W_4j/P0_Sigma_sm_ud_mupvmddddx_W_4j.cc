...
#include "P0_Sigma_sm_ud_mupvmddddx_W_4j.h"
...
// Process: u d > w+ d d d d~ WEIGHTED=6
// *   Decay: w+ > mu+ vm WEIGHTED=2
// Process: c s > w+ s s s s~ WEIGHTED=6
// *   Decay: w+ > mu+ vm WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_ud_mupvmddddx_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_ud_mupvmddddx_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_ud_wpddddx_wp_mupvm(); 
        ...
        t[1] = matrix_ud_wpddddx_wp_mupvm(); 
        double tsum = 0; 
...
double P0_Sigma_sm_ud_mupvmddddx_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_ud_mupvmddddx_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[8], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[16]); 
  ...
  FFV1_3(w[0], w[43], pars->GC_11, pars->ZERO, pars->ZERO, w[44]); 
  FFV1_2(w[0], w[10], pars->GC_11, pars->ZERO, pars->ZERO, w[45]); 
  FFV1_2(w[0], w[19], pars->GC_11, pars->ZERO, pars->ZERO, w[46]); 
  FFV2_1(w[7], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[47]); 
  FFV1_3(w[0], w[47], pars->GC_11, pars->ZERO, pars->ZERO, w[48]); 
  FFV1_2(w[0], w[16], pars->GC_11, pars->ZERO, pars->ZERO, w[49]); 
  FFV2_1(w[5], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[50]); 
  FFV1_3(w[0], w[50], pars->GC_11, pars->ZERO, pars->ZERO, w[51]); 
  FFV1_2(w[0], w[21], pars->GC_11, pars->ZERO, pars->ZERO, w[52]); 
  FFV1_2(w[0], w[26], pars->GC_11, pars->ZERO, pars->ZERO, w[53]); 
  FFV1_2(w[0], w[29], pars->GC_11, pars->ZERO, pars->ZERO, w[54]); 
  ...
  FFV1_0(w[1], w[35], w[11], pars->GC_11, amp[31]); 
  FFV1_0(w[34], w[6], w[14], pars->GC_11, amp[32]); 
  FFV1_0(w[1], w[36], w[14], pars->GC_11, amp[33]); 
  FFV1_0(w[37], w[7], w[22], pars->GC_11, amp[34]); 
  FFV1_0(w[1], w[38], w[22], pars->GC_11, amp[35]); 
  FFV1_0(w[37], w[5], w[14], pars->GC_11, amp[36]); 
  FFV1_0(w[1], w[39], w[14], pars->GC_11, amp[37]); 
  FFV1_0(w[40], w[6], w[22], pars->GC_11, amp[38]); 
  FFV1_0(w[1], w[41], w[22], pars->GC_11, amp[39]); 
  FFV1_0(w[40], w[5], w[11], pars->GC_11, amp[40]); 
  FFV1_0(w[1], w[42], w[11], pars->GC_11, amp[41]); 
  ...
  FFV1_0(w[1], w[38], w[51], pars->GC_11, amp[85]); 
  FFV1_0(w[40], w[6], w[51], pars->GC_11, amp[86]); 
  FFV1_0(w[1], w[41], w[51], pars->GC_11, amp[87]); 
  FFV1_0(w[34], w[7], w[44], pars->GC_11, amp[88]); 
  FFV1_0(w[1], w[35], w[44], pars->GC_11, amp[89]); 
  FFV1_0(w[40], w[5], w[44], pars->GC_11, amp[90]); 
  FFV1_0(w[1], w[42], w[44], pars->GC_11, amp[91]); 
  FFV1_0(w[34], w[6], w[48], pars->GC_11, amp[92]); 
  FFV1_0(w[1], w[36], w[48], pars->GC_11, amp[93]); 
  FFV1_0(w[37], w[5], w[48], pars->GC_11, amp[94]); 
  FFV1_0(w[1], w[39], w[48], pars->GC_11, amp[95]); 

}
double P0_Sigma_sm_ud_mupvmddddx_W_4j::matrix_ud_wpddddx_wp_mupvm() 
{
  int i, j; 
  // Local variables
