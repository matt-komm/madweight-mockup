...
#include "P0_Sigma_sm_ddx_mumvmxuuuxdx_W_4j.h"
...
// Process: d d~ > w- u u u~ d~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: s s~ > w- c c c~ s~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_ddx_mumvmxuuuxdx_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_ddx_mumvmxuuuxdx_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_ddx_wmuuuxdx_wm_mumvmx(); 
        ...
        t[1] = matrix_ddx_wmuuuxdx_wm_mumvmx(); 
        double tsum = 0; 
...
double P0_Sigma_sm_ddx_mumvmxuuuxdx_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_ddx_mumvmxuuuxdx_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[0], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[18]); 
  ...
  FFV1_3(w[7], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[32]); 
...
double P0_Sigma_sm_ddx_mumvmxuuuxdx_W_4j::matrix_ddx_wmuuuxdx_wm_mumvmx() 
{
  int i, j; 
  // Local variables
  ...
  jamp[4] = +1./4. * (+1./3. * amp[2] + 1./3. * amp[3] + amp[5] -
