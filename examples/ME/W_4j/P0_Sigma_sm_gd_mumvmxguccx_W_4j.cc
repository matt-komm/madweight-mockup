...
#include "P0_Sigma_sm_gd_mumvmxguccx_W_4j.h"
...
// Process: g d > w- g u c c~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: g d > w- g u s s~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: g s > w- g c u u~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: g s > w- g c d d~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_gd_mumvmxguccx_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_gd_mumvmxguccx_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_gd_wmguccx_wm_mumvmx(); 
        ...
        t[1] = matrix_gd_wmguccx_wm_mumvmx(); 
        double tsum = 0; 
...
double P0_Sigma_sm_gd_mumvmxguccx_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_gd_mumvmxguccx_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_2(w[8], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[29]); 
  FFV1_3(w[29], w[7], pars->GC_11, pars->ZERO, pars->ZERO, w[30]); 
  FFV1_2(w[1], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[31]); 
  ...
  FFV1_2(w[8], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[44]); 
  ...
  FFV1_2(w[1], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[48]); 
  ...
  FFV1_0(w[1], w[26], w[27], pars->GC_11, amp[12]); 
  FFV1_0(w[8], w[25], w[28], pars->GC_11, amp[13]); 
  FFV1_0(w[1], w[26], w[30], pars->GC_11, amp[14]); 
  ...
  FFV1_0(w[49], w[6], w[34], pars->GC_11, amp[58]); 
  ...
  FFV1_0(w[40], w[6], w[55], pars->GC_11, amp[82]); 
  FFV1_0(w[40], w[23], w[0], pars->GC_11, amp[83]); 
  FFV1_0(w[1], w[57], w[34], pars->GC_11, amp[84]); 
  FFV1_0(w[22], w[57], w[5], pars->GC_11, amp[85]); 
  FFV1_0(w[1], w[42], w[55], pars->GC_11, amp[86]); 
  ...
  FFV1_0(w[54], w[6], w[34], pars->GC_11, amp[93]); 
  FFV1_0(w[54], w[23], w[5], pars->GC_11, amp[94]); 
  FFV1_0(w[43], w[6], w[55], pars->GC_11, amp[95]); 
...
double P0_Sigma_sm_gd_mumvmxguccx_W_4j::matrix_gd_wmguccx_wm_mumvmx() 
{
  int i, j; 
  // Local variables
  ...
  jamp[5] = +1./2. * (+amp[12] + amp[13] + amp[16] + amp[17] +
      ...
      amp[99] + amp[100]);
  jamp[6] = +1./2. * (+amp[24] + amp[25] + amp[26] + amp[27] + amp[31] +
  ...
  jamp[7] = +1./2. * (-1./3. * amp[24] - 1./3. * amp[25] - 1./3. * amp[28] -
