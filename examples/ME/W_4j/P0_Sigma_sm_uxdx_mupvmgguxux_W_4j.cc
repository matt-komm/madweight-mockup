...
#include "P0_Sigma_sm_uxdx_mupvmgguxux_W_4j.h"
...
void P0_Sigma_sm_uxdx_mupvmgguxux_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_uxdx_mupvmgguxux_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_uxdx_wpgguxux_wp_mupvm(); 
        ...
        t[1] = matrix_uxdx_wpgguxux_wp_mupvm(); 
        double tsum = 0; 
...
double P0_Sigma_sm_uxdx_mupvmgguxux_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_uxdx_mupvmgguxux_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_1(w[0], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[11]); 
  ...
  FFV1_2(w[8], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[40]); 
  ...
  FFV1_1(w[1], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[47]); 
  FFV1_1(w[0], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[48]); 
  ...
  FFV1_3(w[37], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[54]); 
  FFV1_1(w[47], w[19], pars->GC_11, pars->ZERO, pars->ZERO, w[55]); 
  FFV1_3(w[40], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[56]); 
  ...
  FFV1_3(w[61], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[65]); 
  ...
  FFV1_3(w[68], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[72]); 
  ...
  FFV1_0(w[14], w[0], w[13], pars->GC_11, amp[2]); 
  FFV1_0(w[15], w[0], w[12], pars->GC_11, amp[3]); 
  ...
  FFV1_0(w[15], w[0], w[22], pars->GC_11, amp[11]); 
  ...
  FFV1_0(w[14], w[0], w[26], pars->GC_11, amp[16]); 
  ...
  FFV1_0(w[40], w[0], w[64], pars->GC_11, amp[82]); 
  FFV1_0(w[40], w[10], w[65], pars->GC_11, amp[83]); 
  FFV1_0(w[67], w[0], w[13], pars->GC_11, amp[84]); 
  ...
  FFV1_0(w[67], w[0], w[26], pars->GC_11, amp[90]); 
  ...
  FFV1_0(w[37], w[0], w[71], pars->GC_11, amp[106]); 
  FFV1_0(w[37], w[10], w[72], pars->GC_11, amp[107]); 
  FFV1_0(w[74], w[0], w[12], pars->GC_11, amp[108]); 
  ...
  FFV1_0(w[74], w[0], w[22], pars->GC_11, amp[114]); 
  ...
  FFV1_0(w[82], w[0], w[13], pars->GC_11, amp[144]); 
  ...
  FFV1_0(w[82], w[0], w[26], pars->GC_11, amp[150]); 
  ...
  FFV1_0(w[83], w[0], w[12], pars->GC_11, amp[156]); 
  ...
  FFV1_0(w[83], w[0], w[22], pars->GC_11, amp[162]); 
...
double P0_Sigma_sm_uxdx_mupvmgguxux_W_4j::matrix_uxdx_wpgguxux_wp_mupvm() 
{
  int i, j; 
  // Local variables
  ...
  jamp[3] = +1./2. * (-std::complex<double> (0, 1) * amp[2] -
      ...
      amp[202]);
  jamp[4] = +1./2. * (+1./3. * std::complex<double> (0, 1) * amp[0] +
  ...
  jamp[7] = +1./2. * (+std::complex<double> (0, 1) * amp[0] + 1./3. *
      std::complex<double> (0, 1) * amp[1] + 1./3. * std::complex<double> (0,
      1) * amp[2] - amp[8] + std::complex<double> (0, 1) * amp[9] +
      std::complex<double> (0, 1) * amp[10] + std::complex<double> (0, 1) *
      amp[12] - amp[13] + 1./3. * std::complex<double> (0, 1) * amp[15] + 1./3.
  ...
  jamp[8] = +1./2. * (+1./3. * amp[24] + amp[25] + amp[26] + 1./3. * amp[27] +
      ...
      amp[193]);
  jamp[9] = +1./2. * (-amp[24] - 1./3. * amp[25] - 1./3. * amp[26] - amp[27] -
      ...
      amp[201] - amp[202]);
  jamp[10] = +1./2. * (-amp[48] - 1./3. * amp[49] - 1./3. * amp[50] - amp[51] -
      ...
      amp[201] - amp[202]);
  jamp[11] = +1./2. * (+1./3. * amp[48] + amp[49] + amp[50] + 1./3. * amp[51] +
