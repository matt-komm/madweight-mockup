...
#include "P0_Sigma_sm_dux_mumvmxuuuxux_W_4j.h"
...
// Process: d u~ > w- u u u~ u~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: s c~ > w- c c c~ c~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_dux_mumvmxuuuxux_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_dux_mumvmxuuuxux_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_dux_wmuuuxux_wm_mumvmx(); 
        ...
        t[1] = matrix_dux_wmuuuxux_wm_mumvmx(); 
        double tsum = 0; 
...
double P0_Sigma_sm_dux_mumvmxuuuxux_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_dux_mumvmxuuuxux_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_2(w[0], w[20], pars->GC_11, pars->ZERO, pars->ZERO, w[22]); 
  ...
  FFV1_3(w[0], w[24], pars->GC_11, pars->ZERO, pars->ZERO, w[28]); 
  FFV1_3(w[0], w[15], pars->GC_11, pars->ZERO, pars->ZERO, w[29]); 
  ...
  FFV1_3(w[8], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[33]); 
  FFV1_1(w[6], w[32], pars->GC_11, pars->ZERO, pars->ZERO, w[34]); 
  FFV1_2(w[0], w[33], pars->GC_11, pars->ZERO, pars->ZERO, w[35]); 
  FFV1_2(w[0], w[32], pars->GC_11, pars->ZERO, pars->ZERO, w[36]); 
  ...
  FFV1_3(w[0], w[43], pars->GC_11, pars->ZERO, pars->ZERO, w[47]); 
  FFV1_3(w[18], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[48]); 
  FFV1_3(w[7], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[49]); 
  FFV1_1(w[5], w[49], pars->GC_11, pars->ZERO, pars->ZERO, w[50]); 
  FFV1_2(w[0], w[49], pars->GC_11, pars->ZERO, pars->ZERO, w[51]); 
  ...
  FFV1_2(w[7], w[33], pars->GC_11, pars->ZERO, pars->ZERO, w[61]); 
  FFV1_2(w[7], w[10], pars->GC_11, pars->ZERO, pars->ZERO, w[62]); 
  FFV1_2(w[7], w[20], pars->GC_11, pars->ZERO, pars->ZERO, w[63]); 
  ...
  FFV1_0(w[0], w[24], w[25], pars->GC_11, amp[10]); 
  FFV1_0(w[0], w[26], w[20], pars->GC_11, amp[11]); 
  ...
  FFV1_0(w[0], w[15], w[38], pars->GC_11, amp[26]); 
  FFV1_0(w[0], w[39], w[33], pars->GC_11, amp[27]); 
  ...
  FFV1_0(w[0], w[43], w[44], pars->GC_11, amp[34]); 
  FFV1_0(w[0], w[45], w[20], pars->GC_11, amp[35]); 
  ...
  FFV1_0(w[0], w[24], w[53], pars->GC_11, amp[50]); 
  FFV1_0(w[0], w[54], w[33], pars->GC_11, amp[51]); 
  ...
  FFV1_0(w[0], w[43], w[58], pars->GC_11, amp[58]); 
  FFV1_0(w[0], w[59], w[10], pars->GC_11, amp[59]); 
  ...
  FFV1_0(w[7], w[37], w[28], pars->GC_11, amp[73]); 
  FFV1_0(w[61], w[5], w[29], pars->GC_11, amp[74]); 
  FFV1_0(w[7], w[52], w[29], pars->GC_11, amp[75]); 
  FFV1_0(w[61], w[6], w[30], pars->GC_11, amp[76]); 
  FFV1_0(w[61], w[5], w[31], pars->GC_11, amp[77]); 
  FFV1_0(w[7], w[52], w[31], pars->GC_11, amp[78]); 
  FFV1_0(w[7], w[37], w[30], pars->GC_11, amp[79]); 
  FFV1_0(w[62], w[6], w[47], pars->GC_11, amp[80]); 
  FFV1_0(w[7], w[14], w[47], pars->GC_11, amp[81]); 
  FFV1_0(w[62], w[1], w[29], pars->GC_11, amp[82]); 
  FFV1_0(w[7], w[57], w[29], pars->GC_11, amp[83]); 
  FFV1_0(w[62], w[6], w[48], pars->GC_11, amp[84]); 
  FFV1_0(w[62], w[1], w[31], pars->GC_11, amp[85]); 
  FFV1_0(w[7], w[57], w[31], pars->GC_11, amp[86]); 
  FFV1_0(w[7], w[14], w[48], pars->GC_11, amp[87]); 
  FFV1_0(w[63], w[5], w[47], pars->GC_11, amp[88]); 
  FFV1_0(w[7], w[23], w[47], pars->GC_11, amp[89]); 
  FFV1_0(w[63], w[1], w[28], pars->GC_11, amp[90]); 
  FFV1_0(w[7], w[42], w[28], pars->GC_11, amp[91]); 
  FFV1_0(w[63], w[5], w[48], pars->GC_11, amp[92]); 
  FFV1_0(w[63], w[1], w[30], pars->GC_11, amp[93]); 
  FFV1_0(w[7], w[42], w[30], pars->GC_11, amp[94]); 
  FFV1_0(w[7], w[23], w[48], pars->GC_11, amp[95]); 

}
double P0_Sigma_sm_dux_mumvmxuuuxux_W_4j::matrix_dux_wmuuuxux_wm_mumvmx() 
{
  int i, j; 
  // Local variables
  ...
  jamp[0] = +1./4. * (+amp[1] + std::complex<double> (0, 1) * amp[2] + amp[4] +
  ...
  jamp[3] = +1./4. * (+1./9. * amp[0] + 1./9. * amp[1] + 1./9. * amp[3] + 1./9.
  ...
  jamp[5] = +1./4. * (-amp[8] + std::complex<double> (0, 1) * amp[10] - amp[11]
