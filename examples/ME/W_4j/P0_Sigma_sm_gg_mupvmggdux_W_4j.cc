...
#include "P0_Sigma_sm_gg_mupvmggdux_W_4j.h"
...
// Process: g g > w+ g g d u~ WEIGHTED=6
// *   Decay: w+ > mu+ vm WEIGHTED=2
// Process: g g > w+ g g s c~ WEIGHTED=6
// *   Decay: w+ > mu+ vm WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_gg_mupvmggdux_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_gg_mupvmggdux_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_gg_wpggdux_wp_mupvm(); 
...
double P0_Sigma_sm_gg_mupvmggdux_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_gg_mupvmggdux_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double P0_Sigma_sm_gg_mupvmggdux_W_4j::matrix_gg_wpggdux_wp_mupvm() 
{
  int i, j; 
  // Local variables
