...
#include "P0_Sigma_sm_dcx_mumvmxggucx_W_4j.h"
...
// Process: d c~ > w- g g u c~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: d s~ > w- g g u s~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: s u~ > w- g g c u~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: s d~ > w- g g c d~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_dcx_mumvmxggucx_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_dcx_mumvmxggucx_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_dcx_wmggucx_wm_mumvmx(); 
        ...
        t[1] = matrix_dcx_wmggucx_wm_mumvmx(); 
        double tsum = 0; 
...
double P0_Sigma_sm_dcx_mumvmxggucx_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_dcx_mumvmxggucx_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_0(w[18], w[7], w[39], pars->GC_11, amp[27]); 
  FFV1_0(w[40], w[7], w[37], pars->GC_11, amp[28]); 
  ...
  FFV1_0(w[18], w[7], w[46], pars->GC_11, amp[39]); 
  FFV1_0(w[40], w[7], w[45], pars->GC_11, amp[40]); 
  ...
  FFV1_0(w[49], w[7], w[34], pars->GC_11, amp[58]); 
  ...
  FFV1_0(w[54], w[7], w[30], pars->GC_11, amp[76]); 
  ...
  FFV1_0(w[40], w[7], w[55], pars->GC_11, amp[82]); 
...
double P0_Sigma_sm_dcx_mumvmxggucx_W_4j::matrix_dcx_wmggucx_wm_mumvmx() 
{
  int i, j; 
  // Local variables
  ...
  jamp[3] = +1./2. * (+1./3. * std::complex<double> (0, 1) * amp[2] + 1./3. *
      ...
      1./3. * amp[94]);
  jamp[4] = +1./2. * (-amp[24] - amp[25] - amp[26] - amp[27] - amp[31] -
  ...
  jamp[5] = +1./2. * (+1./3. * amp[24] + 1./3. * amp[25] + 1./3. * amp[28] +
