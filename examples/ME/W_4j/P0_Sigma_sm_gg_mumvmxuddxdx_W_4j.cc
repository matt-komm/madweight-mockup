...
#include "P0_Sigma_sm_gg_mumvmxuddxdx_W_4j.h"
...
// Process: g g > w- u d d~ d~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: g g > w- c s s~ s~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_gg_mumvmxuddxdx_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_gg_mumvmxuddxdx_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_gg_wmuddxdx_wm_mumvmx(); 
...
double P0_Sigma_sm_gg_mumvmxuddxdx_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_gg_mumvmxuddxdx_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  VVV1_1(w[1], w[16], pars->GC_10, pars->ZERO, pars->ZERO, w[46]); 
  VVV1_1(w[1], w[19], pars->GC_10, pars->ZERO, pars->ZERO, w[47]); 
  FFV1_1(w[6], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[48]); 
  FFV1_1(w[5], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[49]); 
  ...
  FFV1_1(w[48], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[57]); 
  FFV1_1(w[10], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[58]); 
  FFV1_2(w[21], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[59]); 
  FFV1_2(w[25], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[60]); 
  ...
  VVV1_0(w[1], w[19], w[37], pars->GC_10, amp[37]); 
  FFV1_0(w[21], w[41], w[1], pars->GC_11, amp[38]); 
  FFV1_0(w[25], w[45], w[16], pars->GC_11, amp[39]); 
  VVV1_0(w[1], w[16], w[38], pars->GC_10, amp[40]); 
  FFV1_0(w[25], w[44], w[1], pars->GC_11, amp[41]); 
  FFV2_0(w[28], w[45], w[4], pars->GC_100, amp[42]); 
  FFV1_0(w[8], w[34], w[46], pars->GC_11, amp[43]); 
  FFV1_0(w[28], w[34], w[1], pars->GC_11, amp[44]); 
  ...
  FFV1_0(w[63], w[5], w[36], pars->GC_11, amp[76]); 
  FFV1_0(w[8], w[10], w[65], pars->GC_11, amp[77]); 
  FFV1_0(w[8], w[33], w[66], pars->GC_11, amp[78]); 
  FFV1_0(w[25], w[5], w[65], pars->GC_11, amp[79]); 
  FFV1_0(w[63], w[5], w[43], pars->GC_11, amp[80]); 
  FFV1_0(w[55], w[5], w[62], pars->GC_11, amp[81]); 
  ...
  VVV1_0(w[62], w[1], w[13], pars->GC_10, amp[86]); 
  FFV1_0(w[67], w[10], w[19], pars->GC_11, amp[87]); 
  VVV1_0(w[1], w[19], w[66], pars->GC_10, amp[88]); 
  FFV1_0(w[64], w[10], w[1], pars->GC_11, amp[89]); 
  FFV1_0(w[67], w[6], w[26], pars->GC_11, amp[90]); 
  FFV1_0(w[60], w[5], w[62], pars->GC_11, amp[91]); 
  VVV1_0(w[62], w[1], w[26], pars->GC_10, amp[92]); 
  FFV2_0(w[67], w[31], w[4], pars->GC_100, amp[93]); 
  FFV1_0(w[63], w[5], w[47], pars->GC_11, amp[94]); 
  ...
  FFV1_0(w[70], w[5], w[35], pars->GC_11, amp[100]); 
  FFV1_0(w[7], w[10], w[72], pars->GC_11, amp[101]); 
  FFV1_0(w[7], w[33], w[73], pars->GC_11, amp[102]); 
  FFV1_0(w[21], w[5], w[72], pars->GC_11, amp[103]); 
  FFV1_0(w[70], w[5], w[40], pars->GC_11, amp[104]); 
  FFV1_0(w[53], w[5], w[69], pars->GC_11, amp[105]); 
  ...
  VVV1_0(w[69], w[1], w[12], pars->GC_10, amp[110]); 
  FFV1_0(w[74], w[10], w[16], pars->GC_11, amp[111]); 
  VVV1_0(w[1], w[16], w[73], pars->GC_10, amp[112]); 
  FFV1_0(w[71], w[10], w[1], pars->GC_11, amp[113]); 
  FFV1_0(w[74], w[6], w[22], pars->GC_11, amp[114]); 
  FFV1_0(w[59], w[5], w[69], pars->GC_11, amp[115]); 
  VVV1_0(w[69], w[1], w[22], pars->GC_10, amp[116]); 
  FFV2_0(w[74], w[29], w[4], pars->GC_100, amp[117]); 
  FFV1_0(w[70], w[5], w[46], pars->GC_11, amp[118]); 
  FFV1_0(w[70], w[29], w[1], pars->GC_11, amp[119]); 
  ...
  FFV1_0(w[76], w[5], w[36], pars->GC_11, amp[139]); 
  VVV1_0(w[0], w[36], w[22], pars->GC_10, amp[140]); 
  FFV1_0(w[7], w[80], w[26], pars->GC_11, amp[141]); 
  FFV1_0(w[78], w[5], w[35], pars->GC_11, amp[142]); 
  ...
  FFV1_0(w[30], w[81], w[1], pars->GC_11, amp[178]); 
  FFV1_0(w[7], w[58], w[77], pars->GC_11, amp[179]); 
  VVV1_0(w[77], w[1], w[12], pars->GC_10, amp[180]); 
  ...
  FFV1_0(w[76], w[5], w[47], pars->GC_11, amp[186]); 
  FFV1_0(w[76], w[31], w[1], pars->GC_11, amp[187]); 
  FFV1_0(w[59], w[5], w[77], pars->GC_11, amp[188]); 
  VVV1_0(w[77], w[1], w[22], pars->GC_10, amp[189]); 
  FFV1_0(w[59], w[31], w[0], pars->GC_11, amp[190]); 
  VVV1_0(w[0], w[47], w[22], pars->GC_10, amp[191]); 
  FFV1_0(w[21], w[5], w[87], pars->GC_11, amp[192]); 
  FFV1_0(w[21], w[5], w[88], pars->GC_11, amp[193]); 
  FFV1_0(w[21], w[5], w[89], pars->GC_11, amp[194]); 
  FFV1_0(w[78], w[5], w[46], pars->GC_11, amp[195]); 
  FFV1_0(w[78], w[29], w[1], pars->GC_11, amp[196]); 
  FFV1_0(w[60], w[5], w[79], pars->GC_11, amp[197]); 
  VVV1_0(w[79], w[1], w[26], pars->GC_10, amp[198]); 
  FFV1_0(w[60], w[29], w[0], pars->GC_11, amp[199]); 
  VVV1_0(w[0], w[46], w[26], pars->GC_10, amp[200]); 
  FFV1_0(w[25], w[5], w[84], pars->GC_11, amp[201]); 
  FFV1_0(w[25], w[5], w[85], pars->GC_11, amp[202]); 
  FFV1_0(w[25], w[5], w[86], pars->GC_11, amp[203]); 

}
double P0_Sigma_sm_gg_mumvmxuddxdx_W_4j::matrix_gg_wmuddxdx_wm_mumvmx() 
{
  int i, j; 
  // Local variables
