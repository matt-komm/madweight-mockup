...
#include "P0_Sigma_sm_ddx_mumvmxuddxdx_W_4j.h"
...
// Process: d d~ > w- u d d~ d~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: s s~ > w- c s s~ s~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_ddx_mumvmxuddxdx_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_ddx_mumvmxuddxdx_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_ddx_wmuddxdx_wm_mumvmx(); 
        ...
        t[1] = matrix_ddx_wmuddxdx_wm_mumvmx(); 
        double tsum = 0; 
...
double P0_Sigma_sm_ddx_mumvmxuddxdx_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_ddx_mumvmxuddxdx_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[7], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[10]); 
  ...
  FFV1_3(w[7], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[17]); 
  FFV1_1(w[1], w[17], pars->GC_11, pars->ZERO, pars->ZERO, w[18]); 
  FFV1_2(w[8], w[17], pars->GC_11, pars->ZERO, pars->ZERO, w[19]); 
  FFV1_3(w[8], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[20]); 
  ...
  FFV1_1(w[6], w[20], pars->GC_11, pars->ZERO, pars->ZERO, w[24]); 
  FFV1_2(w[7], w[14], pars->GC_11, pars->ZERO, pars->ZERO, w[25]); 
  FFV1_1(w[1], w[14], pars->GC_11, pars->ZERO, pars->ZERO, w[26]); 
  FFV1_3(w[0], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[27]); 
  FFV2_2(w[7], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[28]); 
  FFV1_1(w[6], w[27], pars->GC_11, pars->ZERO, pars->ZERO, w[29]); 
  FFV1_3(w[28], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[30]); 
  FFV1_2(w[8], w[27], pars->GC_11, pars->ZERO, pars->ZERO, w[31]); 
  FFV1_2(w[28], w[27], pars->GC_11, pars->ZERO, pars->ZERO, w[32]); 
  FFV1_1(w[5], w[27], pars->GC_11, pars->ZERO, pars->ZERO, w[33]); 
  VVV1_1(w[27], w[14], pars->GC_10, pars->ZERO, pars->ZERO, w[34]); 
  FFV1_1(w[5], w[17], pars->GC_11, pars->ZERO, pars->ZERO, w[35]); 
  FFV2_1(w[5], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[36]); 
  ...
  FFV1_3(w[39], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[44]); 
  FFV1_1(w[5], w[14], pars->GC_11, pars->ZERO, pars->ZERO, w[45]); 
  FFV1_3(w[0], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[46]); 
  FFV1_1(w[1], w[46], pars->GC_11, pars->ZERO, pars->ZERO, w[47]); 
  FFV1_2(w[8], w[46], pars->GC_11, pars->ZERO, pars->ZERO, w[48]); 
  FFV1_2(w[28], w[46], pars->GC_11, pars->ZERO, pars->ZERO, w[49]); 
  FFV1_1(w[5], w[46], pars->GC_11, pars->ZERO, pars->ZERO, w[50]); 
  VVV1_1(w[46], w[20], pars->GC_10, pars->ZERO, pars->ZERO, w[51]); 
  FFV1_1(w[5], w[10], pars->GC_11, pars->ZERO, pars->ZERO, w[52]); 
  ...
  FFV1_1(w[5], w[20], pars->GC_11, pars->ZERO, pars->ZERO, w[57]); 
  FFV1_2(w[0], w[20], pars->GC_11, pars->ZERO, pars->ZERO, w[58]); 
  FFV1_2(w[0], w[14], pars->GC_11, pars->ZERO, pars->ZERO, w[59]); 
  FFV1_2(w[0], w[10], pars->GC_11, pars->ZERO, pars->ZERO, w[60]); 
  FFV1_3(w[0], w[36], pars->GC_11, pars->ZERO, pars->ZERO, w[61]); 
  FFV1_2(w[0], w[17], pars->GC_11, pars->ZERO, pars->ZERO, w[62]); 
  ...
  FFV1_0(w[19], w[1], w[11], pars->GC_11, amp[6]); 
  FFV1_0(w[21], w[5], w[20], pars->GC_11, amp[7]); 
  VVV1_0(w[17], w[20], w[11], pars->GC_10, amp[8]); 
  FFV1_0(w[22], w[5], w[17], pars->GC_11, amp[9]); 
  FFV1_0(w[23], w[6], w[11], pars->GC_11, amp[10]); 
  FFV1_0(w[7], w[24], w[11], pars->GC_11, amp[11]); 
  FFV1_0(w[25], w[1], w[11], pars->GC_11, amp[12]); 
  FFV1_0(w[7], w[26], w[11], pars->GC_11, amp[13]); 
  FFV1_0(w[8], w[29], w[30], pars->GC_11, amp[14]); 
  FFV1_0(w[31], w[6], w[30], pars->GC_11, amp[15]); 
  FFV1_0(w[32], w[5], w[14], pars->GC_11, amp[16]); 
  FFV1_0(w[28], w[33], w[14], pars->GC_11, amp[17]); 
  FFV1_0(w[28], w[5], w[34], pars->GC_11, amp[18]); 
  FFV2_0(w[19], w[33], w[4], pars->GC_100, amp[19]); 
  ...
  FFV1_0(w[39], w[5], w[37], pars->GC_11, amp[24]); 
  FFV1_0(w[40], w[5], w[17], pars->GC_11, amp[25]); 
  FFV1_0(w[39], w[33], w[17], pars->GC_11, amp[26]); 
  FFV1_0(w[41], w[6], w[42], pars->GC_11, amp[27]); 
  FFV1_0(w[8], w[29], w[43], pars->GC_11, amp[28]); 
  FFV1_0(w[7], w[29], w[42], pars->GC_11, amp[29]); 
  FFV1_0(w[31], w[6], w[43], pars->GC_11, amp[30]); 
  FFV1_0(w[41], w[36], w[14], pars->GC_11, amp[31]); 
  FFV1_0(w[7], w[38], w[14], pars->GC_11, amp[32]); 
  FFV1_0(w[7], w[36], w[34], pars->GC_11, amp[33]); 
  FFV1_0(w[41], w[6], w[44], pars->GC_11, amp[34]); 
  FFV1_0(w[7], w[29], w[44], pars->GC_11, amp[35]); 
  FFV2_0(w[41], w[45], w[4], pars->GC_100, amp[36]); 
  FFV2_0(w[25], w[33], w[4], pars->GC_100, amp[37]); 
  FFV1_0(w[8], w[47], w[30], pars->GC_11, amp[38]); 
  FFV1_0(w[48], w[1], w[30], pars->GC_11, amp[39]); 
  FFV1_0(w[49], w[5], w[20], pars->GC_11, amp[40]); 
  FFV1_0(w[28], w[50], w[20], pars->GC_11, amp[41]); 
  FFV1_0(w[28], w[5], w[51], pars->GC_11, amp[42]); 
  FFV2_0(w[13], w[50], w[4], pars->GC_100, amp[43]); 
  ...
  FFV1_0(w[55], w[5], w[10], pars->GC_11, amp[49]); 
  FFV1_0(w[39], w[50], w[10], pars->GC_11, amp[50]); 
  FFV1_0(w[56], w[1], w[42], pars->GC_11, amp[51]); 
  FFV1_0(w[8], w[47], w[43], pars->GC_11, amp[52]); 
  FFV1_0(w[7], w[47], w[42], pars->GC_11, amp[53]); 
  FFV1_0(w[48], w[1], w[43], pars->GC_11, amp[54]); 
  FFV1_0(w[56], w[36], w[20], pars->GC_11, amp[55]); 
  FFV1_0(w[7], w[54], w[20], pars->GC_11, amp[56]); 
  FFV1_0(w[7], w[36], w[51], pars->GC_11, amp[57]); 
  FFV1_0(w[56], w[1], w[44], pars->GC_11, amp[58]); 
  FFV1_0(w[7], w[47], w[44], pars->GC_11, amp[59]); 
  FFV2_0(w[56], w[57], w[4], pars->GC_100, amp[60]); 
  FFV2_0(w[23], w[50], w[4], pars->GC_100, amp[61]); 
  FFV1_0(w[58], w[6], w[30], pars->GC_11, amp[62]); 
  FFV1_0(w[0], w[24], w[30], pars->GC_11, amp[63]); 
  FFV1_0(w[59], w[1], w[30], pars->GC_11, amp[64]); 
  FFV1_0(w[0], w[26], w[30], pars->GC_11, amp[65]); 
  FFV1_0(w[60], w[6], w[42], pars->GC_11, amp[66]); 
  FFV1_0(w[8], w[12], w[61], pars->GC_11, amp[67]); 
  FFV1_0(w[13], w[6], w[61], pars->GC_11, amp[68]); 
  FFV1_0(w[0], w[12], w[42], pars->GC_11, amp[69]); 
  FFV1_0(w[60], w[36], w[14], pars->GC_11, amp[70]); 
  VVV1_0(w[10], w[14], w[61], pars->GC_10, amp[71]); 
  FFV1_0(w[59], w[36], w[10], pars->GC_11, amp[72]); 
  FFV1_0(w[60], w[6], w[44], pars->GC_11, amp[73]); 
  FFV1_0(w[0], w[12], w[44], pars->GC_11, amp[74]); 
  FFV2_0(w[60], w[45], w[4], pars->GC_100, amp[75]); 
  FFV2_0(w[59], w[52], w[4], pars->GC_100, amp[76]); 
  FFV1_0(w[62], w[1], w[42], pars->GC_11, amp[77]); 
  FFV1_0(w[8], w[18], w[61], pars->GC_11, amp[78]); 
  FFV1_0(w[19], w[1], w[61], pars->GC_11, amp[79]); 
  FFV1_0(w[0], w[18], w[42], pars->GC_11, amp[80]); 
  FFV1_0(w[62], w[36], w[20], pars->GC_11, amp[81]); 
  VVV1_0(w[17], w[20], w[61], pars->GC_10, amp[82]); 
  FFV1_0(w[58], w[36], w[17], pars->GC_11, amp[83]); 
  FFV1_0(w[62], w[1], w[44], pars->GC_11, amp[84]); 
  FFV1_0(w[0], w[18], w[44], pars->GC_11, amp[85]); 
  FFV2_0(w[62], w[57], w[4], pars->GC_100, amp[86]); 
  FFV2_0(w[58], w[35], w[4], pars->GC_100, amp[87]); 
  FFV1_0(w[23], w[6], w[61], pars->GC_11, amp[88]); 
  FFV1_0(w[7], w[24], w[61], pars->GC_11, amp[89]); 
  FFV1_0(w[58], w[6], w[43], pars->GC_11, amp[90]); 
  FFV1_0(w[0], w[24], w[43], pars->GC_11, amp[91]); 
  FFV1_0(w[25], w[1], w[61], pars->GC_11, amp[92]); 
  FFV1_0(w[7], w[26], w[61], pars->GC_11, amp[93]); 
  FFV1_0(w[59], w[1], w[43], pars->GC_11, amp[94]); 
  FFV1_0(w[0], w[26], w[43], pars->GC_11, amp[95]); 

}
double P0_Sigma_sm_ddx_mumvmxuddxdx_W_4j::matrix_ddx_wmuddxdx_wm_mumvmx() 
{
  int i, j; 
  // Local variables
  ...
  jamp[0] = +1./4. * (+1./3. * amp[2] + 1./3. * amp[4] + amp[6] -
      std::complex<double> (0, 1) * amp[8] + amp[9] + amp[11] + 1./3. * amp[12]
      + 1./3. * amp[13] + 1./9. * amp[14] + 1./9. * amp[15] + 1./9. * amp[16] +
      1./9. * amp[17] + 1./3. * amp[19] + 1./3. * amp[20] + 1./3. * amp[22] +
      1./3. * amp[23] + 1./3. * amp[25] + 1./3. * amp[26] + 1./3. * amp[27] +
      1./9. * amp[28] + 1./3. * amp[29] + 1./9. * amp[30] + 1./9. * amp[31] +
      1./9. * amp[32] + 1./3. * amp[34] + 1./3. * amp[35] + 1./9. * amp[36] +
      1./9. * amp[37] + 1./3. * amp[38] + 1./3. * amp[39] + amp[44] +
  ...
  jamp[1] = +1./4. * (-amp[0] - amp[2] - std::complex<double> (0, 1) * amp[3] -
      1./3. * amp[5] - 1./3. * amp[6] - 1./3. * amp[7] - 1./3. * amp[9] -
      amp[12] - 1./3. * amp[14] - 1./3. * amp[15] - 1./3. * amp[16] - 1./3. *
      amp[17] - 1./9. * amp[19] - 1./9. * amp[20] - 1./9. * amp[22] - 1./9. *
      ...
      amp[37] - amp[38] - amp[40] - std::complex<double> (0, 1) * amp[42] -
  ...
  jamp[2] = +1./4. * (-1./9. * amp[0] - 1./9. * amp[1] - 1./9. * amp[2] - 1./9.
      * amp[4] - 1./3. * amp[5] - 1./3. * amp[6] - 1./3. * amp[10] - 1./3. *
      ...
      amp[17] - amp[19] + std::complex<double> (0, 1) * amp[21] - amp[22] +
      std::complex<double> (0, 1) * amp[24] - amp[26] - amp[27] - 1./3. *
      amp[31] - 1./3. * amp[32] - amp[34] - 1./3. * amp[36] - 1./3. * amp[37] -
      amp[39] - amp[41] + std::complex<double> (0, 1) * amp[42] - 1./3. *
  ...
  jamp[3] = +1./4. * (+1./3. * amp[0] + 1./3. * amp[1] + 1./3. * amp[2] + 1./3.
      * amp[4] + amp[5] + amp[7] + std::complex<double> (0, 1) * amp[8] +
      amp[10] + amp[14] + amp[16] + std::complex<double> (0, 1) * amp[18] +
      ...
      amp[41] + 1./9. * amp[43] + 1./9. * amp[44] + 1./9. * amp[46] + 1./9. *
  ...
  jamp[4] = +1./4. * (+1./3. * amp[0] + 1./3. * amp[1] + 1./9. * amp[5] + 1./9.
      * amp[6] + 1./9. * amp[7] + 1./9. * amp[9] + 1./9. * amp[10] + 1./9. *
      amp[11] + 1./3. * amp[12] + 1./3. * amp[13] + amp[15] + amp[17] -
      std::complex<double> (0, 1) * amp[18] + 1./3. * amp[19] + 1./3. * amp[20]
      + 1./3. * amp[22] + 1./3. * amp[23] + 1./3. * amp[25] + 1./3. * amp[26] +
      amp[30] + amp[32] - std::complex<double> (0, 1) * amp[33] + amp[37] +
      1./3. * amp[40] + 1./3. * amp[41] + amp[43] - std::complex<double> (0, 1)
      * amp[45] + amp[46] - std::complex<double> (0, 1) * amp[48] + amp[50] +
      amp[51] + 1./3. * amp[55] + 1./3. * amp[56] + amp[58] + 1./3. * amp[60] +
      1./3. * amp[61] + 1./3. * amp[62] + 1./3. * amp[63] + amp[65] + 1./3. *
      amp[67] + 1./3. * amp[68] + amp[69] + amp[74] + 1./3. * amp[77] + 1./9. *
      amp[78] + 1./9. * amp[79] + 1./3. * amp[80] + 1./9. * amp[81] + 1./9. *
      amp[83] + 1./3. * amp[84] + 1./3. * amp[85] + 1./9. * amp[86] + 1./9. *
      amp[87] + 1./9. * amp[88] + 1./9. * amp[89] + 1./3. * amp[90] + 1./3. *
      amp[91] + 1./3. * amp[92] + 1./3. * amp[93] + amp[95]);
  jamp[5] = +1./4. * (-amp[1] + std::complex<double> (0, 1) * amp[3] - amp[4] -
      ...
      amp[41] - 1./3. * amp[43] - 1./3. * amp[44] - 1./3. * amp[46] - 1./3. *
