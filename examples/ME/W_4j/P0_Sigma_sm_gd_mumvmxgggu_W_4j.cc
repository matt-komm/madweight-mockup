...
#include "P0_Sigma_sm_gd_mumvmxgggu_W_4j.h"
...
void P0_Sigma_sm_gd_mumvmxgggu_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_gd_mumvmxgggu_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_gd_wmgggu_wm_mumvmx(); 
        ...
        t[1] = matrix_gd_wmgggu_wm_mumvmx(); 
        double tsum = 0; 
...
double P0_Sigma_sm_gd_mumvmxgggu_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_gd_mumvmxgggu_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double P0_Sigma_sm_gd_mumvmxgggu_W_4j::matrix_gd_wmgggu_wm_mumvmx() 
{
  int i, j; 
  // Local variables
