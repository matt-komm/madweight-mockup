...
#include "P0_Sigma_sm_gg_mumvmxggudx_W_4j.h"
...
// Process: g g > w- g g u d~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: g g > w- g g c s~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_gg_mumvmxggudx_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_gg_mumvmxggudx_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_gg_wmggudx_wm_mumvmx(); 
...
double P0_Sigma_sm_gg_mumvmxggudx_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_gg_mumvmxggudx_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  VVV1_1(w[0], w[1], pars->GC_10, pars->ZERO, pars->ZERO, w[9]); 
  FFV2_1(w[7], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[10]); 
  VVV1_1(w[9], w[5], pars->GC_10, pars->ZERO, pars->ZERO, w[11]); 
  FFV1_1(w[10], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[12]); 
  FFV1_3(w[8], w[10], pars->GC_11, pars->ZERO, pars->ZERO, w[13]); 
  VVV1_1(w[9], w[6], pars->GC_10, pars->ZERO, pars->ZERO, w[14]); 
  FFV1_1(w[10], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[15]); 
  FFV1_2(w[8], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[16]); 
  VVVV1_1(w[9], w[5], w[6], pars->GC_12, pars->ZERO, pars->ZERO, w[17]); 
  VVVV3_1(w[9], w[5], w[6], pars->GC_12, pars->ZERO, pars->ZERO, w[18]); 
  VVVV4_1(w[9], w[5], w[6], pars->GC_12, pars->ZERO, pars->ZERO, w[19]); 
  VVV1_1(w[5], w[6], pars->GC_10, pars->ZERO, pars->ZERO, w[20]); 
  FFV1_1(w[10], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[21]); 
  VVV1_1(w[9], w[20], pars->GC_10, pars->ZERO, pars->ZERO, w[22]); 
  FFV1_2(w[8], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[23]); 
  FFV1_2(w[23], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[24]); 
  FFV1_2(w[8], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[25]); 
  FFV1_2(w[25], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[26]); 
  FFV2_2(w[8], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[27]); 
  FFV1_2(w[27], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[28]); 
  FFV1_3(w[27], w[7], pars->GC_11, pars->ZERO, pars->ZERO, w[29]); 
  FFV1_2(w[27], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[30]); 
  FFV1_1(w[7], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[31]); 
  ...
  FFV1_1(w[7], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[35]); 
  FFV1_1(w[35], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[36]); 
  FFV1_2(w[8], w[20], pars->GC_11, pars->ZERO, pars->ZERO, w[37]); 
  FFV1_1(w[7], w[20], pars->GC_11, pars->ZERO, pars->ZERO, w[38]); 
  FFV2_1(w[33], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[39]); 
  FFV1_1(w[33], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[40]); 
  FFV2_2(w[23], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[41]); 
  FFV1_2(w[23], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[42]); 
  FFV2_1(w[35], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[43]); 
  FFV1_1(w[35], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[44]); 
  FFV2_2(w[25], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[45]); 
  FFV1_2(w[25], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[46]); 
  VVV1_1(w[0], w[5], pars->GC_10, pars->ZERO, pars->ZERO, w[47]); 
  VVV1_1(w[1], w[6], pars->GC_10, pars->ZERO, pars->ZERO, w[48]); 
  FFV1_1(w[7], w[47], pars->GC_11, pars->ZERO, pars->ZERO, w[49]); 
  FFV1_2(w[8], w[48], pars->GC_11, pars->ZERO, pars->ZERO, w[50]); 
  FFV1_2(w[8], w[47], pars->GC_11, pars->ZERO, pars->ZERO, w[51]); 
  FFV1_1(w[7], w[48], pars->GC_11, pars->ZERO, pars->ZERO, w[52]); 
  ...
  FFV1_1(w[7], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[56]); 
  VVV1_1(w[47], w[6], pars->GC_10, pars->ZERO, pars->ZERO, w[57]); 
  FFV2_1(w[56], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[58]); 
  FFV1_1(w[56], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[59]); 
  FFV1_1(w[56], w[47], pars->GC_11, pars->ZERO, pars->ZERO, w[60]); 
  FFV1_2(w[25], w[47], pars->GC_11, pars->ZERO, pars->ZERO, w[61]); 
  FFV1_2(w[8], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[62]); 
  FFV2_2(w[62], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[63]); 
  FFV1_2(w[62], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[64]); 
  FFV1_2(w[62], w[47], pars->GC_11, pars->ZERO, pars->ZERO, w[65]); 
  FFV1_1(w[35], w[47], pars->GC_11, pars->ZERO, pars->ZERO, w[66]); 
  VVV1_1(w[47], w[1], pars->GC_10, pars->ZERO, pars->ZERO, w[67]); 
  FFV1_1(w[10], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[68]); 
  VVVV1_1(w[47], w[1], w[6], pars->GC_12, pars->ZERO, pars->ZERO, w[69]); 
  VVVV3_1(w[47], w[1], w[6], pars->GC_12, pars->ZERO, pars->ZERO, w[70]); 
  VVVV4_1(w[47], w[1], w[6], pars->GC_12, pars->ZERO, pars->ZERO, w[71]); 
  FFV1_2(w[27], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[72]); 
  FFV1_1(w[35], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[73]); 
  FFV1_2(w[25], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[74]); 
  VVV1_1(w[0], w[6], pars->GC_10, pars->ZERO, pars->ZERO, w[75]); 
  VVV1_1(w[1], w[5], pars->GC_10, pars->ZERO, pars->ZERO, w[76]); 
  FFV1_1(w[7], w[75], pars->GC_11, pars->ZERO, pars->ZERO, w[77]); 
  FFV1_2(w[8], w[76], pars->GC_11, pars->ZERO, pars->ZERO, w[78]); 
  FFV1_2(w[8], w[75], pars->GC_11, pars->ZERO, pars->ZERO, w[79]); 
  FFV1_1(w[7], w[76], pars->GC_11, pars->ZERO, pars->ZERO, w[80]); 
  ...
  VVV1_1(w[75], w[5], pars->GC_10, pars->ZERO, pars->ZERO, w[84]); 
  FFV1_1(w[56], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[85]); 
  FFV1_1(w[56], w[75], pars->GC_11, pars->ZERO, pars->ZERO, w[86]); 
  FFV1_2(w[23], w[75], pars->GC_11, pars->ZERO, pars->ZERO, w[87]); 
  FFV1_2(w[62], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[88]); 
  FFV1_2(w[62], w[75], pars->GC_11, pars->ZERO, pars->ZERO, w[89]); 
  FFV1_1(w[33], w[75], pars->GC_11, pars->ZERO, pars->ZERO, w[90]); 
  VVV1_1(w[75], w[1], pars->GC_10, pars->ZERO, pars->ZERO, w[91]); 
  VVVV1_1(w[75], w[1], w[5], pars->GC_12, pars->ZERO, pars->ZERO, w[92]); 
  VVVV3_1(w[75], w[1], w[5], pars->GC_12, pars->ZERO, pars->ZERO, w[93]); 
  VVVV4_1(w[75], w[1], w[5], pars->GC_12, pars->ZERO, pars->ZERO, w[94]); 
  FFV1_1(w[33], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[95]); 
  FFV1_2(w[23], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[96]); 
  FFV1_1(w[7], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[97]); 
  FFV2_1(w[97], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[98]); 
  VVV1_1(w[76], w[6], pars->GC_10, pars->ZERO, pars->ZERO, w[99]); 
  FFV1_1(w[97], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[100]); 
  FFV1_1(w[97], w[76], pars->GC_11, pars->ZERO, pars->ZERO, w[101]); 
  FFV1_3(w[27], w[97], pars->GC_11, pars->ZERO, pars->ZERO, w[102]); 
  VVV1_1(w[48], w[5], pars->GC_10, pars->ZERO, pars->ZERO, w[103]); 
  FFV1_1(w[97], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[104]); 
  FFV1_1(w[97], w[48], pars->GC_11, pars->ZERO, pars->ZERO, w[105]); 
  FFV1_1(w[97], w[20], pars->GC_11, pars->ZERO, pars->ZERO, w[106]); 
  FFV1_1(w[97], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[107]); 
  VVV1_1(w[1], w[20], pars->GC_10, pars->ZERO, pars->ZERO, w[108]); 
  VVVV1_1(w[1], w[5], w[6], pars->GC_12, pars->ZERO, pars->ZERO, w[109]); 
  VVVV3_1(w[1], w[5], w[6], pars->GC_12, pars->ZERO, pars->ZERO, w[110]); 
  VVVV4_1(w[1], w[5], w[6], pars->GC_12, pars->ZERO, pars->ZERO, w[111]); 
  FFV1_2(w[8], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[112]); 
  FFV2_2(w[112], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[113]); 
  FFV1_2(w[112], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[114]); 
  FFV1_2(w[112], w[76], pars->GC_11, pars->ZERO, pars->ZERO, w[115]); 
  FFV1_3(w[112], w[10], pars->GC_11, pars->ZERO, pars->ZERO, w[116]); 
  FFV1_2(w[112], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[117]); 
  FFV1_2(w[112], w[48], pars->GC_11, pars->ZERO, pars->ZERO, w[118]); 
  FFV1_2(w[112], w[20], pars->GC_11, pars->ZERO, pars->ZERO, w[119]); 
  FFV1_2(w[112], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[120]); 
  VVV1_1(w[0], w[76], pars->GC_10, pars->ZERO, pars->ZERO, w[121]); 
  FFV1_1(w[10], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[122]); 
  VVVV1_1(w[0], w[76], w[6], pars->GC_12, pars->ZERO, pars->ZERO, w[123]); 
  VVVV3_1(w[0], w[76], w[6], pars->GC_12, pars->ZERO, pars->ZERO, w[124]); 
  VVVV4_1(w[0], w[76], w[6], pars->GC_12, pars->ZERO, pars->ZERO, w[125]); 
  ...
  VVVV1_1(w[0], w[48], w[5], pars->GC_12, pars->ZERO, pars->ZERO, w[130]); 
  VVVV3_1(w[0], w[48], w[5], pars->GC_12, pars->ZERO, pars->ZERO, w[131]); 
  VVVV4_1(w[0], w[48], w[5], pars->GC_12, pars->ZERO, pars->ZERO, w[132]); 
  ...
  VVVV1_1(w[0], w[1], w[20], pars->GC_12, pars->ZERO, pars->ZERO, w[138]); 
  VVVV3_1(w[0], w[1], w[20], pars->GC_12, pars->ZERO, pars->ZERO, w[139]); 
  VVVV4_1(w[0], w[1], w[20], pars->GC_12, pars->ZERO, pars->ZERO, w[140]); 
  VVVV1_1(w[0], w[1], w[5], pars->GC_12, pars->ZERO, pars->ZERO, w[141]); 
  VVVV3_1(w[0], w[1], w[5], pars->GC_12, pars->ZERO, pars->ZERO, w[142]); 
  VVVV4_1(w[0], w[1], w[5], pars->GC_12, pars->ZERO, pars->ZERO, w[143]); 
  VVV1_1(w[141], w[6], pars->GC_10, pars->ZERO, pars->ZERO, w[144]); 
  VVV1_1(w[142], w[6], pars->GC_10, pars->ZERO, pars->ZERO, w[145]); 
  VVV1_1(w[143], w[6], pars->GC_10, pars->ZERO, pars->ZERO, w[146]); 
  ...
  FFV1_1(w[7], w[141], pars->GC_11, pars->ZERO, pars->ZERO, w[150]); 
  FFV1_1(w[7], w[142], pars->GC_11, pars->ZERO, pars->ZERO, w[151]); 
  FFV1_1(w[7], w[143], pars->GC_11, pars->ZERO, pars->ZERO, w[152]); 
  VVVV1_1(w[0], w[1], w[6], pars->GC_12, pars->ZERO, pars->ZERO, w[153]); 
  VVVV3_1(w[0], w[1], w[6], pars->GC_12, pars->ZERO, pars->ZERO, w[154]); 
  VVVV4_1(w[0], w[1], w[6], pars->GC_12, pars->ZERO, pars->ZERO, w[155]); 
  VVV1_1(w[153], w[5], pars->GC_10, pars->ZERO, pars->ZERO, w[156]); 
  VVV1_1(w[154], w[5], pars->GC_10, pars->ZERO, pars->ZERO, w[157]); 
  VVV1_1(w[155], w[5], pars->GC_10, pars->ZERO, pars->ZERO, w[158]); 
  ...
  FFV1_1(w[7], w[153], pars->GC_11, pars->ZERO, pars->ZERO, w[162]); 
  FFV1_1(w[7], w[154], pars->GC_11, pars->ZERO, pars->ZERO, w[163]); 
  FFV1_1(w[7], w[155], pars->GC_11, pars->ZERO, pars->ZERO, w[164]); 
  VVVV1_1(w[0], w[5], w[6], pars->GC_12, pars->ZERO, pars->ZERO, w[165]); 
  VVVV3_1(w[0], w[5], w[6], pars->GC_12, pars->ZERO, pars->ZERO, w[166]); 
  VVVV4_1(w[0], w[5], w[6], pars->GC_12, pars->ZERO, pars->ZERO, w[167]); 
  ...
  FFV1_1(w[7], w[165], pars->GC_11, pars->ZERO, pars->ZERO, w[171]); 
  FFV1_1(w[7], w[166], pars->GC_11, pars->ZERO, pars->ZERO, w[172]); 
  FFV1_1(w[7], w[167], pars->GC_11, pars->ZERO, pars->ZERO, w[173]); 
  VVV1_1(w[165], w[1], pars->GC_10, pars->ZERO, pars->ZERO, w[174]); 
  VVV1_1(w[166], w[1], pars->GC_10, pars->ZERO, pars->ZERO, w[175]); 
  VVV1_1(w[167], w[1], pars->GC_10, pars->ZERO, pars->ZERO, w[176]); 
  ...
  VVV1_0(w[11], w[13], w[6], pars->GC_10, amp[1]); 
  FFV1_0(w[8], w[15], w[14], pars->GC_11, amp[2]); 
  VVV1_0(w[14], w[13], w[5], pars->GC_10, amp[3]); 
  FFV1_0(w[16], w[15], w[6], pars->GC_11, amp[4]); 
  FFV1_0(w[16], w[12], w[5], pars->GC_11, amp[5]); 
  ...
  FFV1_0(w[23], w[21], w[6], pars->GC_11, amp[12]); 
  FFV1_0(w[24], w[10], w[6], pars->GC_11, amp[13]); 
  FFV1_0(w[23], w[10], w[14], pars->GC_11, amp[14]); 
  FFV1_0(w[25], w[21], w[5], pars->GC_11, amp[15]); 
  FFV1_0(w[25], w[10], w[11], pars->GC_11, amp[16]); 
  FFV1_0(w[26], w[10], w[5], pars->GC_11, amp[17]); 
  FFV1_0(w[28], w[7], w[11], pars->GC_11, amp[18]); 
  VVV1_0(w[11], w[29], w[6], pars->GC_10, amp[19]); 
  FFV1_0(w[30], w[7], w[14], pars->GC_11, amp[20]); 
  VVV1_0(w[14], w[29], w[5], pars->GC_10, amp[21]); 
  FFV1_0(w[30], w[31], w[6], pars->GC_11, amp[22]); 
  FFV1_0(w[28], w[31], w[5], pars->GC_11, amp[23]); 
  FFV1_0(w[27], w[7], w[17], pars->GC_11, amp[24]); 
  FFV1_0(w[27], w[7], w[18], pars->GC_11, amp[25]); 
  FFV1_0(w[27], w[7], w[19], pars->GC_11, amp[26]); 
  FFV1_0(w[32], w[7], w[20], pars->GC_11, amp[27]); 
  FFV1_0(w[27], w[7], w[22], pars->GC_11, amp[28]); 
  FFV1_0(w[27], w[31], w[20], pars->GC_11, amp[29]); 
  FFV1_0(w[32], w[33], w[6], pars->GC_11, amp[30]); 
  FFV1_0(w[27], w[34], w[6], pars->GC_11, amp[31]); 
  FFV1_0(w[27], w[33], w[14], pars->GC_11, amp[32]); 
  FFV1_0(w[32], w[35], w[5], pars->GC_11, amp[33]); 
  FFV1_0(w[27], w[35], w[11], pars->GC_11, amp[34]); 
  FFV1_0(w[27], w[36], w[5], pars->GC_11, amp[35]); 
  FFV2_0(w[37], w[31], w[4], pars->GC_100, amp[36]); 
  FFV2_0(w[16], w[38], w[4], pars->GC_100, amp[37]); 
  FFV1_0(w[8], w[39], w[14], pars->GC_11, amp[38]); 
  FFV1_0(w[16], w[39], w[6], pars->GC_11, amp[39]); 
  FFV2_0(w[16], w[40], w[4], pars->GC_100, amp[40]); 
  FFV2_0(w[25], w[34], w[4], pars->GC_100, amp[41]); 
  FFV2_0(w[26], w[33], w[4], pars->GC_100, amp[42]); 
  FFV1_0(w[41], w[7], w[14], pars->GC_11, amp[43]); 
  FFV1_0(w[41], w[31], w[6], pars->GC_11, amp[44]); 
  ...
  FFV1_0(w[16], w[43], w[5], pars->GC_11, amp[49]); 
  FFV2_0(w[16], w[44], w[4], pars->GC_100, amp[50]); 
  FFV1_0(w[45], w[7], w[11], pars->GC_11, amp[51]); 
  FFV1_0(w[45], w[31], w[5], pars->GC_11, amp[52]); 
  ...
  FFV1_0(w[27], w[7], w[53], pars->GC_11, amp[59]); 
  FFV1_0(w[55], w[7], w[48], pars->GC_11, amp[60]); 
  FFV1_0(w[27], w[49], w[48], pars->GC_11, amp[61]); 
  FFV1_0(w[8], w[58], w[57], pars->GC_11, amp[62]); 
  FFV1_0(w[51], w[58], w[6], pars->GC_11, amp[63]); 
  FFV2_0(w[51], w[59], w[4], pars->GC_100, amp[64]); 
  FFV1_0(w[27], w[60], w[6], pars->GC_11, amp[65]); 
  FFV1_0(w[55], w[56], w[6], pars->GC_11, amp[66]); 
  FFV1_0(w[27], w[56], w[57], pars->GC_11, amp[67]); 
  FFV2_0(w[25], w[60], w[4], pars->GC_100, amp[68]); 
  FFV2_0(w[61], w[56], w[4], pars->GC_100, amp[69]); 
  FFV1_0(w[63], w[7], w[57], pars->GC_11, amp[70]); 
  FFV1_0(w[63], w[49], w[6], pars->GC_11, amp[71]); 
  FFV2_0(w[64], w[49], w[4], pars->GC_100, amp[72]); 
  FFV1_0(w[65], w[10], w[6], pars->GC_11, amp[73]); 
  FFV1_0(w[62], w[54], w[6], pars->GC_11, amp[74]); 
  ...
  VVV1_0(w[67], w[13], w[6], pars->GC_10, amp[79]); 
  FFV1_0(w[8], w[68], w[57], pars->GC_11, amp[80]); 
  VVV1_0(w[57], w[1], w[13], pars->GC_10, amp[81]); 
  FFV1_0(w[51], w[68], w[6], pars->GC_11, amp[82]); 
  FFV1_0(w[51], w[12], w[1], pars->GC_11, amp[83]); 
  ...
  FFV1_0(w[25], w[54], w[1], pars->GC_11, amp[88]); 
  FFV1_0(w[61], w[10], w[1], pars->GC_11, amp[89]); 
  FFV1_0(w[28], w[7], w[67], pars->GC_11, amp[90]); 
  VVV1_0(w[67], w[29], w[6], pars->GC_10, amp[91]); 
  FFV1_0(w[72], w[7], w[57], pars->GC_11, amp[92]); 
  VVV1_0(w[57], w[1], w[29], pars->GC_10, amp[93]); 
  FFV1_0(w[72], w[49], w[6], pars->GC_11, amp[94]); 
  FFV1_0(w[28], w[49], w[1], pars->GC_11, amp[95]); 
  FFV1_0(w[27], w[7], w[69], pars->GC_11, amp[96]); 
  FFV1_0(w[27], w[7], w[70], pars->GC_11, amp[97]); 
  FFV1_0(w[27], w[7], w[71], pars->GC_11, amp[98]); 
  FFV1_0(w[27], w[35], w[67], pars->GC_11, amp[99]); 
  FFV1_0(w[55], w[35], w[1], pars->GC_11, amp[100]); 
  FFV1_0(w[27], w[66], w[1], pars->GC_11, amp[101]); 
  FFV1_0(w[8], w[43], w[67], pars->GC_11, amp[102]); 
  FFV2_0(w[51], w[73], w[4], pars->GC_100, amp[103]); 
  FFV1_0(w[51], w[43], w[1], pars->GC_11, amp[104]); 
  FFV1_0(w[45], w[7], w[67], pars->GC_11, amp[105]); 
  FFV2_0(w[74], w[49], w[4], pars->GC_100, amp[106]); 
  FFV1_0(w[45], w[49], w[1], pars->GC_11, amp[107]); 
  ...
  FFV1_0(w[27], w[7], w[81], pars->GC_11, amp[113]); 
  FFV1_0(w[83], w[7], w[76], pars->GC_11, amp[114]); 
  FFV1_0(w[27], w[77], w[76], pars->GC_11, amp[115]); 
  FFV1_0(w[8], w[58], w[84], pars->GC_11, amp[116]); 
  FFV1_0(w[79], w[58], w[5], pars->GC_11, amp[117]); 
  FFV2_0(w[79], w[85], w[4], pars->GC_100, amp[118]); 
  FFV1_0(w[27], w[86], w[5], pars->GC_11, amp[119]); 
  FFV1_0(w[83], w[56], w[5], pars->GC_11, amp[120]); 
  FFV1_0(w[27], w[56], w[84], pars->GC_11, amp[121]); 
  FFV2_0(w[23], w[86], w[4], pars->GC_100, amp[122]); 
  FFV2_0(w[87], w[56], w[4], pars->GC_100, amp[123]); 
  FFV1_0(w[63], w[7], w[84], pars->GC_11, amp[124]); 
  FFV1_0(w[63], w[77], w[5], pars->GC_11, amp[125]); 
  FFV2_0(w[88], w[77], w[4], pars->GC_100, amp[126]); 
  FFV1_0(w[89], w[10], w[5], pars->GC_11, amp[127]); 
  FFV1_0(w[62], w[82], w[5], pars->GC_11, amp[128]); 
  ...
  VVV1_0(w[91], w[13], w[5], pars->GC_10, amp[133]); 
  FFV1_0(w[8], w[68], w[84], pars->GC_11, amp[134]); 
  VVV1_0(w[84], w[1], w[13], pars->GC_10, amp[135]); 
  FFV1_0(w[79], w[68], w[5], pars->GC_11, amp[136]); 
  FFV1_0(w[79], w[15], w[1], pars->GC_11, amp[137]); 
  ...
  FFV1_0(w[23], w[82], w[1], pars->GC_11, amp[142]); 
  FFV1_0(w[87], w[10], w[1], pars->GC_11, amp[143]); 
  FFV1_0(w[30], w[7], w[91], pars->GC_11, amp[144]); 
  VVV1_0(w[91], w[29], w[5], pars->GC_10, amp[145]); 
  FFV1_0(w[72], w[7], w[84], pars->GC_11, amp[146]); 
  VVV1_0(w[84], w[1], w[29], pars->GC_10, amp[147]); 
  FFV1_0(w[72], w[77], w[5], pars->GC_11, amp[148]); 
  FFV1_0(w[30], w[77], w[1], pars->GC_11, amp[149]); 
  FFV1_0(w[27], w[7], w[92], pars->GC_11, amp[150]); 
  FFV1_0(w[27], w[7], w[93], pars->GC_11, amp[151]); 
  FFV1_0(w[27], w[7], w[94], pars->GC_11, amp[152]); 
  FFV1_0(w[27], w[33], w[91], pars->GC_11, amp[153]); 
  FFV1_0(w[83], w[33], w[1], pars->GC_11, amp[154]); 
  FFV1_0(w[27], w[90], w[1], pars->GC_11, amp[155]); 
  FFV1_0(w[8], w[39], w[91], pars->GC_11, amp[156]); 
  FFV2_0(w[79], w[95], w[4], pars->GC_100, amp[157]); 
  FFV1_0(w[79], w[39], w[1], pars->GC_11, amp[158]); 
  FFV1_0(w[41], w[7], w[91], pars->GC_11, amp[159]); 
  FFV2_0(w[96], w[77], w[4], pars->GC_100, amp[160]); 
  FFV1_0(w[41], w[77], w[1], pars->GC_11, amp[161]); 
  FFV1_0(w[8], w[98], w[99], pars->GC_11, amp[162]); 
  FFV1_0(w[78], w[98], w[6], pars->GC_11, amp[163]); 
  FFV2_0(w[78], w[100], w[4], pars->GC_100, amp[164]); 
  FFV1_0(w[27], w[101], w[6], pars->GC_11, amp[165]); 
  VVV1_0(w[76], w[6], w[102], pars->GC_10, amp[166]); 
  ...
  FFV1_0(w[50], w[98], w[5], pars->GC_11, amp[171]); 
  FFV2_0(w[50], w[104], w[4], pars->GC_100, amp[172]); 
  FFV1_0(w[27], w[105], w[5], pars->GC_11, amp[173]); 
  VVV1_0(w[48], w[5], w[102], pars->GC_10, amp[174]); 
  ...
  FFV1_0(w[88], w[98], w[6], pars->GC_11, amp[178]); 
  FFV1_0(w[64], w[98], w[5], pars->GC_11, amp[179]); 
  FFV1_0(w[63], w[104], w[6], pars->GC_11, amp[180]); 
  FFV2_0(w[64], w[104], w[4], pars->GC_100, amp[181]); 
  FFV1_0(w[63], w[100], w[5], pars->GC_11, amp[182]); 
  ...
  FFV1_0(w[30], w[107], w[6], pars->GC_11, amp[186]); 
  FFV1_0(w[28], w[107], w[5], pars->GC_11, amp[187]); 
  FFV1_0(w[72], w[104], w[6], pars->GC_11, amp[188]); 
  FFV1_0(w[28], w[104], w[1], pars->GC_11, amp[189]); 
  FFV1_0(w[72], w[100], w[5], pars->GC_11, amp[190]); 
  FFV1_0(w[30], w[100], w[1], pars->GC_11, amp[191]); 
  FFV1_0(w[27], w[107], w[20], pars->GC_11, amp[192]); 
  VVV1_0(w[1], w[20], w[102], pars->GC_10, amp[193]); 
  FFV1_0(w[27], w[106], w[1], pars->GC_11, amp[194]); 
  FFV2_0(w[37], w[107], w[4], pars->GC_100, amp[195]); 
  FFV1_0(w[8], w[98], w[108], pars->GC_11, amp[196]); 
  FFV1_0(w[37], w[98], w[1], pars->GC_11, amp[197]); 
  FFV1_0(w[41], w[107], w[6], pars->GC_11, amp[198]); 
  FFV2_0(w[42], w[107], w[4], pars->GC_100, amp[199]); 
  FFV1_0(w[96], w[98], w[6], pars->GC_11, amp[200]); 
  FFV1_0(w[42], w[98], w[1], pars->GC_11, amp[201]); 
  FFV2_0(w[96], w[100], w[4], pars->GC_100, amp[202]); 
  FFV1_0(w[41], w[100], w[1], pars->GC_11, amp[203]); 
  FFV1_0(w[45], w[107], w[5], pars->GC_11, amp[204]); 
  FFV2_0(w[46], w[107], w[4], pars->GC_100, amp[205]); 
  FFV1_0(w[74], w[98], w[5], pars->GC_11, amp[206]); 
  FFV1_0(w[46], w[98], w[1], pars->GC_11, amp[207]); 
  FFV2_0(w[74], w[104], w[4], pars->GC_100, amp[208]); 
  FFV1_0(w[45], w[104], w[1], pars->GC_11, amp[209]); 
  ...
  FFV1_0(w[113], w[7], w[99], pars->GC_11, amp[216]); 
  FFV1_0(w[113], w[80], w[6], pars->GC_11, amp[217]); 
  FFV2_0(w[114], w[80], w[4], pars->GC_100, amp[218]); 
  FFV1_0(w[115], w[10], w[6], pars->GC_11, amp[219]); 
  VVV1_0(w[76], w[6], w[116], pars->GC_10, amp[220]); 
  ...
  FFV1_0(w[113], w[7], w[103], pars->GC_11, amp[224]); 
  FFV1_0(w[113], w[52], w[5], pars->GC_11, amp[225]); 
  FFV2_0(w[117], w[52], w[4], pars->GC_100, amp[226]); 
  FFV1_0(w[118], w[10], w[5], pars->GC_11, amp[227]); 
  VVV1_0(w[48], w[5], w[116], pars->GC_10, amp[228]); 
  ...
  FFV1_0(w[113], w[85], w[6], pars->GC_11, amp[232]); 
  FFV1_0(w[113], w[59], w[5], pars->GC_11, amp[233]); 
  FFV1_0(w[117], w[58], w[6], pars->GC_11, amp[234]); 
  FFV2_0(w[117], w[59], w[4], pars->GC_100, amp[235]); 
  FFV1_0(w[114], w[58], w[5], pars->GC_11, amp[236]); 
  ...
  FFV1_0(w[120], w[15], w[6], pars->GC_11, amp[240]); 
  FFV1_0(w[120], w[12], w[5], pars->GC_11, amp[241]); 
  FFV1_0(w[117], w[68], w[6], pars->GC_11, amp[242]); 
  FFV1_0(w[117], w[12], w[1], pars->GC_11, amp[243]); 
  FFV1_0(w[114], w[68], w[5], pars->GC_11, amp[244]); 
  FFV1_0(w[114], w[15], w[1], pars->GC_11, amp[245]); 
  FFV1_0(w[120], w[10], w[20], pars->GC_11, amp[246]); 
  VVV1_0(w[1], w[20], w[116], pars->GC_10, amp[247]); 
  FFV1_0(w[119], w[10], w[1], pars->GC_11, amp[248]); 
  FFV2_0(w[120], w[38], w[4], pars->GC_100, amp[249]); 
  FFV1_0(w[113], w[7], w[108], pars->GC_11, amp[250]); 
  FFV1_0(w[113], w[38], w[1], pars->GC_11, amp[251]); 
  FFV1_0(w[120], w[39], w[6], pars->GC_11, amp[252]); 
  FFV2_0(w[120], w[40], w[4], pars->GC_100, amp[253]); 
  FFV1_0(w[113], w[95], w[6], pars->GC_11, amp[254]); 
  FFV1_0(w[113], w[40], w[1], pars->GC_11, amp[255]); 
  FFV2_0(w[114], w[95], w[4], pars->GC_100, amp[256]); 
  FFV1_0(w[114], w[39], w[1], pars->GC_11, amp[257]); 
  FFV1_0(w[120], w[43], w[5], pars->GC_11, amp[258]); 
  FFV2_0(w[120], w[44], w[4], pars->GC_100, amp[259]); 
  FFV1_0(w[113], w[73], w[5], pars->GC_11, amp[260]); 
  FFV1_0(w[113], w[44], w[1], pars->GC_11, amp[261]); 
  FFV2_0(w[117], w[73], w[4], pars->GC_100, amp[262]); 
  FFV1_0(w[117], w[43], w[1], pars->GC_11, amp[263]); 
  FFV1_0(w[113], w[7], w[109], pars->GC_11, amp[264]); 
  FFV1_0(w[113], w[7], w[110], pars->GC_11, amp[265]); 
  FFV1_0(w[113], w[7], w[111], pars->GC_11, amp[266]); 
  ...
  VVV1_0(w[121], w[13], w[6], pars->GC_10, amp[271]); 
  FFV1_0(w[8], w[122], w[99], pars->GC_11, amp[272]); 
  FFV1_0(w[78], w[122], w[6], pars->GC_11, amp[273]); 
  ...
  FFV1_0(w[28], w[7], w[121], pars->GC_11, amp[282]); 
  VVV1_0(w[121], w[29], w[6], pars->GC_10, amp[283]); 
  FFV1_0(w[127], w[7], w[99], pars->GC_11, amp[284]); 
  FFV1_0(w[127], w[80], w[6], pars->GC_11, amp[285]); 
  VVV1_0(w[0], w[99], w[29], pars->GC_10, amp[286]); 
  FFV1_0(w[28], w[80], w[0], pars->GC_11, amp[287]); 
  FFV1_0(w[27], w[7], w[123], pars->GC_11, amp[288]); 
  FFV1_0(w[27], w[7], w[124], pars->GC_11, amp[289]); 
  FFV1_0(w[27], w[7], w[125], pars->GC_11, amp[290]); 
  ...
  FFV1_0(w[30], w[7], w[129], pars->GC_11, amp[312]); 
  VVV1_0(w[129], w[29], w[5], pars->GC_10, amp[313]); 
  FFV1_0(w[127], w[7], w[103], pars->GC_11, amp[314]); 
  FFV1_0(w[127], w[52], w[5], pars->GC_11, amp[315]); 
  VVV1_0(w[0], w[103], w[29], pars->GC_10, amp[316]); 
  FFV1_0(w[30], w[52], w[0], pars->GC_11, amp[317]); 
  FFV1_0(w[27], w[7], w[130], pars->GC_11, amp[318]); 
  FFV1_0(w[27], w[7], w[131], pars->GC_11, amp[319]); 
  FFV1_0(w[27], w[7], w[132], pars->GC_11, amp[320]); 
  ...
  FFV1_0(w[41], w[7], w[129], pars->GC_11, amp[327]); 
  FFV2_0(w[133], w[52], w[4], pars->GC_100, amp[328]); 
  FFV1_0(w[41], w[52], w[0], pars->GC_11, amp[329]); 
  FFV1_0(w[30], w[135], w[6], pars->GC_11, amp[330]); 
  FFV1_0(w[28], w[135], w[5], pars->GC_11, amp[331]); 
  FFV1_0(w[127], w[85], w[6], pars->GC_11, amp[332]); 
  FFV1_0(w[127], w[59], w[5], pars->GC_11, amp[333]); 
  ...
  FFV1_0(w[41], w[135], w[6], pars->GC_11, amp[342]); 
  FFV2_0(w[42], w[135], w[4], pars->GC_100, amp[343]); 
  FFV1_0(w[133], w[58], w[6], pars->GC_11, amp[344]); 
  FFV2_0(w[133], w[59], w[4], pars->GC_100, amp[345]); 
  FFV1_0(w[42], w[58], w[0], pars->GC_11, amp[346]); 
  FFV1_0(w[41], w[59], w[0], pars->GC_11, amp[347]); 
  FFV1_0(w[45], w[135], w[5], pars->GC_11, amp[348]); 
  FFV2_0(w[46], w[135], w[4], pars->GC_100, amp[349]); 
  FFV1_0(w[126], w[58], w[5], pars->GC_11, amp[350]); 
  FFV2_0(w[126], w[85], w[4], pars->GC_100, amp[351]); 
  FFV1_0(w[46], w[58], w[0], pars->GC_11, amp[352]); 
  FFV1_0(w[45], w[85], w[0], pars->GC_11, amp[353]); 
  FFV1_0(w[137], w[15], w[6], pars->GC_11, amp[354]); 
  FFV1_0(w[137], w[12], w[5], pars->GC_11, amp[355]); 
  FFV1_0(w[88], w[122], w[6], pars->GC_11, amp[356]); 
  FFV1_0(w[64], w[122], w[5], pars->GC_11, amp[357]); 
  ...
  FFV1_0(w[37], w[122], w[1], pars->GC_11, amp[379]); 
  FFV1_0(w[8], w[68], w[136], pars->GC_11, amp[380]); 
  VVV1_0(w[136], w[1], w[13], pars->GC_10, amp[381]); 
  ...
  FFV1_0(w[96], w[122], w[6], pars->GC_11, amp[387]); 
  FFV1_0(w[42], w[122], w[1], pars->GC_11, amp[388]); 
  FFV1_0(w[133], w[68], w[6], pars->GC_11, amp[389]); 
  FFV1_0(w[133], w[12], w[1], pars->GC_11, amp[390]); 
  FFV1_0(w[42], w[68], w[0], pars->GC_11, amp[391]); 
  FFV1_0(w[96], w[12], w[0], pars->GC_11, amp[392]); 
  FFV1_0(w[74], w[122], w[5], pars->GC_11, amp[393]); 
  FFV1_0(w[46], w[122], w[1], pars->GC_11, amp[394]); 
  FFV1_0(w[126], w[68], w[5], pars->GC_11, amp[395]); 
  FFV1_0(w[126], w[15], w[1], pars->GC_11, amp[396]); 
  FFV1_0(w[46], w[68], w[0], pars->GC_11, amp[397]); 
  FFV1_0(w[74], w[15], w[0], pars->GC_11, amp[398]); 
  FFV1_0(w[127], w[7], w[108], pars->GC_11, amp[399]); 
  FFV1_0(w[127], w[38], w[1], pars->GC_11, amp[400]); 
  FFV1_0(w[72], w[7], w[136], pars->GC_11, amp[401]); 
  VVV1_0(w[136], w[1], w[29], pars->GC_10, amp[402]); 
  FFV1_0(w[72], w[38], w[0], pars->GC_11, amp[403]); 
  VVV1_0(w[0], w[108], w[29], pars->GC_10, amp[404]); 
  FFV1_0(w[27], w[7], w[138], pars->GC_11, amp[405]); 
  FFV1_0(w[27], w[7], w[139], pars->GC_11, amp[406]); 
  FFV1_0(w[27], w[7], w[140], pars->GC_11, amp[407]); 
  FFV1_0(w[127], w[95], w[6], pars->GC_11, amp[408]); 
  FFV1_0(w[127], w[40], w[1], pars->GC_11, amp[409]); 
  FFV1_0(w[72], w[134], w[6], pars->GC_11, amp[410]); 
  FFV1_0(w[28], w[134], w[1], pars->GC_11, amp[411]); 
  FFV1_0(w[72], w[40], w[0], pars->GC_11, amp[412]); 
  FFV1_0(w[28], w[95], w[0], pars->GC_11, amp[413]); 
  FFV1_0(w[127], w[73], w[5], pars->GC_11, amp[414]); 
  FFV1_0(w[127], w[44], w[1], pars->GC_11, amp[415]); 
  FFV1_0(w[72], w[128], w[5], pars->GC_11, amp[416]); 
  FFV1_0(w[30], w[128], w[1], pars->GC_11, amp[417]); 
  FFV1_0(w[72], w[44], w[0], pars->GC_11, amp[418]); 
  FFV1_0(w[30], w[73], w[0], pars->GC_11, amp[419]); 
  FFV2_0(w[74], w[134], w[4], pars->GC_100, amp[420]); 
  FFV1_0(w[45], w[134], w[1], pars->GC_11, amp[421]); 
  FFV2_0(w[126], w[95], w[4], pars->GC_100, amp[422]); 
  FFV1_0(w[126], w[39], w[1], pars->GC_11, amp[423]); 
  FFV1_0(w[45], w[95], w[0], pars->GC_11, amp[424]); 
  FFV1_0(w[74], w[39], w[0], pars->GC_11, amp[425]); 
  FFV2_0(w[133], w[73], w[4], pars->GC_100, amp[426]); 
  FFV1_0(w[133], w[43], w[1], pars->GC_11, amp[427]); 
  FFV2_0(w[96], w[128], w[4], pars->GC_100, amp[428]); 
  FFV1_0(w[41], w[128], w[1], pars->GC_11, amp[429]); 
  ...
  FFV1_0(w[147], w[10], w[6], pars->GC_11, amp[435]); 
  FFV1_0(w[148], w[10], w[6], pars->GC_11, amp[436]); 
  FFV1_0(w[149], w[10], w[6], pars->GC_11, amp[437]); 
  ...
  FFV1_0(w[27], w[7], w[144], pars->GC_11, amp[441]); 
  FFV1_0(w[27], w[7], w[145], pars->GC_11, amp[442]); 
  FFV1_0(w[27], w[7], w[146], pars->GC_11, amp[443]); 
  FFV1_0(w[27], w[150], w[6], pars->GC_11, amp[444]); 
  FFV1_0(w[27], w[151], w[6], pars->GC_11, amp[445]); 
  FFV1_0(w[27], w[152], w[6], pars->GC_11, amp[446]); 
  ...
  FFV1_0(w[159], w[10], w[5], pars->GC_11, amp[459]); 
  FFV1_0(w[160], w[10], w[5], pars->GC_11, amp[460]); 
  FFV1_0(w[161], w[10], w[5], pars->GC_11, amp[461]); 
  ...
  FFV1_0(w[27], w[7], w[156], pars->GC_11, amp[465]); 
  FFV1_0(w[27], w[7], w[157], pars->GC_11, amp[466]); 
  FFV1_0(w[27], w[7], w[158], pars->GC_11, amp[467]); 
  FFV1_0(w[27], w[162], w[5], pars->GC_11, amp[468]); 
  FFV1_0(w[27], w[163], w[5], pars->GC_11, amp[469]); 
  FFV1_0(w[27], w[164], w[5], pars->GC_11, amp[470]); 
  ...
  FFV1_0(w[168], w[10], w[1], pars->GC_11, amp[495]); 
  FFV1_0(w[169], w[10], w[1], pars->GC_11, amp[496]); 
  FFV1_0(w[170], w[10], w[1], pars->GC_11, amp[497]); 
  FFV1_0(w[27], w[7], w[174], pars->GC_11, amp[498]); 
  FFV1_0(w[27], w[7], w[175], pars->GC_11, amp[499]); 
  FFV1_0(w[27], w[7], w[176], pars->GC_11, amp[500]); 
  FFV1_0(w[27], w[171], w[1], pars->GC_11, amp[501]); 
  FFV1_0(w[27], w[172], w[1], pars->GC_11, amp[502]); 
  FFV1_0(w[27], w[173], w[1], pars->GC_11, amp[503]); 
  ...
  FFV1_0(w[27], w[7], w[177], pars->GC_11, amp[510]); 
  FFV1_0(w[27], w[7], w[178], pars->GC_11, amp[511]); 
  FFV1_0(w[27], w[7], w[179], pars->GC_11, amp[512]); 
  FFV1_0(w[127], w[7], w[109], pars->GC_11, amp[513]); 
  FFV1_0(w[127], w[7], w[110], pars->GC_11, amp[514]); 
  FFV1_0(w[127], w[7], w[111], pars->GC_11, amp[515]); 

}
double P0_Sigma_sm_gg_mumvmxggudx_W_4j::matrix_gg_wmggudx_wm_mumvmx() 
{
  int i, j; 
  // Local variables
