...
#include "P0_Sigma_sm_uux_mumvmxucuxsx_W_4j.h"
...
// Process: u u~ > w- u c u~ s~ WEIGHTED=6
...
void P0_Sigma_sm_uux_mumvmxucuxsx_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_uux_mumvmxucuxsx_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_uux_wmucuxsx_wm_mumvmx(); 
        ...
        t[1] = matrix_uux_wmucuxsx_wm_mumvmx(); 
        double tsum = 0; 
...
double P0_Sigma_sm_uux_mumvmxucuxsx_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_uux_mumvmxucuxsx_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_0(w[18], w[6], w[30], pars->GC_11, amp[17]); 
  FFV1_0(w[32], w[6], w[25], pars->GC_11, amp[18]); 
...
double P0_Sigma_sm_uux_mumvmxucuxsx_W_4j::matrix_uux_wmucuxsx_wm_mumvmx() 
{
  int i, j; 
  // Local variables
