...
#include "P0_Sigma_sm_uc_mupvmggcd_W_4j.h"
...
void P0_Sigma_sm_uc_mupvmggcd_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_uc_mupvmggcd_W_4j::sigmaKin() 
{
...
double P0_Sigma_sm_uc_mupvmggcd_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_uc_mupvmggcd_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_0(w[45], w[8], w[38], pars->GC_11, amp[36]); 
  FFV1_0(w[1], w[36], w[46], pars->GC_11, amp[37]); 
  FFV1_0(w[45], w[25], w[14], pars->GC_11, amp[38]); 
  FFV2_0(w[47], w[25], w[4], pars->GC_100, amp[39]); 
  FFV1_0(w[45], w[8], w[41], pars->GC_11, amp[40]); 
  ...
  FFV1_0(w[34], w[8], w[51], pars->GC_11, amp[58]); 
  ...
  FFV1_0(w[29], w[8], w[57], pars->GC_11, amp[76]); 
  ...
  FFV1_0(w[55], w[8], w[41], pars->GC_11, amp[82]); 
...
double P0_Sigma_sm_uc_mupvmggcd_W_4j::matrix_uc_wpggcd_wp_mupvm() 
{
  int i, j; 
  // Local variables
