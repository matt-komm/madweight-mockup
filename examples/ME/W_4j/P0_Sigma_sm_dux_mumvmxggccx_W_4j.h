...
#ifndef MG5_Sigma_sm_dux_mumvmxggccx_H
#define MG5_Sigma_sm_dux_mumvmxggccx_H
...
class P0_Sigma_sm_dux_mumvmxggccx_W_4j
{
  public:

    // Constructor.
    P0_Sigma_sm_dux_mumvmxggccx_W_4j() {}
    ...
    virtual string name() const {return "d u~ > mu- vm~ g g c c~ (sm)";}
  ...
  private:
    ...
    double matrix_dux_wmggccx_wm_mumvmx(); 
...
#endif  // MG5_Sigma_sm_dux_mumvmxggccx_H
