...
#ifndef MG5_Sigma_sm_uc_mupvmggcd_H
#define MG5_Sigma_sm_uc_mupvmggcd_H
...
class P0_Sigma_sm_uc_mupvmggcd_W_4j
{
  public:

    // Constructor.
    P0_Sigma_sm_uc_mupvmggcd_W_4j() {}
  ...
  private:
    ...
    double matrix_uc_wpggcd_wp_mupvm(); 
...
#endif  // MG5_Sigma_sm_uc_mupvmggcd_H
