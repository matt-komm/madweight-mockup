...
#include "P0_Sigma_sm_gu_mumvmxgucsx_W_4j.h"
...
// Process: g u > w- g u c s~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: g c > w- g c u d~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: g d > w- g d c s~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: g s > w- g s u d~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_gu_mumvmxgucsx_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_gu_mumvmxgucsx_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_gu_wmgucsx_wm_mumvmx(); 
        ...
        t[1] = matrix_gu_wmgucsx_wm_mumvmx(); 
        double tsum = 0; 
...
double P0_Sigma_sm_gu_mumvmxgucsx_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_gu_mumvmxgucsx_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[1], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[14]); 
  ...
  FFV1_3(w[1], w[24], pars->GC_11, pars->ZERO, pars->ZERO, w[26]); 
  ...
  FFV1_3(w[1], w[36], pars->GC_11, pars->ZERO, pars->ZERO, w[38]); 
  FFV1_3(w[18], w[35], pars->GC_11, pars->ZERO, pars->ZERO, w[39]); 
  FFV1_3(w[28], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[40]); 
  ...
  FFV1_3(w[44], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[46]); 
  ...
  FFV1_0(w[18], w[7], w[45], pars->GC_11, amp[37]); 
  FFV1_0(w[8], w[27], w[46], pars->GC_11, amp[38]); 
  FFV1_0(w[18], w[25], w[46], pars->GC_11, amp[39]); 
  FFV1_0(w[31], w[7], w[46], pars->GC_11, amp[40]); 
  FFV1_0(w[30], w[10], w[46], pars->GC_11, amp[41]); 
  FFV1_0(w[47], w[6], w[12], pars->GC_11, amp[42]); 
  FFV1_0(w[8], w[33], w[46], pars->GC_11, amp[43]); 
  VVV1_0(w[46], w[5], w[12], pars->GC_10, amp[44]); 
  FFV1_0(w[47], w[6], w[19], pars->GC_11, amp[45]); 
  FFV1_0(w[34], w[7], w[46], pars->GC_11, amp[46]); 
  VVV1_0(w[46], w[5], w[19], pars->GC_10, amp[47]); 
  FFV1_0(w[49], w[7], w[38], pars->GC_11, amp[48]); 
  FFV1_0(w[1], w[36], w[50], pars->GC_11, amp[49]); 
  FFV1_0(w[49], w[25], w[14], pars->GC_11, amp[50]); 
  FFV2_0(w[51], w[25], w[4], pars->GC_100, amp[51]); 
  FFV1_0(w[49], w[7], w[40], pars->GC_11, amp[52]); 
  FFV1_0(w[28], w[6], w[50], pars->GC_11, amp[53]); 
  ...
  FFV1_0(w[49], w[7], w[43], pars->GC_11, amp[58]); 
  FFV1_0(w[49], w[23], w[5], pars->GC_11, amp[59]); 
  FFV1_0(w[1], w[53], w[12], pars->GC_11, amp[60]); 
  FFV1_0(w[8], w[54], w[38], pars->GC_11, amp[61]); 
  VVV1_0(w[0], w[38], w[12], pars->GC_10, amp[62]); 
  FFV1_0(w[1], w[53], w[19], pars->GC_11, amp[63]); 
  ...
  FFV1_0(w[58], w[6], w[12], pars->GC_11, amp[72]); 
  FFV1_0(w[8], w[54], w[40], pars->GC_11, amp[73]); 
  VVV1_0(w[0], w[40], w[12], pars->GC_10, amp[74]); 
  FFV1_0(w[58], w[6], w[19], pars->GC_11, amp[75]); 
  FFV1_0(w[55], w[7], w[40], pars->GC_11, amp[76]); 
  ...
  FFV1_0(w[31], w[7], w[57], pars->GC_11, amp[82]); 
...
double P0_Sigma_sm_gu_mumvmxgucsx_W_4j::matrix_gu_wmgucsx_wm_mumvmx() 
{
  int i, j; 
  // Local variables
