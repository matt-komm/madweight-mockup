...
#include "P0_Sigma_sm_uux_mumvmxcccxsx_W_4j.h"
...
// Process: u u~ > w- c c c~ s~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: c c~ > w- u u u~ d~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: d d~ > w- c c c~ s~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: s s~ > w- u u u~ d~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_uux_mumvmxcccxsx_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_uux_mumvmxcccxsx_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_uux_wmcccxsx_wm_mumvmx(); 
        ...
        t[1] = matrix_uux_wmcccxsx_wm_mumvmx(); 
        double tsum = 0; 
...
double P0_Sigma_sm_uux_mumvmxcccxsx_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_uux_mumvmxcccxsx_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_1(w[1], w[10], pars->GC_11, pars->ZERO, pars->ZERO, w[33]); 
  ...
  FFV1_0(w[32], w[1], w[29], pars->GC_11, amp[24]); 
  FFV1_0(w[0], w[33], w[29], pars->GC_11, amp[25]); 
  FFV1_0(w[32], w[1], w[31], pars->GC_11, amp[26]); 
  FFV1_0(w[0], w[33], w[31], pars->GC_11, amp[27]); 
  FFV1_0(w[34], w[1], w[28], pars->GC_11, amp[28]); 
  FFV1_0(w[0], w[35], w[28], pars->GC_11, amp[29]); 
  FFV1_0(w[34], w[1], w[30], pars->GC_11, amp[30]); 
  FFV1_0(w[0], w[35], w[30], pars->GC_11, amp[31]); 

}
double P0_Sigma_sm_uux_mumvmxcccxsx_W_4j::matrix_uux_wmcccxsx_wm_mumvmx() 
{
  int i, j; 
  // Local variables
