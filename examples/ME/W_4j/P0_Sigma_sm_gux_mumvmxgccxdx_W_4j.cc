...
#include "P0_Sigma_sm_gux_mumvmxgccxdx_W_4j.h"
...
// Process: g u~ > w- g c c~ d~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: g u~ > w- g s s~ d~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: g c~ > w- g u u~ s~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: g c~ > w- g d d~ s~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_gux_mumvmxgccxdx_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_gux_mumvmxgccxdx_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_gux_wmgccxdx_wm_mumvmx(); 
        ...
        t[1] = matrix_gux_wmgccxdx_wm_mumvmx(); 
        double tsum = 0; 
...
double P0_Sigma_sm_gux_mumvmxgccxdx_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_gux_mumvmxgccxdx_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[7], w[25], pars->GC_11, pars->ZERO, pars->ZERO, w[27]); 
  FFV1_3(w[18], w[24], pars->GC_11, pars->ZERO, pars->ZERO, w[28]); 
  FFV1_2(w[7], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[29]); 
  FFV1_3(w[29], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[30]); 
  FFV1_2(w[8], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[31]); 
  FFV1_1(w[24], w[14], pars->GC_11, pars->ZERO, pars->ZERO, w[32]); 
  FFV1_1(w[24], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[33]); 
  VVV1_1(w[5], w[14], pars->GC_10, pars->ZERO, pars->ZERO, w[34]); 
  FFV1_1(w[6], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[35]); 
  FFV1_1(w[1], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[36]); 
  FFV1_3(w[7], w[35], pars->GC_11, pars->ZERO, pars->ZERO, w[37]); 
  ...
  FFV1_1(w[35], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[41]); 
  FFV1_1(w[10], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[42]); 
  FFV1_2(w[18], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[43]); 
  FFV1_2(w[7], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[44]); 
  FFV1_3(w[44], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[45]); 
  ...
  FFV1_2(w[18], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[54]); 
  VVV1_1(w[0], w[14], pars->GC_10, pars->ZERO, pars->ZERO, w[55]); 
  FFV1_1(w[25], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[56]); 
  FFV1_1(w[10], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[57]); 
  FFV1_2(w[29], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[58]); 
  FFV1_2(w[31], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[59]); 
  ...
  FFV1_0(w[8], w[26], w[27], pars->GC_11, amp[12]); 
  FFV1_0(w[7], w[25], w[28], pars->GC_11, amp[13]); 
  FFV1_0(w[8], w[26], w[30], pars->GC_11, amp[14]); 
  FFV1_0(w[29], w[6], w[28], pars->GC_11, amp[15]); 
  FFV1_0(w[31], w[26], w[14], pars->GC_11, amp[16]); 
  FFV2_0(w[31], w[32], w[4], pars->GC_100, amp[17]); 
  FFV1_0(w[18], w[33], w[14], pars->GC_11, amp[18]); 
  VVV1_0(w[5], w[14], w[28], pars->GC_10, amp[19]); 
  FFV1_0(w[18], w[32], w[5], pars->GC_11, amp[20]); 
  FFV2_0(w[22], w[33], w[4], pars->GC_100, amp[21]); 
  FFV1_0(w[8], w[26], w[34], pars->GC_11, amp[22]); 
  FFV1_0(w[22], w[26], w[5], pars->GC_11, amp[23]); 
  FFV1_0(w[8], w[38], w[37], pars->GC_11, amp[24]); 
  FFV1_0(w[18], w[36], w[37], pars->GC_11, amp[25]); 
  FFV1_0(w[8], w[10], w[39], pars->GC_11, amp[26]); 
  FFV1_0(w[18], w[1], w[39], pars->GC_11, amp[27]); 
  FFV1_0(w[40], w[1], w[37], pars->GC_11, amp[28]); 
  FFV1_0(w[31], w[10], w[37], pars->GC_11, amp[29]); 
  FFV1_0(w[7], w[41], w[12], pars->GC_11, amp[30]); 
  FFV1_0(w[8], w[42], w[37], pars->GC_11, amp[31]); 
  VVV1_0(w[37], w[5], w[12], pars->GC_10, amp[32]); 
  FFV1_0(w[7], w[41], w[19], pars->GC_11, amp[33]); 
  FFV1_0(w[43], w[1], w[37], pars->GC_11, amp[34]); 
  VVV1_0(w[37], w[5], w[19], pars->GC_10, amp[35]); 
  FFV1_0(w[8], w[38], w[45], pars->GC_11, amp[36]); 
  FFV1_0(w[18], w[36], w[45], pars->GC_11, amp[37]); 
  FFV1_0(w[8], w[10], w[46], pars->GC_11, amp[38]); 
  ...
  FFV1_0(w[8], w[38], w[55], pars->GC_11, amp[64]); 
  FFV1_0(w[22], w[38], w[0], pars->GC_11, amp[65]); 
  FFV1_0(w[7], w[56], w[12], pars->GC_11, amp[66]); 
  FFV1_0(w[8], w[57], w[27], pars->GC_11, amp[67]); 
  VVV1_0(w[0], w[27], w[12], pars->GC_10, amp[68]); 
  FFV1_0(w[7], w[56], w[19], pars->GC_11, amp[69]); 
  FFV1_0(w[54], w[1], w[27], pars->GC_11, amp[70]); 
  VVV1_0(w[0], w[27], w[19], pars->GC_10, amp[71]); 
  FFV1_0(w[58], w[6], w[12], pars->GC_11, amp[72]); 
  FFV1_0(w[8], w[57], w[30], pars->GC_11, amp[73]); 
  VVV1_0(w[0], w[30], w[12], pars->GC_10, amp[74]); 
  FFV1_0(w[58], w[6], w[19], pars->GC_11, amp[75]); 
  FFV1_0(w[54], w[1], w[30], pars->GC_11, amp[76]); 
  VVV1_0(w[0], w[30], w[19], pars->GC_10, amp[77]); 
  ...
  FFV1_0(w[40], w[23], w[0], pars->GC_11, amp[83]); 
  FFV1_0(w[8], w[57], w[34], pars->GC_11, amp[84]); 
  FFV1_0(w[22], w[57], w[5], pars->GC_11, amp[85]); 
  FFV1_0(w[8], w[42], w[55], pars->GC_11, amp[86]); 
  VVV1_0(w[55], w[5], w[12], pars->GC_10, amp[87]); 
  FFV1_0(w[22], w[42], w[0], pars->GC_11, amp[88]); 
  VVV1_0(w[0], w[34], w[12], pars->GC_10, amp[89]); 
  ...
  FFV1_0(w[54], w[23], w[5], pars->GC_11, amp[94]); 
  FFV1_0(w[43], w[1], w[55], pars->GC_11, amp[95]); 
  VVV1_0(w[55], w[5], w[19], pars->GC_10, amp[96]); 
  FFV1_0(w[43], w[23], w[0], pars->GC_11, amp[97]); 
  VVV1_0(w[0], w[34], w[19], pars->GC_10, amp[98]); 
  FFV1_0(w[18], w[1], w[60], pars->GC_11, amp[99]); 
  FFV1_0(w[18], w[1], w[61], pars->GC_11, amp[100]); 
  FFV1_0(w[18], w[1], w[62], pars->GC_11, amp[101]); 

}
double P0_Sigma_sm_gux_mumvmxgccxdx_W_4j::matrix_gux_wmgccxdx_wm_mumvmx() 
{
  int i, j; 
  // Local variables
  ...
  jamp[0] = +1./2. * (-amp[12] - amp[13] - amp[16] - amp[17] -
      ...
      amp[99] - amp[100]);
  jamp[1] = +1./2. * (+1./3. * amp[12] + 1./3. * amp[13] + 1./3. * amp[14] +
  ...
  jamp[6] = +1./2. * (+1./3. * amp[24] + 1./3. * amp[25] + 1./3. * amp[28] +
      ...
      1./3. * amp[46]);
  jamp[7] = +1./2. * (-amp[24] - amp[25] - amp[26] - amp[27] - amp[31] -
