...
#include "P0_Sigma_sm_dxdx_mumvmxudxdxdx_W_4j.h"
...
void P0_Sigma_sm_dxdx_mumvmxudxdxdx_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_dxdx_mumvmxudxdxdx_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_dxdx_wmudxdxdx_wm_mumvmx(); 
...
double P0_Sigma_sm_dxdx_mumvmxudxdxdx_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_dxdx_mumvmxudxdxdx_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_1(w[1], w[10], pars->GC_11, pars->ZERO, pars->ZERO, w[12]); 
  ...
  FFV1_3(w[7], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[17]); 
  ...
  FFV1_1(w[1], w[20], pars->GC_11, pars->ZERO, pars->ZERO, w[24]); 
  ...
  FFV1_1(w[1], w[27], pars->GC_11, pars->ZERO, pars->ZERO, w[29]); 
  ...
  FFV1_3(w[6], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[46]); 
  ...
  FFV1_0(w[23], w[1], w[11], pars->GC_11, amp[10]); 
  ...
  FFV1_0(w[31], w[1], w[30], pars->GC_11, amp[15]); 
  ...
  FFV1_0(w[60], w[1], w[44], pars->GC_11, amp[73]); 
  ...
  FFV1_0(w[23], w[1], w[61], pars->GC_11, amp[88]); 
  FFV1_0(w[7], w[24], w[61], pars->GC_11, amp[89]); 
  FFV1_0(w[58], w[1], w[43], pars->GC_11, amp[90]); 
...
double P0_Sigma_sm_dxdx_mumvmxudxdxdx_W_4j::matrix_dxdx_wmudxdxdx_wm_mumvmx() 
{
  int i, j; 
  // Local variables
  ...
  jamp[0] = +1./4. * (-amp[0] - amp[2] - std::complex<double> (0, 1) * amp[3] -
  ...
  jamp[1] = +1./4. * (+1./3. * amp[2] + 1./3. * amp[4] + amp[6] -
  ...
  jamp[4] = +1./4. * (-amp[1] + std::complex<double> (0, 1) * amp[3] - amp[4] -
