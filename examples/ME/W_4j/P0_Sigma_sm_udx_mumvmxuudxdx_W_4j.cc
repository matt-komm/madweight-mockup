...
#include "P0_Sigma_sm_udx_mumvmxuudxdx_W_4j.h"
...
// Process: u d~ > w- u u d~ d~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: c s~ > w- c c s~ s~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_udx_mumvmxuudxdx_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_udx_mumvmxuudxdx_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_udx_wmuudxdx_wm_mumvmx(); 
        ...
        t[1] = matrix_udx_wmuudxdx_wm_mumvmx(); 
        double tsum = 0; 
...
double P0_Sigma_sm_udx_mumvmxuudxdx_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_udx_mumvmxuudxdx_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[7], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[18]); 
  FFV1_2(w[8], w[18], pars->GC_11, pars->ZERO, pars->ZERO, w[19]); 
  FFV1_1(w[6], w[18], pars->GC_11, pars->ZERO, pars->ZERO, w[20]); 
  ...
  FFV1_2(w[7], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[26]); 
  FFV1_3(w[8], w[21], pars->GC_11, pars->ZERO, pars->ZERO, w[27]); 
  FFV1_3(w[7], w[21], pars->GC_11, pars->ZERO, pars->ZERO, w[28]); 
  FFV1_3(w[24], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[29]); 
  FFV1_1(w[6], w[14], pars->GC_11, pars->ZERO, pars->ZERO, w[30]); 
  FFV1_2(w[7], w[14], pars->GC_11, pars->ZERO, pars->ZERO, w[31]); 
  FFV1_3(w[0], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[32]); 
  FFV1_1(w[1], w[32], pars->GC_11, pars->ZERO, pars->ZERO, w[33]); 
  FFV1_3(w[10], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[34]); 
  FFV1_2(w[8], w[32], pars->GC_11, pars->ZERO, pars->ZERO, w[35]); 
  FFV1_2(w[10], w[32], pars->GC_11, pars->ZERO, pars->ZERO, w[36]); 
  FFV1_1(w[5], w[32], pars->GC_11, pars->ZERO, pars->ZERO, w[37]); 
  VVV1_1(w[32], w[14], pars->GC_10, pars->ZERO, pars->ZERO, w[38]); 
  FFV1_1(w[5], w[18], pars->GC_11, pars->ZERO, pars->ZERO, w[39]); 
  FFV2_1(w[5], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[40]); 
  ...
  FFV1_2(w[7], w[32], pars->GC_11, pars->ZERO, pars->ZERO, w[44]); 
  FFV1_3(w[8], w[40], pars->GC_11, pars->ZERO, pars->ZERO, w[45]); 
  FFV1_3(w[7], w[40], pars->GC_11, pars->ZERO, pars->ZERO, w[46]); 
  FFV1_3(w[24], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[47]); 
  FFV1_1(w[5], w[14], pars->GC_11, pars->ZERO, pars->ZERO, w[48]); 
  FFV1_2(w[0], w[14], pars->GC_11, pars->ZERO, pars->ZERO, w[49]); 
  FFV1_2(w[0], w[18], pars->GC_11, pars->ZERO, pars->ZERO, w[50]); 
  ...
  FFV1_0(w[24], w[6], w[22], pars->GC_11, amp[10]); 
  FFV1_0(w[25], w[6], w[18], pars->GC_11, amp[11]); 
  FFV1_0(w[24], w[16], w[18], pars->GC_11, amp[12]); 
  FFV1_0(w[26], w[1], w[27], pars->GC_11, amp[13]); 
  FFV1_0(w[8], w[11], w[28], pars->GC_11, amp[14]); 
  FFV1_0(w[7], w[11], w[27], pars->GC_11, amp[15]); 
  FFV1_0(w[13], w[1], w[28], pars->GC_11, amp[16]); 
  FFV1_0(w[26], w[21], w[14], pars->GC_11, amp[17]); 
  FFV1_0(w[7], w[23], w[14], pars->GC_11, amp[18]); 
  FFV1_0(w[7], w[21], w[17], pars->GC_11, amp[19]); 
  FFV1_0(w[26], w[1], w[29], pars->GC_11, amp[20]); 
  FFV1_0(w[7], w[11], w[29], pars->GC_11, amp[21]); 
  FFV2_0(w[26], w[30], w[4], pars->GC_100, amp[22]); 
  FFV2_0(w[31], w[16], w[4], pars->GC_100, amp[23]); 
  FFV1_0(w[8], w[33], w[34], pars->GC_11, amp[24]); 
  FFV1_0(w[35], w[1], w[34], pars->GC_11, amp[25]); 
  FFV1_0(w[36], w[5], w[14], pars->GC_11, amp[26]); 
  FFV1_0(w[10], w[37], w[14], pars->GC_11, amp[27]); 
  FFV1_0(w[10], w[5], w[38], pars->GC_11, amp[28]); 
  ...
  FFV1_0(w[24], w[5], w[41], pars->GC_11, amp[34]); 
  FFV1_0(w[43], w[5], w[18], pars->GC_11, amp[35]); 
  FFV1_0(w[24], w[37], w[18], pars->GC_11, amp[36]); 
  FFV1_0(w[44], w[1], w[45], pars->GC_11, amp[37]); 
  FFV1_0(w[8], w[33], w[46], pars->GC_11, amp[38]); 
  FFV1_0(w[7], w[33], w[45], pars->GC_11, amp[39]); 
  FFV1_0(w[35], w[1], w[46], pars->GC_11, amp[40]); 
  FFV1_0(w[44], w[40], w[14], pars->GC_11, amp[41]); 
  FFV1_0(w[7], w[42], w[14], pars->GC_11, amp[42]); 
  FFV1_0(w[7], w[40], w[38], pars->GC_11, amp[43]); 
  FFV1_0(w[44], w[1], w[47], pars->GC_11, amp[44]); 
  FFV1_0(w[7], w[33], w[47], pars->GC_11, amp[45]); 
  FFV2_0(w[44], w[48], w[4], pars->GC_100, amp[46]); 
  FFV2_0(w[31], w[37], w[4], pars->GC_100, amp[47]); 
  FFV1_0(w[49], w[6], w[34], pars->GC_11, amp[48]); 
  FFV1_0(w[49], w[5], w[12], pars->GC_11, amp[49]); 
  FFV1_0(w[0], w[30], w[34], pars->GC_11, amp[50]); 
  FFV1_0(w[0], w[48], w[12], pars->GC_11, amp[51]); 
  FFV1_0(w[50], w[6], w[45], pars->GC_11, amp[52]); 
  FFV1_0(w[0], w[20], w[45], pars->GC_11, amp[53]); 
  FFV1_0(w[50], w[5], w[27], pars->GC_11, amp[54]); 
  FFV1_0(w[0], w[39], w[27], pars->GC_11, amp[55]); 
  FFV1_0(w[50], w[6], w[47], pars->GC_11, amp[56]); 
  FFV1_0(w[50], w[5], w[29], pars->GC_11, amp[57]); 
  FFV1_0(w[0], w[39], w[29], pars->GC_11, amp[58]); 
  FFV1_0(w[0], w[20], w[47], pars->GC_11, amp[59]); 
  FFV1_0(w[49], w[6], w[46], pars->GC_11, amp[60]); 
  FFV1_0(w[0], w[30], w[46], pars->GC_11, amp[61]); 
  FFV1_0(w[49], w[5], w[28], pars->GC_11, amp[62]); 
  FFV1_0(w[0], w[48], w[28], pars->GC_11, amp[63]); 

}
double P0_Sigma_sm_udx_mumvmxuudxdx_W_4j::matrix_udx_wmuudxdx_wm_mumvmx() 
{
  int i, j; 
  // Local variables
  ...
  jamp[1] = +1./4. * (-1./3. * amp[0] - 1./3. * amp[1] - amp[6] -
  ...
  jamp[5] = +1./4. * (-1./3. * amp[2] - 1./3. * amp[3] - amp[5] +
