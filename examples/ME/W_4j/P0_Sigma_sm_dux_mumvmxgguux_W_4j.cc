...
#include "P0_Sigma_sm_dux_mumvmxgguux_W_4j.h"
...
// Process: d u~ > w- g g u u~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: s c~ > w- g g c c~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_dux_mumvmxgguux_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_dux_mumvmxgguux_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_dux_wmgguux_wm_mumvmx(); 
        ...
        t[1] = matrix_dux_wmgguux_wm_mumvmx(); 
        double tsum = 0; 
...
double P0_Sigma_sm_dux_mumvmxgguux_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_dux_mumvmxgguux_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_2(w[0], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[68]); 
  ...
  FFV1_0(w[0], w[34], w[40], pars->GC_11, amp[28]); 
  FFV1_0(w[0], w[18], w[41], pars->GC_11, amp[29]); 
  ...
  FFV1_0(w[0], w[51], w[56], pars->GC_11, amp[52]); 
  FFV1_0(w[0], w[10], w[57], pars->GC_11, amp[53]); 
  ...
  FFV1_0(w[0], w[54], w[63], pars->GC_11, amp[72]); 
  FFV1_0(w[0], w[18], w[64], pars->GC_11, amp[73]); 
  FFV1_0(w[24], w[7], w[64], pars->GC_11, amp[74]); 
  FFV1_0(w[24], w[50], w[63], pars->GC_11, amp[75]); 
  FFV1_0(w[0], w[37], w[65], pars->GC_11, amp[76]); 
  FFV1_0(w[0], w[10], w[66], pars->GC_11, amp[77]); 
  ...
  FFV1_0(w[0], w[60], w[63], pars->GC_11, amp[85]); 
  VVV1_0(w[63], w[6], w[12], pars->GC_10, amp[86]); 
  FFV1_0(w[67], w[1], w[20], pars->GC_11, amp[87]); 
  FFV1_0(w[0], w[46], w[65], pars->GC_11, amp[88]); 
  ...
  FFV1_0(w[0], w[80], w[40], pars->GC_11, amp[145]); 
  VVV1_0(w[5], w[40], w[12], pars->GC_10, amp[146]); 
  FFV1_0(w[82], w[1], w[20], pars->GC_11, amp[147]); 
  FFV1_0(w[0], w[76], w[56], pars->GC_11, amp[148]); 
...
double P0_Sigma_sm_dux_mumvmxgguux_W_4j::matrix_dux_wmgguux_wm_mumvmx() 
{
  int i, j; 
  // Local variables
