...
#include "P0_Sigma_sm_uu_mumvmxuuudx_W_4j.h"
...
void P0_Sigma_sm_uu_mumvmxuuudx_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_uu_mumvmxuuudx_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_uu_wmuuudx_wm_mumvmx(); 
...
double P0_Sigma_sm_uu_mumvmxuuudx_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_uu_mumvmxuuudx_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[1], w[7], pars->GC_11, pars->ZERO, pars->ZERO, w[20]); 
  ...
  FFV1_2(w[1], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[27]); 
  ...
  FFV1_3(w[1], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[33]); 
  ...
  FFV1_2(w[1], w[32], pars->GC_11, pars->ZERO, pars->ZERO, w[46]); 
  ...
  FFV1_2(w[1], w[49], pars->GC_11, pars->ZERO, pars->ZERO, w[60]); 
  ...
  FFV1_0(w[1], w[11], w[28], pars->GC_11, amp[17]); 
  FFV1_0(w[27], w[6], w[29], pars->GC_11, amp[18]); 
  FFV1_0(w[1], w[21], w[29], pars->GC_11, amp[19]); 
  FFV1_0(w[27], w[7], w[30], pars->GC_11, amp[20]); 
  FFV1_0(w[27], w[6], w[31], pars->GC_11, amp[21]); 
  FFV1_0(w[1], w[21], w[31], pars->GC_11, amp[22]); 
  FFV1_0(w[1], w[11], w[30], pars->GC_11, amp[23]); 
  ...
  FFV1_0(w[1], w[34], w[47], pars->GC_11, amp[41]); 
  FFV1_0(w[46], w[5], w[29], pars->GC_11, amp[42]); 
  FFV1_0(w[1], w[41], w[29], pars->GC_11, amp[43]); 
  FFV1_0(w[46], w[7], w[48], pars->GC_11, amp[44]); 
  FFV1_0(w[46], w[5], w[31], pars->GC_11, amp[45]); 
  FFV1_0(w[1], w[41], w[31], pars->GC_11, amp[46]); 
  FFV1_0(w[1], w[34], w[48], pars->GC_11, amp[47]); 
  ...
  FFV1_0(w[1], w[50], w[47], pars->GC_11, amp[65]); 
  FFV1_0(w[60], w[5], w[28], pars->GC_11, amp[66]); 
  FFV1_0(w[1], w[56], w[28], pars->GC_11, amp[67]); 
  FFV1_0(w[60], w[6], w[48], pars->GC_11, amp[68]); 
  FFV1_0(w[60], w[5], w[30], pars->GC_11, amp[69]); 
  FFV1_0(w[1], w[56], w[30], pars->GC_11, amp[70]); 
  FFV1_0(w[1], w[50], w[48], pars->GC_11, amp[71]); 
...
double P0_Sigma_sm_uu_mumvmxuuudx_W_4j::matrix_uu_wmuuudx_wm_mumvmx() 
{
  int i, j; 
  // Local variables
