...
#include "P0_Sigma_sm_dux_mupvmdduxux_W_4j.h"
...
// Process: d u~ > w+ d d u~ u~ WEIGHTED=6
// *   Decay: w+ > mu+ vm WEIGHTED=2
// Process: s c~ > w+ s s c~ c~ WEIGHTED=6
// *   Decay: w+ > mu+ vm WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_dux_mupvmdduxux_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_dux_mupvmdduxux_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_dux_wpdduxux_wp_mupvm(); 
        ...
        t[1] = matrix_dux_wpdduxux_wp_mupvm(); 
        double tsum = 0; 
...
double P0_Sigma_sm_dux_mupvmdduxux_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_dux_mupvmdduxux_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[7], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[25]); 
  ...
  FFV1_3(w[26], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[30]); 
  ...
  FFV2_1(w[5], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[35]); 
  ...
  FFV1_1(w[5], w[19], pars->GC_11, pars->ZERO, pars->ZERO, w[43]); 
  ...
  FFV1_0(w[31], w[5], w[40], pars->GC_11, amp[30]); 
  ...
  FFV1_0(w[44], w[1], w[28], pars->GC_11, amp[38]); 
  FFV1_0(w[7], w[22], w[28], pars->GC_11, amp[39]); 
  FFV1_0(w[45], w[1], w[30], pars->GC_11, amp[40]); 
  ...
  FFV1_0(w[23], w[1], w[46], pars->GC_11, amp[56]); 
  FFV1_0(w[8], w[24], w[46], pars->GC_11, amp[57]); 
  FFV1_0(w[45], w[1], w[36], pars->GC_11, amp[58]); 
  FFV1_0(w[7], w[24], w[36], pars->GC_11, amp[59]); 
  FFV1_0(w[21], w[1], w[48], pars->GC_11, amp[60]); 
  FFV1_0(w[8], w[22], w[48], pars->GC_11, amp[61]); 
  FFV1_0(w[44], w[1], w[40], pars->GC_11, amp[62]); 
  FFV1_0(w[7], w[22], w[40], pars->GC_11, amp[63]); 

}
double P0_Sigma_sm_dux_mupvmdduxux_W_4j::matrix_dux_wpdduxux_wp_mupvm() 
{
  int i, j; 
  // Local variables
