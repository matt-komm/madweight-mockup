...
#include "P0_Sigma_sm_gg_mupvmuduxux_W_4j.h"
...
// Process: g g > w+ u d u~ u~ WEIGHTED=6
// *   Decay: w+ > mu+ vm WEIGHTED=2
// Process: g g > w+ c s c~ c~ WEIGHTED=6
// *   Decay: w+ > mu+ vm WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_gg_mupvmuduxux_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_gg_mupvmuduxux_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_gg_wpuduxux_wp_mupvm(); 
...
double P0_Sigma_sm_gg_mupvmuduxux_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_gg_mupvmuduxux_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_1(w[5], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[11]); 
  ...
  FFV1_3(w[7], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[16]); 
  ...
  FFV1_3(w[21], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[22]); 
  FFV1_2(w[21], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[23]); 
  FFV1_1(w[6], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[24]); 
  FFV2_2(w[8], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[25]); 
  FFV1_3(w[25], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[26]); 
  FFV1_2(w[25], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[27]); 
  FFV1_2(w[8], w[16], pars->GC_11, pars->ZERO, pars->ZERO, w[28]); 
  FFV1_1(w[6], w[16], pars->GC_11, pars->ZERO, pars->ZERO, w[29]); 
  FFV1_2(w[7], w[19], pars->GC_11, pars->ZERO, pars->ZERO, w[30]); 
  FFV1_1(w[6], w[19], pars->GC_11, pars->ZERO, pars->ZERO, w[31]); 
  FFV1_1(w[5], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[32]); 
  FFV1_1(w[6], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[33]); 
  FFV1_3(w[7], w[32], pars->GC_11, pars->ZERO, pars->ZERO, w[34]); 
  FFV2_1(w[33], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[35]); 
  FFV1_3(w[8], w[32], pars->GC_11, pars->ZERO, pars->ZERO, w[36]); 
  FFV1_2(w[7], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[37]); 
  FFV2_2(w[37], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[38]); 
  FFV1_3(w[37], w[32], pars->GC_11, pars->ZERO, pars->ZERO, w[39]); 
  FFV1_2(w[8], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[40]); 
  FFV2_2(w[40], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[41]); 
  FFV1_3(w[40], w[32], pars->GC_11, pars->ZERO, pars->ZERO, w[42]); 
  FFV1_1(w[32], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[43]); 
  FFV1_1(w[10], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[44]); 
  FFV1_2(w[21], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[45]); 
  FFV1_2(w[25], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[46]); 
  FFV1_1(w[6], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[47]); 
  FFV1_1(w[5], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[48]); 
  FFV2_1(w[47], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[49]); 
  FFV1_3(w[7], w[48], pars->GC_11, pars->ZERO, pars->ZERO, w[50]); 
  FFV1_3(w[8], w[48], pars->GC_11, pars->ZERO, pars->ZERO, w[51]); 
  FFV1_3(w[21], w[47], pars->GC_11, pars->ZERO, pars->ZERO, w[52]); 
  FFV1_3(w[25], w[47], pars->GC_11, pars->ZERO, pars->ZERO, w[53]); 
  FFV1_3(w[37], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[54]); 
  FFV1_1(w[47], w[19], pars->GC_11, pars->ZERO, pars->ZERO, w[55]); 
  FFV1_3(w[40], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[56]); 
  FFV1_1(w[47], w[16], pars->GC_11, pars->ZERO, pars->ZERO, w[57]); 
  FFV1_1(w[47], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[58]); 
  VVV1_1(w[1], w[16], pars->GC_10, pars->ZERO, pars->ZERO, w[59]); 
  VVV1_1(w[1], w[19], pars->GC_10, pars->ZERO, pars->ZERO, w[60]); 
  ...
  FFV1_3(w[61], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[65]); 
  FFV1_2(w[61], w[19], pars->GC_11, pars->ZERO, pars->ZERO, w[66]); 
  FFV1_2(w[61], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[67]); 
  ...
  FFV1_3(w[68], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[72]); 
  FFV1_2(w[68], w[16], pars->GC_11, pars->ZERO, pars->ZERO, w[73]); 
  FFV1_2(w[68], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[74]); 
  FFV1_1(w[48], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[75]); 
  FFV1_1(w[10], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[76]); 
  FFV1_2(w[21], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[77]); 
  FFV1_2(w[25], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[78]); 
  FFV1_1(w[33], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[79]); 
  VVV1_1(w[0], w[19], pars->GC_10, pars->ZERO, pars->ZERO, w[80]); 
  VVV1_1(w[0], w[16], pars->GC_10, pars->ZERO, pars->ZERO, w[81]); 
  FFV1_2(w[37], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[82]); 
  FFV1_2(w[40], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[83]); 
  VVVV1_1(w[0], w[1], w[16], pars->GC_12, pars->ZERO, pars->ZERO, w[84]); 
  VVVV3_1(w[0], w[1], w[16], pars->GC_12, pars->ZERO, pars->ZERO, w[85]); 
  VVVV4_1(w[0], w[1], w[16], pars->GC_12, pars->ZERO, pars->ZERO, w[86]); 
  VVVV1_1(w[0], w[1], w[19], pars->GC_12, pars->ZERO, pars->ZERO, w[87]); 
  VVVV3_1(w[0], w[1], w[19], pars->GC_12, pars->ZERO, pars->ZERO, w[88]); 
  VVVV4_1(w[0], w[1], w[19], pars->GC_12, pars->ZERO, pars->ZERO, w[89]); 

  // Calculate all amplitudes
  // Amplitude(s) for diagram number 0
  FFV1_0(w[8], w[11], w[12], pars->GC_11, amp[0]); 
  FFV1_0(w[7], w[11], w[13], pars->GC_11, amp[1]); 
  FFV1_0(w[14], w[5], w[13], pars->GC_11, amp[2]); 
  FFV1_0(w[15], w[5], w[12], pars->GC_11, amp[3]); 
  ...
  FFV1_0(w[15], w[5], w[22], pars->GC_11, amp[11]); 
  FFV1_0(w[23], w[6], w[19], pars->GC_11, amp[12]); 
  FFV1_0(w[21], w[6], w[20], pars->GC_11, amp[13]); 
  FFV1_0(w[21], w[24], w[19], pars->GC_11, amp[14]); 
  FFV1_0(w[7], w[11], w[26], pars->GC_11, amp[15]); 
  FFV1_0(w[14], w[5], w[26], pars->GC_11, amp[16]); 
  FFV1_0(w[27], w[6], w[16], pars->GC_11, amp[17]); 
  FFV1_0(w[25], w[6], w[18], pars->GC_11, amp[18]); 
  ...
  FFV1_0(w[8], w[35], w[34], pars->GC_11, amp[24]); 
  FFV1_0(w[7], w[35], w[36], pars->GC_11, amp[25]); 
  FFV1_0(w[21], w[33], w[36], pars->GC_11, amp[26]); 
  FFV1_0(w[25], w[33], w[34], pars->GC_11, amp[27]); 
  FFV1_0(w[38], w[6], w[36], pars->GC_11, amp[28]); 
  FFV1_0(w[8], w[10], w[39], pars->GC_11, amp[29]); 
  FFV1_0(w[37], w[10], w[36], pars->GC_11, amp[30]); 
  FFV1_0(w[25], w[6], w[39], pars->GC_11, amp[31]); 
  FFV1_0(w[41], w[6], w[34], pars->GC_11, amp[32]); 
  FFV1_0(w[7], w[10], w[42], pars->GC_11, amp[33]); 
  FFV1_0(w[40], w[10], w[34], pars->GC_11, amp[34]); 
  FFV1_0(w[21], w[6], w[42], pars->GC_11, amp[35]); 
  FFV1_0(w[8], w[43], w[12], pars->GC_11, amp[36]); 
  FFV1_0(w[7], w[43], w[13], pars->GC_11, amp[37]); 
  FFV1_0(w[8], w[44], w[34], pars->GC_11, amp[38]); 
  VVV1_0(w[34], w[1], w[13], pars->GC_10, amp[39]); 
  FFV1_0(w[7], w[44], w[36], pars->GC_11, amp[40]); 
  VVV1_0(w[36], w[1], w[12], pars->GC_10, amp[41]); 
  FFV1_0(w[8], w[43], w[22], pars->GC_11, amp[42]); 
  FFV1_0(w[45], w[6], w[36], pars->GC_11, amp[43]); 
  VVV1_0(w[36], w[1], w[22], pars->GC_10, amp[44]); 
  FFV1_0(w[7], w[43], w[26], pars->GC_11, amp[45]); 
  FFV1_0(w[46], w[6], w[34], pars->GC_11, amp[46]); 
  VVV1_0(w[34], w[1], w[26], pars->GC_10, amp[47]); 
  FFV1_0(w[8], w[49], w[50], pars->GC_11, amp[48]); 
  FFV1_0(w[7], w[49], w[51], pars->GC_11, amp[49]); 
  FFV1_0(w[8], w[48], w[52], pars->GC_11, amp[50]); 
  FFV1_0(w[7], w[48], w[53], pars->GC_11, amp[51]); 
  FFV1_0(w[8], w[49], w[54], pars->GC_11, amp[52]); 
  FFV1_0(w[37], w[5], w[53], pars->GC_11, amp[53]); 
  FFV1_0(w[37], w[49], w[19], pars->GC_11, amp[54]); 
  FFV2_0(w[37], w[55], w[4], pars->GC_100, amp[55]); 
  FFV1_0(w[7], w[49], w[56], pars->GC_11, amp[56]); 
  FFV1_0(w[40], w[5], w[52], pars->GC_11, amp[57]); 
  FFV1_0(w[40], w[49], w[16], pars->GC_11, amp[58]); 
  FFV2_0(w[40], w[57], w[4], pars->GC_100, amp[59]); 
  FFV1_0(w[21], w[58], w[19], pars->GC_11, amp[60]); 
  VVV1_0(w[1], w[19], w[52], pars->GC_10, amp[61]); 
  FFV1_0(w[21], w[55], w[1], pars->GC_11, amp[62]); 
  FFV1_0(w[25], w[58], w[16], pars->GC_11, amp[63]); 
  VVV1_0(w[1], w[16], w[53], pars->GC_10, amp[64]); 
  FFV1_0(w[25], w[57], w[1], pars->GC_11, amp[65]); 
  FFV2_0(w[28], w[58], w[4], pars->GC_100, amp[66]); 
  FFV1_0(w[8], w[49], w[59], pars->GC_11, amp[67]); 
  FFV1_0(w[28], w[49], w[1], pars->GC_11, amp[68]); 
  FFV2_0(w[30], w[58], w[4], pars->GC_100, amp[69]); 
  FFV1_0(w[7], w[49], w[60], pars->GC_11, amp[70]); 
  FFV1_0(w[30], w[49], w[1], pars->GC_11, amp[71]); 
  FFV1_0(w[62], w[6], w[51], pars->GC_11, amp[72]); 
  FFV1_0(w[8], w[10], w[63], pars->GC_11, amp[73]); 
  FFV1_0(w[8], w[48], w[64], pars->GC_11, amp[74]); 
  FFV1_0(w[25], w[6], w[63], pars->GC_11, amp[75]); 
  FFV1_0(w[8], w[35], w[65], pars->GC_11, amp[76]); 
  FFV1_0(w[25], w[33], w[65], pars->GC_11, amp[77]); 
  FFV1_0(w[62], w[33], w[19], pars->GC_11, amp[78]); 
  FFV2_0(w[66], w[33], w[4], pars->GC_100, amp[79]); 
  FFV1_0(w[62], w[6], w[56], pars->GC_11, amp[80]); 
  FFV1_0(w[41], w[6], w[65], pars->GC_11, amp[81]); 
  FFV1_0(w[40], w[5], w[64], pars->GC_11, amp[82]); 
  FFV1_0(w[40], w[10], w[65], pars->GC_11, amp[83]); 
  FFV1_0(w[67], w[5], w[13], pars->GC_11, amp[84]); 
  FFV1_0(w[8], w[44], w[65], pars->GC_11, amp[85]); 
  VVV1_0(w[65], w[1], w[13], pars->GC_10, amp[86]); 
  FFV1_0(w[67], w[10], w[19], pars->GC_11, amp[87]); 
  VVV1_0(w[1], w[19], w[64], pars->GC_10, amp[88]); 
  FFV1_0(w[66], w[10], w[1], pars->GC_11, amp[89]); 
  FFV1_0(w[67], w[5], w[26], pars->GC_11, amp[90]); 
  FFV1_0(w[46], w[6], w[65], pars->GC_11, amp[91]); 
  VVV1_0(w[65], w[1], w[26], pars->GC_10, amp[92]); 
  FFV2_0(w[67], w[31], w[4], pars->GC_100, amp[93]); 
  FFV1_0(w[62], w[6], w[60], pars->GC_11, amp[94]); 
  FFV1_0(w[62], w[31], w[1], pars->GC_11, amp[95]); 
  FFV1_0(w[69], w[6], w[50], pars->GC_11, amp[96]); 
  FFV1_0(w[7], w[10], w[70], pars->GC_11, amp[97]); 
  FFV1_0(w[7], w[48], w[71], pars->GC_11, amp[98]); 
  FFV1_0(w[21], w[6], w[70], pars->GC_11, amp[99]); 
  FFV1_0(w[7], w[35], w[72], pars->GC_11, amp[100]); 
  FFV1_0(w[21], w[33], w[72], pars->GC_11, amp[101]); 
  FFV1_0(w[69], w[33], w[16], pars->GC_11, amp[102]); 
  FFV2_0(w[73], w[33], w[4], pars->GC_100, amp[103]); 
  FFV1_0(w[69], w[6], w[54], pars->GC_11, amp[104]); 
  FFV1_0(w[38], w[6], w[72], pars->GC_11, amp[105]); 
  FFV1_0(w[37], w[5], w[71], pars->GC_11, amp[106]); 
  FFV1_0(w[37], w[10], w[72], pars->GC_11, amp[107]); 
  FFV1_0(w[74], w[5], w[12], pars->GC_11, amp[108]); 
  FFV1_0(w[7], w[44], w[72], pars->GC_11, amp[109]); 
  VVV1_0(w[72], w[1], w[12], pars->GC_10, amp[110]); 
  FFV1_0(w[74], w[10], w[16], pars->GC_11, amp[111]); 
  VVV1_0(w[1], w[16], w[71], pars->GC_10, amp[112]); 
  FFV1_0(w[73], w[10], w[1], pars->GC_11, amp[113]); 
  FFV1_0(w[74], w[5], w[22], pars->GC_11, amp[114]); 
  FFV1_0(w[45], w[6], w[72], pars->GC_11, amp[115]); 
  VVV1_0(w[72], w[1], w[22], pars->GC_10, amp[116]); 
  FFV2_0(w[74], w[29], w[4], pars->GC_100, amp[117]); 
  FFV1_0(w[69], w[6], w[59], pars->GC_11, amp[118]); 
  FFV1_0(w[69], w[29], w[1], pars->GC_11, amp[119]); 
  FFV1_0(w[8], w[75], w[12], pars->GC_11, amp[120]); 
  FFV1_0(w[7], w[75], w[13], pars->GC_11, amp[121]); 
  FFV1_0(w[8], w[76], w[50], pars->GC_11, amp[122]); 
  FFV1_0(w[7], w[76], w[51], pars->GC_11, amp[123]); 
  VVV1_0(w[0], w[50], w[13], pars->GC_10, amp[124]); 
  VVV1_0(w[0], w[51], w[12], pars->GC_10, amp[125]); 
  FFV1_0(w[8], w[75], w[22], pars->GC_11, amp[126]); 
  FFV1_0(w[77], w[6], w[51], pars->GC_11, amp[127]); 
  VVV1_0(w[0], w[51], w[22], pars->GC_10, amp[128]); 
  FFV1_0(w[7], w[75], w[26], pars->GC_11, amp[129]); 
  FFV1_0(w[78], w[6], w[50], pars->GC_11, amp[130]); 
  VVV1_0(w[0], w[50], w[26], pars->GC_10, amp[131]); 
  ...
  FFV1_0(w[8], w[35], w[81], pars->GC_11, amp[139]); 
  FFV1_0(w[28], w[35], w[0], pars->GC_11, amp[140]); 
  FFV2_0(w[30], w[79], w[4], pars->GC_100, amp[141]); 
  FFV1_0(w[7], w[35], w[80], pars->GC_11, amp[142]); 
  FFV1_0(w[30], w[35], w[0], pars->GC_11, amp[143]); 
  FFV1_0(w[82], w[5], w[13], pars->GC_11, amp[144]); 
  FFV1_0(w[8], w[76], w[54], pars->GC_11, amp[145]); 
  VVV1_0(w[0], w[54], w[13], pars->GC_10, amp[146]); 
  FFV1_0(w[82], w[10], w[19], pars->GC_11, amp[147]); 
  FFV1_0(w[37], w[76], w[19], pars->GC_11, amp[148]); 
  FFV1_0(w[37], w[10], w[80], pars->GC_11, amp[149]); 
  FFV1_0(w[82], w[5], w[26], pars->GC_11, amp[150]); 
  FFV1_0(w[78], w[6], w[54], pars->GC_11, amp[151]); 
  VVV1_0(w[0], w[54], w[26], pars->GC_10, amp[152]); 
  FFV2_0(w[82], w[31], w[4], pars->GC_100, amp[153]); 
  FFV1_0(w[38], w[6], w[80], pars->GC_11, amp[154]); 
  FFV1_0(w[38], w[31], w[0], pars->GC_11, amp[155]); 
  FFV1_0(w[83], w[5], w[12], pars->GC_11, amp[156]); 
  FFV1_0(w[7], w[76], w[56], pars->GC_11, amp[157]); 
  VVV1_0(w[0], w[56], w[12], pars->GC_10, amp[158]); 
  FFV1_0(w[83], w[10], w[16], pars->GC_11, amp[159]); 
  FFV1_0(w[40], w[76], w[16], pars->GC_11, amp[160]); 
  FFV1_0(w[40], w[10], w[81], pars->GC_11, amp[161]); 
  FFV1_0(w[83], w[5], w[22], pars->GC_11, amp[162]); 
  FFV1_0(w[77], w[6], w[56], pars->GC_11, amp[163]); 
  VVV1_0(w[0], w[56], w[22], pars->GC_10, amp[164]); 
  FFV2_0(w[83], w[29], w[4], pars->GC_100, amp[165]); 
  FFV1_0(w[41], w[6], w[81], pars->GC_11, amp[166]); 
  FFV1_0(w[41], w[29], w[0], pars->GC_11, amp[167]); 
  FFV1_0(w[8], w[76], w[59], pars->GC_11, amp[168]); 
  FFV1_0(w[28], w[76], w[1], pars->GC_11, amp[169]); 
  FFV1_0(w[8], w[44], w[81], pars->GC_11, amp[170]); 
  VVV1_0(w[81], w[1], w[13], pars->GC_10, amp[171]); 
  FFV1_0(w[28], w[44], w[0], pars->GC_11, amp[172]); 
  VVV1_0(w[0], w[59], w[13], pars->GC_10, amp[173]); 
  FFV1_0(w[8], w[10], w[84], pars->GC_11, amp[174]); 
  FFV1_0(w[8], w[10], w[85], pars->GC_11, amp[175]); 
  FFV1_0(w[8], w[10], w[86], pars->GC_11, amp[176]); 
  FFV1_0(w[7], w[76], w[60], pars->GC_11, amp[177]); 
  FFV1_0(w[30], w[76], w[1], pars->GC_11, amp[178]); 
  FFV1_0(w[7], w[44], w[80], pars->GC_11, amp[179]); 
  VVV1_0(w[80], w[1], w[12], pars->GC_10, amp[180]); 
  FFV1_0(w[30], w[44], w[0], pars->GC_11, amp[181]); 
  VVV1_0(w[0], w[60], w[12], pars->GC_10, amp[182]); 
  FFV1_0(w[7], w[10], w[87], pars->GC_11, amp[183]); 
  FFV1_0(w[7], w[10], w[88], pars->GC_11, amp[184]); 
  FFV1_0(w[7], w[10], w[89], pars->GC_11, amp[185]); 
  FFV1_0(w[77], w[6], w[60], pars->GC_11, amp[186]); 
  FFV1_0(w[77], w[31], w[1], pars->GC_11, amp[187]); 
  FFV1_0(w[45], w[6], w[80], pars->GC_11, amp[188]); 
  VVV1_0(w[80], w[1], w[22], pars->GC_10, amp[189]); 
  FFV1_0(w[45], w[31], w[0], pars->GC_11, amp[190]); 
  VVV1_0(w[0], w[60], w[22], pars->GC_10, amp[191]); 
  FFV1_0(w[21], w[6], w[87], pars->GC_11, amp[192]); 
  FFV1_0(w[21], w[6], w[88], pars->GC_11, amp[193]); 
  FFV1_0(w[21], w[6], w[89], pars->GC_11, amp[194]); 
  FFV1_0(w[78], w[6], w[59], pars->GC_11, amp[195]); 
  FFV1_0(w[78], w[29], w[1], pars->GC_11, amp[196]); 
  FFV1_0(w[46], w[6], w[81], pars->GC_11, amp[197]); 
  VVV1_0(w[81], w[1], w[26], pars->GC_10, amp[198]); 
  FFV1_0(w[46], w[29], w[0], pars->GC_11, amp[199]); 
  VVV1_0(w[0], w[59], w[26], pars->GC_10, amp[200]); 
  FFV1_0(w[25], w[6], w[84], pars->GC_11, amp[201]); 
  FFV1_0(w[25], w[6], w[85], pars->GC_11, amp[202]); 
  FFV1_0(w[25], w[6], w[86], pars->GC_11, amp[203]); 

}
double P0_Sigma_sm_gg_mupvmuduxux_W_4j::matrix_gg_wpuduxux_wp_mupvm() 
{
  int i, j; 
  // Local variables
