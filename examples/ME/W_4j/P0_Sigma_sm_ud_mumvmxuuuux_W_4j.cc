...
#include "P0_Sigma_sm_ud_mumvmxuuuux_W_4j.h"
...
void P0_Sigma_sm_ud_mumvmxuuuux_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_ud_mumvmxuuuux_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_ud_wmuuuux_wm_mumvmx(); 
        ...
        t[1] = matrix_ud_wmuuuux_wm_mumvmx(); 
        double tsum = 0; 
...
double P0_Sigma_sm_ud_mumvmxuuuux_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_ud_mumvmxuuuux_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[0], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[9]); 
  FFV1_3(w[8], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[10]); 
  FFV1_1(w[7], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[11]); 
  FFV1_2(w[1], w[10], pars->GC_11, pars->ZERO, pars->ZERO, w[12]); 
  FFV1_2(w[1], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[13]); 
  FFV1_1(w[7], w[10], pars->GC_11, pars->ZERO, pars->ZERO, w[14]); 
  FFV2_1(w[7], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[15]); 
  ...
  FFV1_3(w[8], w[7], pars->GC_11, pars->ZERO, pars->ZERO, w[20]); 
  FFV1_1(w[6], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[21]); 
  FFV1_2(w[1], w[20], pars->GC_11, pars->ZERO, pars->ZERO, w[22]); 
  FFV1_1(w[6], w[20], pars->GC_11, pars->ZERO, pars->ZERO, w[23]); 
  FFV2_1(w[6], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[24]); 
  VVV1_1(w[9], w[20], pars->GC_10, pars->ZERO, pars->ZERO, w[25]); 
  FFV1_1(w[24], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[26]); 
  FFV1_2(w[8], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[27]); 
  FFV1_3(w[1], w[24], pars->GC_11, pars->ZERO, pars->ZERO, w[28]); 
  FFV1_3(w[1], w[15], pars->GC_11, pars->ZERO, pars->ZERO, w[29]); 
  FFV1_3(w[18], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[30]); 
  FFV1_3(w[18], w[7], pars->GC_11, pars->ZERO, pars->ZERO, w[31]); 
  FFV1_3(w[0], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[32]); 
  FFV1_3(w[8], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[33]); 
  FFV1_1(w[7], w[32], pars->GC_11, pars->ZERO, pars->ZERO, w[34]); 
  FFV1_2(w[1], w[33], pars->GC_11, pars->ZERO, pars->ZERO, w[35]); 
  FFV1_2(w[1], w[32], pars->GC_11, pars->ZERO, pars->ZERO, w[36]); 
  FFV1_1(w[7], w[33], pars->GC_11, pars->ZERO, pars->ZERO, w[37]); 
  ...
  FFV1_1(w[5], w[32], pars->GC_11, pars->ZERO, pars->ZERO, w[41]); 
  FFV1_1(w[5], w[20], pars->GC_11, pars->ZERO, pars->ZERO, w[42]); 
  FFV2_1(w[5], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[43]); 
  VVV1_1(w[32], w[20], pars->GC_10, pars->ZERO, pars->ZERO, w[44]); 
  FFV1_1(w[43], w[32], pars->GC_11, pars->ZERO, pars->ZERO, w[45]); 
  FFV1_2(w[8], w[32], pars->GC_11, pars->ZERO, pars->ZERO, w[46]); 
  FFV1_3(w[1], w[43], pars->GC_11, pars->ZERO, pars->ZERO, w[47]); 
  FFV1_3(w[18], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[48]); 
  FFV1_3(w[0], w[7], pars->GC_11, pars->ZERO, pars->ZERO, w[49]); 
  FFV1_1(w[6], w[49], pars->GC_11, pars->ZERO, pars->ZERO, w[50]); 
  FFV1_2(w[1], w[49], pars->GC_11, pars->ZERO, pars->ZERO, w[51]); 
  FFV1_1(w[6], w[33], pars->GC_11, pars->ZERO, pars->ZERO, w[52]); 
  ...
  FFV1_1(w[5], w[49], pars->GC_11, pars->ZERO, pars->ZERO, w[56]); 
  FFV1_1(w[5], w[10], pars->GC_11, pars->ZERO, pars->ZERO, w[57]); 
  VVV1_1(w[49], w[10], pars->GC_10, pars->ZERO, pars->ZERO, w[58]); 
  FFV1_1(w[43], w[49], pars->GC_11, pars->ZERO, pars->ZERO, w[59]); 
  FFV1_2(w[8], w[49], pars->GC_11, pars->ZERO, pars->ZERO, w[60]); 
  ...
  FFV1_0(w[1], w[15], w[16], pars->GC_11, amp[2]); 
  FFV1_0(w[1], w[17], w[10], pars->GC_11, amp[3]); 
  FFV1_0(w[13], w[15], w[10], pars->GC_11, amp[4]); 
  FFV1_0(w[18], w[7], w[16], pars->GC_11, amp[5]); 
  FFV1_0(w[19], w[7], w[10], pars->GC_11, amp[6]); 
  FFV1_0(w[18], w[11], w[10], pars->GC_11, amp[7]); 
  FFV2_0(w[22], w[21], w[4], pars->GC_100, amp[8]); 
  FFV2_0(w[13], w[23], w[4], pars->GC_100, amp[9]); 
  FFV1_0(w[1], w[24], w[25], pars->GC_11, amp[10]); 
  FFV1_0(w[1], w[26], w[20], pars->GC_11, amp[11]); 
  FFV1_0(w[13], w[24], w[20], pars->GC_11, amp[12]); 
  FFV1_0(w[18], w[6], w[25], pars->GC_11, amp[13]); 
  FFV1_0(w[19], w[6], w[20], pars->GC_11, amp[14]); 
  FFV1_0(w[18], w[21], w[20], pars->GC_11, amp[15]); 
  FFV1_0(w[27], w[7], w[28], pars->GC_11, amp[16]); 
  FFV1_0(w[8], w[11], w[28], pars->GC_11, amp[17]); 
  FFV1_0(w[27], w[6], w[29], pars->GC_11, amp[18]); 
  FFV1_0(w[8], w[21], w[29], pars->GC_11, amp[19]); 
  FFV1_0(w[27], w[7], w[30], pars->GC_11, amp[20]); 
  FFV1_0(w[27], w[6], w[31], pars->GC_11, amp[21]); 
  FFV1_0(w[8], w[21], w[31], pars->GC_11, amp[22]); 
  FFV1_0(w[8], w[11], w[30], pars->GC_11, amp[23]); 
  FFV2_0(w[35], w[34], w[4], pars->GC_100, amp[24]); 
  FFV2_0(w[36], w[37], w[4], pars->GC_100, amp[25]); 
  FFV1_0(w[1], w[15], w[38], pars->GC_11, amp[26]); 
  FFV1_0(w[1], w[39], w[33], pars->GC_11, amp[27]); 
  FFV1_0(w[36], w[15], w[33], pars->GC_11, amp[28]); 
  FFV1_0(w[18], w[7], w[38], pars->GC_11, amp[29]); 
  FFV1_0(w[40], w[7], w[33], pars->GC_11, amp[30]); 
  FFV1_0(w[18], w[34], w[33], pars->GC_11, amp[31]); 
  FFV2_0(w[22], w[41], w[4], pars->GC_100, amp[32]); 
  FFV2_0(w[36], w[42], w[4], pars->GC_100, amp[33]); 
  FFV1_0(w[1], w[43], w[44], pars->GC_11, amp[34]); 
  FFV1_0(w[1], w[45], w[20], pars->GC_11, amp[35]); 
  FFV1_0(w[36], w[43], w[20], pars->GC_11, amp[36]); 
  FFV1_0(w[18], w[5], w[44], pars->GC_11, amp[37]); 
  FFV1_0(w[40], w[5], w[20], pars->GC_11, amp[38]); 
  FFV1_0(w[18], w[41], w[20], pars->GC_11, amp[39]); 
  FFV1_0(w[46], w[7], w[47], pars->GC_11, amp[40]); 
  FFV1_0(w[8], w[34], w[47], pars->GC_11, amp[41]); 
  FFV1_0(w[46], w[5], w[29], pars->GC_11, amp[42]); 
  FFV1_0(w[8], w[41], w[29], pars->GC_11, amp[43]); 
  FFV1_0(w[46], w[7], w[48], pars->GC_11, amp[44]); 
  FFV1_0(w[46], w[5], w[31], pars->GC_11, amp[45]); 
  FFV1_0(w[8], w[41], w[31], pars->GC_11, amp[46]); 
  FFV1_0(w[8], w[34], w[48], pars->GC_11, amp[47]); 
  FFV2_0(w[35], w[50], w[4], pars->GC_100, amp[48]); 
  FFV2_0(w[51], w[52], w[4], pars->GC_100, amp[49]); 
  FFV1_0(w[1], w[24], w[53], pars->GC_11, amp[50]); 
  FFV1_0(w[1], w[54], w[33], pars->GC_11, amp[51]); 
  FFV1_0(w[51], w[24], w[33], pars->GC_11, amp[52]); 
  FFV1_0(w[18], w[6], w[53], pars->GC_11, amp[53]); 
  FFV1_0(w[55], w[6], w[33], pars->GC_11, amp[54]); 
  FFV1_0(w[18], w[50], w[33], pars->GC_11, amp[55]); 
  FFV2_0(w[12], w[56], w[4], pars->GC_100, amp[56]); 
  FFV2_0(w[51], w[57], w[4], pars->GC_100, amp[57]); 
  FFV1_0(w[1], w[43], w[58], pars->GC_11, amp[58]); 
  FFV1_0(w[1], w[59], w[10], pars->GC_11, amp[59]); 
  FFV1_0(w[51], w[43], w[10], pars->GC_11, amp[60]); 
  FFV1_0(w[18], w[5], w[58], pars->GC_11, amp[61]); 
  FFV1_0(w[55], w[5], w[10], pars->GC_11, amp[62]); 
  FFV1_0(w[18], w[56], w[10], pars->GC_11, amp[63]); 
  FFV1_0(w[60], w[6], w[47], pars->GC_11, amp[64]); 
  FFV1_0(w[8], w[50], w[47], pars->GC_11, amp[65]); 
  FFV1_0(w[60], w[5], w[28], pars->GC_11, amp[66]); 
  FFV1_0(w[8], w[56], w[28], pars->GC_11, amp[67]); 
  FFV1_0(w[60], w[6], w[48], pars->GC_11, amp[68]); 
  FFV1_0(w[60], w[5], w[30], pars->GC_11, amp[69]); 
  FFV1_0(w[8], w[56], w[30], pars->GC_11, amp[70]); 
  FFV1_0(w[8], w[50], w[48], pars->GC_11, amp[71]); 
  FFV1_0(w[61], w[7], w[28], pars->GC_11, amp[72]); 
  FFV1_0(w[0], w[37], w[28], pars->GC_11, amp[73]); 
  FFV1_0(w[61], w[6], w[29], pars->GC_11, amp[74]); 
  FFV1_0(w[0], w[52], w[29], pars->GC_11, amp[75]); 
  FFV1_0(w[61], w[7], w[30], pars->GC_11, amp[76]); 
  FFV1_0(w[61], w[6], w[31], pars->GC_11, amp[77]); 
  FFV1_0(w[0], w[52], w[31], pars->GC_11, amp[78]); 
  FFV1_0(w[0], w[37], w[30], pars->GC_11, amp[79]); 
  FFV1_0(w[62], w[7], w[47], pars->GC_11, amp[80]); 
  FFV1_0(w[0], w[14], w[47], pars->GC_11, amp[81]); 
  FFV1_0(w[62], w[5], w[29], pars->GC_11, amp[82]); 
  FFV1_0(w[0], w[57], w[29], pars->GC_11, amp[83]); 
  FFV1_0(w[62], w[7], w[48], pars->GC_11, amp[84]); 
  FFV1_0(w[62], w[5], w[31], pars->GC_11, amp[85]); 
  FFV1_0(w[0], w[57], w[31], pars->GC_11, amp[86]); 
  FFV1_0(w[0], w[14], w[48], pars->GC_11, amp[87]); 
  FFV1_0(w[63], w[6], w[47], pars->GC_11, amp[88]); 
  FFV1_0(w[0], w[23], w[47], pars->GC_11, amp[89]); 
  FFV1_0(w[63], w[5], w[28], pars->GC_11, amp[90]); 
  FFV1_0(w[0], w[42], w[28], pars->GC_11, amp[91]); 
  FFV1_0(w[63], w[6], w[48], pars->GC_11, amp[92]); 
  FFV1_0(w[63], w[5], w[30], pars->GC_11, amp[93]); 
  FFV1_0(w[0], w[42], w[30], pars->GC_11, amp[94]); 
  FFV1_0(w[0], w[23], w[48], pars->GC_11, amp[95]); 

}
double P0_Sigma_sm_ud_mumvmxuuuux_W_4j::matrix_ud_wmuuuux_wm_mumvmx() 
{
  int i, j; 
  // Local variables
  ...
  jamp[2] = +1./4. * (+amp[1] + std::complex<double> (0, 1) * amp[2] + amp[4] +
  ...
  jamp[3] = +1./4. * (-1./3. * amp[0] - 1./3. * amp[1] - 1./3. * amp[3] - 1./3.
      * amp[4] - 1./3. * amp[6] - 1./3. * amp[7] - amp[9] -
      ...
      amp[95]);
  jamp[4] = +1./4. * (-amp[8] + std::complex<double> (0, 1) * amp[10] - amp[11]
