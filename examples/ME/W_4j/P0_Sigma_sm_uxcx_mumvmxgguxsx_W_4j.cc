...
#include "P0_Sigma_sm_uxcx_mumvmxgguxsx_W_4j.h"
...
void P0_Sigma_sm_uxcx_mumvmxgguxsx_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_uxcx_mumvmxgguxsx_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_uxcx_wmgguxsx_wm_mumvmx(); 
        ...
        t[1] = matrix_uxcx_wmgguxsx_wm_mumvmx(); 
        double tsum = 0; 
...
double P0_Sigma_sm_uxcx_mumvmxgguxsx_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_uxcx_mumvmxgguxsx_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[7], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[14]); 
  ...
  FFV1_3(w[28], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[40]); 
  ...
  FFV1_3(w[44], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[46]); 
  ...
  FFV1_0(w[13], w[0], w[12], pars->GC_11, amp[1]); 
  ...
  FFV1_0(w[13], w[0], w[19], pars->GC_11, amp[6]); 
  ...
  FFV1_0(w[18], w[1], w[29], pars->GC_11, amp[15]); 
  FFV1_0(w[31], w[1], w[26], pars->GC_11, amp[16]); 
  ...
  FFV1_0(w[28], w[0], w[39], pars->GC_11, amp[27]); 
  ...
  FFV1_0(w[49], w[1], w[43], pars->GC_11, amp[58]); 
  ...
  FFV1_0(w[58], w[0], w[12], pars->GC_11, amp[72]); 
  FFV1_0(w[8], w[54], w[40], pars->GC_11, amp[73]); 
  VVV1_0(w[5], w[40], w[12], pars->GC_10, amp[74]); 
  FFV1_0(w[58], w[0], w[19], pars->GC_11, amp[75]); 
  FFV1_0(w[55], w[1], w[40], pars->GC_11, amp[76]); 
  ...
  FFV1_0(w[31], w[1], w[57], pars->GC_11, amp[82]); 
...
double P0_Sigma_sm_uxcx_mumvmxgguxsx_W_4j::matrix_uxcx_wmgguxsx_wm_mumvmx() 
{
  int i, j; 
  // Local variables
  ...
  jamp[8] = +1./2. * (-1./3. * amp[12] - 1./3. * amp[13] - 1./3. * amp[16] -
      ...
      1./3. * amp[46]);
  jamp[9] = +1./2. * (+amp[12] + amp[13] + amp[14] + amp[15] + amp[19] +
  ...
  jamp[10] = +1./2. * (+amp[24] + amp[25] + amp[28] + amp[29] +
