...
#include "P0_Sigma_sm_uxdx_mumvmxuuxdxdx_W_4j.h"
...
void P0_Sigma_sm_uxdx_mumvmxuuxdxdx_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_uxdx_mumvmxuuxdxdx_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_uxdx_wmuuxdxdx_wm_mumvmx(); 
        ...
        t[1] = matrix_uxdx_wmuuxdxdx_wm_mumvmx(); 
        double tsum = 0; 
...
double P0_Sigma_sm_uxdx_mumvmxuuxdxdx_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_uxdx_mumvmxuuxdxdx_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[6], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[32]); 
...
double P0_Sigma_sm_uxdx_mumvmxuuxdxdx_W_4j::matrix_uxdx_wmuuxdxdx_wm_mumvmx() 
{
  int i, j; 
  // Local variables
  ...
  jamp[3] = +1./4. * (-1./3. * amp[2] - 1./3. * amp[3] - amp[5] +
