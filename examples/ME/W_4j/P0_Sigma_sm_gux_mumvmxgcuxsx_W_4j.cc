...
#include "P0_Sigma_sm_gux_mumvmxgcuxsx_W_4j.h"
...
// Process: g u~ > w- g c u~ s~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: g c~ > w- g u c~ d~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: g d~ > w- g c d~ s~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: g s~ > w- g u s~ d~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_gux_mumvmxgcuxsx_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_gux_mumvmxgcuxsx_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_gux_wmgcuxsx_wm_mumvmx(); 
        ...
        t[1] = matrix_gux_wmgcuxsx_wm_mumvmx(); 
        double tsum = 0; 
...
double P0_Sigma_sm_gux_mumvmxgcuxsx_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_gux_mumvmxgcuxsx_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[18], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[19]); 
  FFV1_2(w[18], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[20]); 
  FFV1_1(w[6], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[21]); 
  FFV1_2(w[8], w[14], pars->GC_11, pars->ZERO, pars->ZERO, w[22]); 
  FFV1_1(w[6], w[14], pars->GC_11, pars->ZERO, pars->ZERO, w[23]); 
  FFV1_1(w[1], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[24]); 
  FFV1_1(w[6], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[25]); 
  FFV1_3(w[7], w[24], pars->GC_11, pars->ZERO, pars->ZERO, w[26]); 
  ...
  FFV1_3(w[44], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[46]); 
  FFV1_2(w[44], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[47]); 
  FFV1_2(w[8], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[48]); 
  ...
  FFV1_2(w[48], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[52]); 
  ...
  FFV1_0(w[7], w[11], w[19], pars->GC_11, amp[5]); 
  FFV1_0(w[13], w[1], w[19], pars->GC_11, amp[6]); 
  FFV1_0(w[20], w[6], w[14], pars->GC_11, amp[7]); 
  FFV1_0(w[18], w[6], w[16], pars->GC_11, amp[8]); 
  FFV1_0(w[18], w[21], w[14], pars->GC_11, amp[9]); 
  FFV2_0(w[22], w[21], w[4], pars->GC_100, amp[10]); 
  FFV2_0(w[17], w[23], w[4], pars->GC_100, amp[11]); 
  FFV1_0(w[8], w[27], w[26], pars->GC_11, amp[12]); 
  FFV1_0(w[18], w[25], w[26], pars->GC_11, amp[13]); 
  FFV1_0(w[8], w[10], w[29], pars->GC_11, amp[14]); 
  FFV1_0(w[18], w[6], w[29], pars->GC_11, amp[15]); 
  FFV1_0(w[31], w[6], w[26], pars->GC_11, amp[16]); 
  FFV1_0(w[30], w[10], w[26], pars->GC_11, amp[17]); 
  FFV1_0(w[7], w[32], w[12], pars->GC_11, amp[18]); 
  FFV1_0(w[8], w[33], w[26], pars->GC_11, amp[19]); 
  VVV1_0(w[26], w[5], w[12], pars->GC_10, amp[20]); 
  FFV1_0(w[7], w[32], w[19], pars->GC_11, amp[21]); 
  FFV1_0(w[34], w[6], w[26], pars->GC_11, amp[22]); 
  VVV1_0(w[26], w[5], w[19], pars->GC_10, amp[23]); 
  FFV1_0(w[8], w[37], w[38], pars->GC_11, amp[24]); 
  FFV1_0(w[7], w[36], w[39], pars->GC_11, amp[25]); 
  FFV1_0(w[8], w[37], w[40], pars->GC_11, amp[26]); 
  FFV1_0(w[28], w[1], w[39], pars->GC_11, amp[27]); 
  ...
  FFV1_0(w[18], w[41], w[5], pars->GC_11, amp[32]); 
  FFV2_0(w[22], w[42], w[4], pars->GC_100, amp[33]); 
  FFV1_0(w[8], w[37], w[43], pars->GC_11, amp[34]); 
  FFV1_0(w[22], w[37], w[5], pars->GC_11, amp[35]); 
  FFV1_0(w[8], w[10], w[45], pars->GC_11, amp[36]); 
  FFV1_0(w[18], w[6], w[45], pars->GC_11, amp[37]); 
  FFV1_0(w[8], w[27], w[46], pars->GC_11, amp[38]); 
  FFV1_0(w[18], w[25], w[46], pars->GC_11, amp[39]); 
  FFV1_0(w[31], w[6], w[46], pars->GC_11, amp[40]); 
  FFV1_0(w[30], w[10], w[46], pars->GC_11, amp[41]); 
  FFV1_0(w[47], w[1], w[12], pars->GC_11, amp[42]); 
  FFV1_0(w[8], w[33], w[46], pars->GC_11, amp[43]); 
  VVV1_0(w[46], w[5], w[12], pars->GC_10, amp[44]); 
  FFV1_0(w[47], w[1], w[19], pars->GC_11, amp[45]); 
  FFV1_0(w[34], w[6], w[46], pars->GC_11, amp[46]); 
  VVV1_0(w[46], w[5], w[19], pars->GC_10, amp[47]); 
  FFV1_0(w[49], w[6], w[38], pars->GC_11, amp[48]); 
  FFV1_0(w[7], w[36], w[50], pars->GC_11, amp[49]); 
  FFV1_0(w[49], w[25], w[14], pars->GC_11, amp[50]); 
  FFV2_0(w[51], w[25], w[4], pars->GC_100, amp[51]); 
  FFV1_0(w[49], w[6], w[40], pars->GC_11, amp[52]); 
  FFV1_0(w[28], w[1], w[50], pars->GC_11, amp[53]); 
  FFV1_0(w[52], w[10], w[14], pars->GC_11, amp[54]); 
  VVV1_0(w[5], w[14], w[50], pars->GC_10, amp[55]); 
  FFV1_0(w[51], w[10], w[5], pars->GC_11, amp[56]); 
  FFV2_0(w[52], w[23], w[4], pars->GC_100, amp[57]); 
  FFV1_0(w[49], w[6], w[43], pars->GC_11, amp[58]); 
  FFV1_0(w[49], w[23], w[5], pars->GC_11, amp[59]); 
  FFV1_0(w[7], w[53], w[12], pars->GC_11, amp[60]); 
  FFV1_0(w[8], w[54], w[38], pars->GC_11, amp[61]); 
  VVV1_0(w[0], w[38], w[12], pars->GC_10, amp[62]); 
  FFV1_0(w[7], w[53], w[19], pars->GC_11, amp[63]); 
  FFV1_0(w[55], w[6], w[38], pars->GC_11, amp[64]); 
  ...
  FFV1_0(w[8], w[27], w[57], pars->GC_11, amp[70]); 
  FFV1_0(w[22], w[27], w[0], pars->GC_11, amp[71]); 
  FFV1_0(w[58], w[1], w[12], pars->GC_11, amp[72]); 
  FFV1_0(w[8], w[54], w[40], pars->GC_11, amp[73]); 
  VVV1_0(w[0], w[40], w[12], pars->GC_10, amp[74]); 
  FFV1_0(w[58], w[1], w[19], pars->GC_11, amp[75]); 
  FFV1_0(w[55], w[6], w[40], pars->GC_11, amp[76]); 
  VVV1_0(w[0], w[40], w[19], pars->GC_10, amp[77]); 
  ...
  FFV1_0(w[31], w[6], w[57], pars->GC_11, amp[82]); 
  FFV1_0(w[31], w[23], w[0], pars->GC_11, amp[83]); 
  FFV1_0(w[8], w[54], w[43], pars->GC_11, amp[84]); 
  FFV1_0(w[22], w[54], w[5], pars->GC_11, amp[85]); 
  FFV1_0(w[8], w[33], w[57], pars->GC_11, amp[86]); 
  VVV1_0(w[57], w[5], w[12], pars->GC_10, amp[87]); 
  FFV1_0(w[22], w[33], w[0], pars->GC_11, amp[88]); 
  VVV1_0(w[0], w[43], w[12], pars->GC_10, amp[89]); 
  FFV1_0(w[8], w[10], w[60], pars->GC_11, amp[90]); 
  FFV1_0(w[8], w[10], w[61], pars->GC_11, amp[91]); 
  FFV1_0(w[8], w[10], w[62], pars->GC_11, amp[92]); 
  FFV1_0(w[55], w[6], w[43], pars->GC_11, amp[93]); 
  FFV1_0(w[55], w[23], w[5], pars->GC_11, amp[94]); 
  FFV1_0(w[34], w[6], w[57], pars->GC_11, amp[95]); 
  VVV1_0(w[57], w[5], w[19], pars->GC_10, amp[96]); 
  FFV1_0(w[34], w[23], w[0], pars->GC_11, amp[97]); 
  VVV1_0(w[0], w[43], w[19], pars->GC_10, amp[98]); 
  FFV1_0(w[18], w[6], w[60], pars->GC_11, amp[99]); 
  FFV1_0(w[18], w[6], w[61], pars->GC_11, amp[100]); 
  FFV1_0(w[18], w[6], w[62], pars->GC_11, amp[101]); 

}
double P0_Sigma_sm_gux_mumvmxgcuxsx_W_4j::matrix_gux_wmgcuxsx_wm_mumvmx() 
{
  int i, j; 
  // Local variables
  ...
  jamp[0] = +1./2. * (-1./3. * amp[12] - 1./3. * amp[13] - 1./3. * amp[16] -
      1./3. * amp[17] - 1./3. * amp[19] - 1./3. * amp[22] - 1./3. * amp[38] -
      1./3. * amp[39] - 1./3. * amp[40] - 1./3. * amp[41] - 1./3. * amp[43] -
      1./3. * amp[46]);
  jamp[1] = +1./2. * (+amp[12] + amp[13] + amp[14] + amp[15] + amp[19] +
