...
#include "P0_Sigma_sm_udx_mupvmgguux_W_4j.h"
...
void P0_Sigma_sm_udx_mupvmgguux_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_udx_mupvmgguux_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_udx_wpgguux_wp_mupvm(); 
        ...
        t[1] = matrix_udx_wpgguux_wp_mupvm(); 
        double tsum = 0; 
...
double P0_Sigma_sm_udx_mupvmgguux_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_udx_mupvmgguux_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double P0_Sigma_sm_udx_mupvmgguux_W_4j::matrix_udx_wpgguux_wp_mupvm() 
{
  int i, j; 
  // Local variables
  ...
  jamp[4] = +1./2. * (+amp[48] + 1./3. * amp[49] + 1./3. * amp[50] + amp[51] +
      ...
      amp[201] + amp[202]);
  jamp[5] = +1./2. * (-1./3. * amp[48] - amp[49] - amp[50] - 1./3. * amp[51] -
