...
#include "P0_Sigma_sm_ud_mupvmuddux_W_4j.h"
...
// Process: u d > w+ u d d u~ WEIGHTED=6
// *   Decay: w+ > mu+ vm WEIGHTED=2
// Process: c s > w+ c s s c~ WEIGHTED=6
// *   Decay: w+ > mu+ vm WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_ud_mupvmuddux_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_ud_mupvmuddux_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_ud_wpuddux_wp_mupvm(); 
        ...
        t[1] = matrix_ud_wpuddux_wp_mupvm(); 
        double tsum = 0; 
...
double P0_Sigma_sm_ud_mupvmuddux_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_ud_mupvmuddux_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_1(w[5], w[16], pars->GC_11, pars->ZERO, pars->ZERO, w[22]); 
  FFV1_2(w[8], w[19], pars->GC_11, pars->ZERO, pars->ZERO, w[23]); 
  FFV1_1(w[5], w[19], pars->GC_11, pars->ZERO, pars->ZERO, w[24]); 
  FFV1_3(w[0], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[25]); 
  FFV2_2(w[8], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[26]); 
  FFV1_1(w[6], w[25], pars->GC_11, pars->ZERO, pars->ZERO, w[27]); 
  FFV1_3(w[26], w[7], pars->GC_11, pars->ZERO, pars->ZERO, w[28]); 
  FFV1_1(w[7], w[25], pars->GC_11, pars->ZERO, pars->ZERO, w[29]); 
  FFV1_3(w[26], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[30]); 
  FFV1_2(w[1], w[25], pars->GC_11, pars->ZERO, pars->ZERO, w[31]); 
  ...
  FFV2_1(w[6], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[35]); 
  FFV1_3(w[8], w[35], pars->GC_11, pars->ZERO, pars->ZERO, w[36]); 
  FFV1_2(w[8], w[25], pars->GC_11, pars->ZERO, pars->ZERO, w[37]); 
  FFV1_1(w[35], w[25], pars->GC_11, pars->ZERO, pars->ZERO, w[38]); 
  FFV2_1(w[7], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[39]); 
  FFV1_3(w[8], w[39], pars->GC_11, pars->ZERO, pars->ZERO, w[40]); 
  FFV1_1(w[39], w[25], pars->GC_11, pars->ZERO, pars->ZERO, w[41]); 
  FFV1_1(w[7], w[16], pars->GC_11, pars->ZERO, pars->ZERO, w[42]); 
  FFV1_1(w[6], w[19], pars->GC_11, pars->ZERO, pars->ZERO, w[43]); 
  FFV1_2(w[0], w[16], pars->GC_11, pars->ZERO, pars->ZERO, w[44]); 
  FFV1_2(w[0], w[19], pars->GC_11, pars->ZERO, pars->ZERO, w[45]); 
  FFV1_3(w[0], w[35], pars->GC_11, pars->ZERO, pars->ZERO, w[46]); 
  FFV1_2(w[0], w[10], pars->GC_11, pars->ZERO, pars->ZERO, w[47]); 
  FFV1_3(w[0], w[39], pars->GC_11, pars->ZERO, pars->ZERO, w[48]); 
  ...
  FFV1_0(w[21], w[5], w[14], pars->GC_11, amp[10]); 
  FFV1_0(w[8], w[22], w[14], pars->GC_11, amp[11]); 
  FFV1_0(w[23], w[5], w[11], pars->GC_11, amp[12]); 
  FFV1_0(w[8], w[24], w[11], pars->GC_11, amp[13]); 
  FFV1_0(w[1], w[27], w[28], pars->GC_11, amp[14]); 
  FFV1_0(w[1], w[29], w[30], pars->GC_11, amp[15]); 
  FFV1_0(w[31], w[7], w[30], pars->GC_11, amp[16]); 
  FFV1_0(w[31], w[6], w[28], pars->GC_11, amp[17]); 
  FFV1_0(w[32], w[7], w[16], pars->GC_11, amp[18]); 
  FFV1_0(w[26], w[7], w[33], pars->GC_11, amp[19]); 
  FFV1_0(w[26], w[29], w[16], pars->GC_11, amp[20]); 
  FFV1_0(w[32], w[6], w[19], pars->GC_11, amp[21]); 
  FFV1_0(w[26], w[27], w[19], pars->GC_11, amp[22]); 
  FFV1_0(w[26], w[6], w[34], pars->GC_11, amp[23]); 
  FFV1_0(w[1], w[29], w[36], pars->GC_11, amp[24]); 
  FFV1_0(w[31], w[7], w[36], pars->GC_11, amp[25]); 
  FFV1_0(w[37], w[35], w[19], pars->GC_11, amp[26]); 
  FFV1_0(w[8], w[38], w[19], pars->GC_11, amp[27]); 
  FFV1_0(w[8], w[35], w[34], pars->GC_11, amp[28]); 
  FFV1_0(w[1], w[27], w[40], pars->GC_11, amp[29]); 
  FFV1_0(w[31], w[6], w[40], pars->GC_11, amp[30]); 
  FFV1_0(w[37], w[39], w[16], pars->GC_11, amp[31]); 
  FFV1_0(w[8], w[41], w[16], pars->GC_11, amp[32]); 
  FFV1_0(w[8], w[39], w[33], pars->GC_11, amp[33]); 
  ...
  FFV1_0(w[44], w[5], w[28], pars->GC_11, amp[38]); 
  FFV1_0(w[0], w[22], w[28], pars->GC_11, amp[39]); 
  FFV1_0(w[45], w[5], w[30], pars->GC_11, amp[40]); 
  FFV1_0(w[0], w[24], w[30], pars->GC_11, amp[41]); 
  FFV1_0(w[1], w[12], w[46], pars->GC_11, amp[42]); 
  FFV1_0(w[13], w[7], w[46], pars->GC_11, amp[43]); 
  ...
  FFV1_0(w[23], w[5], w[46], pars->GC_11, amp[56]); 
  FFV1_0(w[8], w[24], w[46], pars->GC_11, amp[57]); 
  FFV1_0(w[45], w[5], w[36], pars->GC_11, amp[58]); 
  FFV1_0(w[0], w[24], w[36], pars->GC_11, amp[59]); 
  FFV1_0(w[21], w[5], w[48], pars->GC_11, amp[60]); 
  FFV1_0(w[8], w[22], w[48], pars->GC_11, amp[61]); 
  FFV1_0(w[44], w[5], w[40], pars->GC_11, amp[62]); 
  FFV1_0(w[0], w[22], w[40], pars->GC_11, amp[63]); 

}
double P0_Sigma_sm_ud_mupvmuddux_W_4j::matrix_ud_wpuddux_wp_mupvm() 
{
  int i, j; 
  // Local variables
  ...
  jamp[0] = +1./4. * (+amp[0] + 1./3. * amp[4] + 1./3. * amp[5] + amp[7] +
  ...
  jamp[1] = +1./4. * (-amp[2] - amp[4] - std::complex<double> (0, 1) * amp[6] -
  ...
  jamp[2] = +1./4. * (-1./3. * amp[0] - 1./3. * amp[1] - amp[3] - amp[5] +
  ...
  jamp[3] = +1./4. * (+amp[1] + 1./3. * amp[2] + 1./3. * amp[3] -
  ...
  jamp[4] = +1./4. * (+1./9. * amp[0] + 1./9. * amp[1] + 1./3. * amp[2] + 1./3.
  ...
  jamp[5] = +1./4. * (-1./3. * amp[0] - 1./3. * amp[1] - 1./9. * amp[2] - 1./9.
