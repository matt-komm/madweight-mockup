...
#include "P0_Sigma_sm_uxcx_mupvmsuxcxcx_W_4j.h"
...
// Process: u~ c~ > w+ s u~ c~ c~ WEIGHTED=6
// *   Decay: w+ > mu+ vm WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_uxcx_mupvmsuxcxcx_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_uxcx_mupvmsuxcxcx_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_uxcx_wpsuxcxcx_wp_mupvm(); 
        ...
        t[1] = matrix_uxcx_wpsuxcxcx_wp_mupvm(); 
        double tsum = 0; 
...
double P0_Sigma_sm_uxcx_mupvmsuxcxcx_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_uxcx_mupvmsuxcxcx_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_0(w[10], w[5], w[16], pars->GC_11, amp[3]); 
...
double P0_Sigma_sm_uxcx_mupvmsuxcxcx_W_4j::matrix_uxcx_wpsuxcxcx_wp_mupvm() 
{
  int i, j; 
  // Local variables
