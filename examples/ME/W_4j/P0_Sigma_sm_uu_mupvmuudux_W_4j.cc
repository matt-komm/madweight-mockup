...
#include "P0_Sigma_sm_uu_mupvmuudux_W_4j.h"
...
// Process: u u > w+ u u d u~ WEIGHTED=6
// *   Decay: w+ > mu+ vm WEIGHTED=2
// Process: c c > w+ c c s c~ WEIGHTED=6
// *   Decay: w+ > mu+ vm WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_uu_mupvmuudux_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_uu_mupvmuudux_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_uu_wpuudux_wp_mupvm(); 
...
double P0_Sigma_sm_uu_mupvmuudux_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_uu_mupvmuudux_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[1], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[10]); 
  FFV1_3(w[9], w[7], pars->GC_11, pars->ZERO, pars->ZERO, w[11]); 
  ...
  FFV1_3(w[1], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[17]); 
  ...
  FFV1_3(w[28], w[7], pars->GC_11, pars->ZERO, pars->ZERO, w[30]); 
  ...
  FFV1_1(w[7], w[27], pars->GC_11, pars->ZERO, pars->ZERO, w[34]); 
  FFV1_1(w[7], w[17], pars->GC_11, pars->ZERO, pars->ZERO, w[35]); 
  FFV2_1(w[7], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[36]); 
  ...
  FFV1_3(w[39], w[7], pars->GC_11, pars->ZERO, pars->ZERO, w[44]); 
  FFV1_1(w[7], w[14], pars->GC_11, pars->ZERO, pars->ZERO, w[45]); 
  ...
  FFV1_1(w[7], w[46], pars->GC_11, pars->ZERO, pars->ZERO, w[51]); 
  FFV1_1(w[7], w[10], pars->GC_11, pars->ZERO, pars->ZERO, w[52]); 
  ...
  FFV1_1(w[7], w[20], pars->GC_11, pars->ZERO, pars->ZERO, w[57]); 
  ...
  FFV1_0(w[15], w[7], w[14], pars->GC_11, amp[2]); 
  FFV1_0(w[16], w[7], w[10], pars->GC_11, amp[3]); 
  VVV1_0(w[10], w[14], w[11], pars->GC_10, amp[4]); 
  FFV1_0(w[8], w[18], w[11], pars->GC_11, amp[5]); 
  FFV1_0(w[19], w[5], w[11], pars->GC_11, amp[6]); 
  FFV1_0(w[21], w[7], w[20], pars->GC_11, amp[7]); 
  FFV1_0(w[22], w[7], w[17], pars->GC_11, amp[8]); 
  ...
  FFV1_0(w[32], w[7], w[14], pars->GC_11, amp[16]); 
  FFV1_0(w[28], w[7], w[33], pars->GC_11, amp[17]); 
  ...
  FFV1_0(w[39], w[7], w[37], pars->GC_11, amp[24]); 
  FFV1_0(w[40], w[7], w[17], pars->GC_11, amp[25]); 
  ...
  FFV1_0(w[1], w[36], w[33], pars->GC_11, amp[33]); 
  ...
  FFV1_0(w[49], w[7], w[20], pars->GC_11, amp[40]); 
  FFV1_0(w[28], w[7], w[50], pars->GC_11, amp[41]); 
  ...
  FFV1_0(w[39], w[7], w[53], pars->GC_11, amp[48]); 
  FFV1_0(w[55], w[7], w[10], pars->GC_11, amp[49]); 
  ...
  FFV1_0(w[1], w[36], w[50], pars->GC_11, amp[57]); 
...
double P0_Sigma_sm_uu_mupvmuudux_W_4j::matrix_uu_wpuudux_wp_mupvm() 
{
  int i, j; 
  // Local variables
  ...
  jamp[0] = +1./4. * (+amp[0] + amp[2] + std::complex<double> (0, 1) * amp[4] +
  ...
  jamp[1] = +1./4. * (-1./3. * amp[2] - 1./3. * amp[3] - amp[6] - amp[8] +
  ...
  jamp[2] = +1./4. * (-1./3. * amp[0] - 1./3. * amp[1] - 1./3. * amp[2] - 1./3.
      * amp[3] - amp[5] - amp[7] - std::complex<double> (0, 1) * amp[9] -
      ...
      amp[94]);
  jamp[3] = +1./4. * (+1./9. * amp[0] + 1./9. * amp[1] + 1./9. * amp[2] + 1./9.
  ...
  jamp[4] = +1./4. * (+amp[1] + amp[3] - std::complex<double> (0, 1) * amp[4] +
  ...
  jamp[5] = +1./4. * (-1./3. * amp[0] - 1./3. * amp[1] - 1./9. * amp[5] - 1./9.
