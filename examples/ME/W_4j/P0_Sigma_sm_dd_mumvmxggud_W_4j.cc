...
#include "P0_Sigma_sm_dd_mumvmxggud_W_4j.h"
...
void P0_Sigma_sm_dd_mumvmxggud_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_dd_mumvmxggud_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_dd_wmggud_wm_mumvmx(); 
...
double P0_Sigma_sm_dd_mumvmxggud_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_dd_mumvmxggud_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[1], w[33], pars->GC_11, pars->ZERO, pars->ZERO, w[36]); 
  ...
  FFV1_3(w[39], w[8], pars->GC_11, pars->ZERO, pars->ZERO, w[40]); 
  ...
  VVV1_1(w[6], w[16], pars->GC_10, pars->ZERO, pars->ZERO, w[46]); 
  VVV1_1(w[6], w[19], pars->GC_10, pars->ZERO, pars->ZERO, w[47]); 
  FFV1_1(w[8], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[48]); 
  FFV1_1(w[7], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[49]); 
  FFV1_3(w[0], w[48], pars->GC_11, pars->ZERO, pars->ZERO, w[50]); 
  FFV2_1(w[49], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[51]); 
  FFV1_3(w[1], w[48], pars->GC_11, pars->ZERO, pars->ZERO, w[52]); 
  ...
  FFV1_1(w[48], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[57]); 
  FFV1_1(w[10], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[58]); 
  FFV1_2(w[21], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[59]); 
  FFV1_2(w[25], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[60]); 
  FFV1_2(w[0], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[61]); 
  FFV1_3(w[61], w[8], pars->GC_11, pars->ZERO, pars->ZERO, w[62]); 
  ...
  FFV1_3(w[68], w[8], pars->GC_11, pars->ZERO, pars->ZERO, w[69]); 
  ...
  FFV1_1(w[49], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[75]); 
  FFV1_2(w[21], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[76]); 
  VVV1_1(w[5], w[19], pars->GC_10, pars->ZERO, pars->ZERO, w[77]); 
  FFV1_2(w[25], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[78]); 
  VVV1_1(w[5], w[16], pars->GC_10, pars->ZERO, pars->ZERO, w[79]); 
  FFV1_1(w[33], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[80]); 
  FFV1_1(w[10], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[81]); 
  ...
  FFV1_0(w[14], w[8], w[13], pars->GC_11, amp[2]); 
  FFV1_0(w[15], w[8], w[12], pars->GC_11, amp[3]); 
  ...
  FFV1_0(w[15], w[8], w[22], pars->GC_11, amp[11]); 
  FFV1_0(w[23], w[7], w[19], pars->GC_11, amp[12]); 
  FFV1_0(w[21], w[24], w[19], pars->GC_11, amp[13]); 
  FFV1_0(w[21], w[7], w[20], pars->GC_11, amp[14]); 
  FFV1_0(w[0], w[11], w[26], pars->GC_11, amp[15]); 
  FFV1_0(w[14], w[8], w[26], pars->GC_11, amp[16]); 
  FFV1_0(w[27], w[7], w[16], pars->GC_11, amp[17]); 
  FFV1_0(w[25], w[24], w[16], pars->GC_11, amp[18]); 
  FFV1_0(w[25], w[7], w[18], pars->GC_11, amp[19]); 
  ...
  FFV1_0(w[0], w[34], w[36], pars->GC_11, amp[25]); 
  FFV1_0(w[1], w[33], w[37], pars->GC_11, amp[26]); 
  FFV1_0(w[0], w[33], w[38], pars->GC_11, amp[27]); 
  FFV1_0(w[1], w[34], w[40], pars->GC_11, amp[28]); 
  FFV1_0(w[39], w[8], w[38], pars->GC_11, amp[29]); 
  FFV1_0(w[39], w[34], w[19], pars->GC_11, amp[30]); 
  FFV2_0(w[39], w[41], w[4], pars->GC_100, amp[31]); 
  FFV1_0(w[0], w[34], w[43], pars->GC_11, amp[32]); 
  FFV1_0(w[42], w[8], w[37], pars->GC_11, amp[33]); 
  FFV1_0(w[42], w[34], w[16], pars->GC_11, amp[34]); 
  FFV2_0(w[42], w[44], w[4], pars->GC_100, amp[35]); 
  FFV1_0(w[21], w[45], w[19], pars->GC_11, amp[36]); 
  VVV1_0(w[6], w[19], w[37], pars->GC_10, amp[37]); 
  FFV1_0(w[21], w[41], w[6], pars->GC_11, amp[38]); 
  FFV1_0(w[25], w[45], w[16], pars->GC_11, amp[39]); 
  VVV1_0(w[6], w[16], w[38], pars->GC_10, amp[40]); 
  FFV1_0(w[25], w[44], w[6], pars->GC_11, amp[41]); 
  FFV2_0(w[28], w[45], w[4], pars->GC_100, amp[42]); 
  FFV1_0(w[1], w[34], w[46], pars->GC_11, amp[43]); 
  FFV1_0(w[28], w[34], w[6], pars->GC_11, amp[44]); 
  FFV2_0(w[30], w[45], w[4], pars->GC_100, amp[45]); 
  FFV1_0(w[0], w[34], w[47], pars->GC_11, amp[46]); 
  FFV1_0(w[30], w[34], w[6], pars->GC_11, amp[47]); 
  FFV1_0(w[1], w[51], w[50], pars->GC_11, amp[48]); 
  FFV1_0(w[0], w[51], w[52], pars->GC_11, amp[49]); 
  FFV1_0(w[21], w[49], w[52], pars->GC_11, amp[50]); 
  FFV1_0(w[25], w[49], w[50], pars->GC_11, amp[51]); 
  FFV1_0(w[53], w[7], w[52], pars->GC_11, amp[52]); 
  FFV1_0(w[1], w[10], w[54], pars->GC_11, amp[53]); 
  FFV1_0(w[39], w[10], w[52], pars->GC_11, amp[54]); 
  FFV1_0(w[25], w[7], w[54], pars->GC_11, amp[55]); 
  FFV1_0(w[55], w[7], w[50], pars->GC_11, amp[56]); 
  FFV1_0(w[0], w[10], w[56], pars->GC_11, amp[57]); 
  FFV1_0(w[42], w[10], w[50], pars->GC_11, amp[58]); 
  FFV1_0(w[21], w[7], w[56], pars->GC_11, amp[59]); 
  FFV1_0(w[1], w[57], w[12], pars->GC_11, amp[60]); 
  FFV1_0(w[0], w[57], w[13], pars->GC_11, amp[61]); 
  FFV1_0(w[1], w[58], w[50], pars->GC_11, amp[62]); 
  VVV1_0(w[50], w[6], w[13], pars->GC_10, amp[63]); 
  FFV1_0(w[0], w[58], w[52], pars->GC_11, amp[64]); 
  VVV1_0(w[52], w[6], w[12], pars->GC_10, amp[65]); 
  FFV1_0(w[1], w[57], w[22], pars->GC_11, amp[66]); 
  FFV1_0(w[59], w[7], w[52], pars->GC_11, amp[67]); 
  VVV1_0(w[52], w[6], w[22], pars->GC_10, amp[68]); 
  FFV1_0(w[0], w[57], w[26], pars->GC_11, amp[69]); 
  FFV1_0(w[60], w[7], w[50], pars->GC_11, amp[70]); 
  VVV1_0(w[50], w[6], w[26], pars->GC_10, amp[71]); 
  FFV1_0(w[1], w[51], w[62], pars->GC_11, amp[72]); 
  FFV1_0(w[25], w[49], w[62], pars->GC_11, amp[73]); 
  FFV1_0(w[63], w[49], w[19], pars->GC_11, amp[74]); 
  FFV2_0(w[64], w[49], w[4], pars->GC_100, amp[75]); 
  FFV1_0(w[63], w[7], w[36], pars->GC_11, amp[76]); 
  FFV1_0(w[1], w[10], w[65], pars->GC_11, amp[77]); 
  FFV1_0(w[1], w[33], w[66], pars->GC_11, amp[78]); 
  FFV1_0(w[25], w[7], w[65], pars->GC_11, amp[79]); 
  FFV1_0(w[63], w[7], w[43], pars->GC_11, amp[80]); 
  FFV1_0(w[55], w[7], w[62], pars->GC_11, amp[81]); 
  FFV1_0(w[42], w[8], w[66], pars->GC_11, amp[82]); 
  FFV1_0(w[42], w[10], w[62], pars->GC_11, amp[83]); 
  FFV1_0(w[67], w[8], w[13], pars->GC_11, amp[84]); 
  FFV1_0(w[1], w[58], w[62], pars->GC_11, amp[85]); 
  VVV1_0(w[62], w[6], w[13], pars->GC_10, amp[86]); 
  FFV1_0(w[67], w[10], w[19], pars->GC_11, amp[87]); 
  VVV1_0(w[6], w[19], w[66], pars->GC_10, amp[88]); 
  FFV1_0(w[64], w[10], w[6], pars->GC_11, amp[89]); 
  FFV1_0(w[67], w[8], w[26], pars->GC_11, amp[90]); 
  FFV1_0(w[60], w[7], w[62], pars->GC_11, amp[91]); 
  VVV1_0(w[62], w[6], w[26], pars->GC_10, amp[92]); 
  FFV2_0(w[67], w[31], w[4], pars->GC_100, amp[93]); 
  FFV1_0(w[63], w[7], w[47], pars->GC_11, amp[94]); 
  FFV1_0(w[63], w[31], w[6], pars->GC_11, amp[95]); 
  FFV1_0(w[0], w[51], w[69], pars->GC_11, amp[96]); 
  FFV1_0(w[21], w[49], w[69], pars->GC_11, amp[97]); 
  FFV1_0(w[70], w[49], w[16], pars->GC_11, amp[98]); 
  FFV2_0(w[71], w[49], w[4], pars->GC_100, amp[99]); 
  FFV1_0(w[70], w[7], w[35], pars->GC_11, amp[100]); 
  FFV1_0(w[0], w[10], w[72], pars->GC_11, amp[101]); 
  FFV1_0(w[0], w[33], w[73], pars->GC_11, amp[102]); 
  FFV1_0(w[21], w[7], w[72], pars->GC_11, amp[103]); 
  FFV1_0(w[70], w[7], w[40], pars->GC_11, amp[104]); 
  FFV1_0(w[53], w[7], w[69], pars->GC_11, amp[105]); 
  FFV1_0(w[39], w[8], w[73], pars->GC_11, amp[106]); 
  FFV1_0(w[39], w[10], w[69], pars->GC_11, amp[107]); 
  FFV1_0(w[74], w[8], w[12], pars->GC_11, amp[108]); 
  FFV1_0(w[0], w[58], w[69], pars->GC_11, amp[109]); 
  VVV1_0(w[69], w[6], w[12], pars->GC_10, amp[110]); 
  FFV1_0(w[74], w[10], w[16], pars->GC_11, amp[111]); 
  VVV1_0(w[6], w[16], w[73], pars->GC_10, amp[112]); 
  FFV1_0(w[71], w[10], w[6], pars->GC_11, amp[113]); 
  FFV1_0(w[74], w[8], w[22], pars->GC_11, amp[114]); 
  FFV1_0(w[59], w[7], w[69], pars->GC_11, amp[115]); 
  VVV1_0(w[69], w[6], w[22], pars->GC_10, amp[116]); 
  FFV2_0(w[74], w[29], w[4], pars->GC_100, amp[117]); 
  FFV1_0(w[70], w[7], w[46], pars->GC_11, amp[118]); 
  FFV1_0(w[70], w[29], w[6], pars->GC_11, amp[119]); 
  ...
  FFV1_0(w[1], w[51], w[79], pars->GC_11, amp[127]); 
  FFV1_0(w[28], w[51], w[5], pars->GC_11, amp[128]); 
  FFV2_0(w[30], w[75], w[4], pars->GC_100, amp[129]); 
  FFV1_0(w[0], w[51], w[77], pars->GC_11, amp[130]); 
  FFV1_0(w[30], w[51], w[5], pars->GC_11, amp[131]); 
  FFV1_0(w[1], w[80], w[12], pars->GC_11, amp[132]); 
  FFV1_0(w[0], w[80], w[13], pars->GC_11, amp[133]); 
  FFV1_0(w[1], w[81], w[35], pars->GC_11, amp[134]); 
  FFV1_0(w[0], w[81], w[36], pars->GC_11, amp[135]); 
  VVV1_0(w[5], w[35], w[13], pars->GC_10, amp[136]); 
  VVV1_0(w[5], w[36], w[12], pars->GC_10, amp[137]); 
  FFV1_0(w[1], w[80], w[22], pars->GC_11, amp[138]); 
  FFV1_0(w[76], w[7], w[36], pars->GC_11, amp[139]); 
  VVV1_0(w[5], w[36], w[22], pars->GC_10, amp[140]); 
  FFV1_0(w[0], w[80], w[26], pars->GC_11, amp[141]); 
  FFV1_0(w[78], w[7], w[35], pars->GC_11, amp[142]); 
  VVV1_0(w[5], w[35], w[26], pars->GC_10, amp[143]); 
  FFV1_0(w[82], w[8], w[13], pars->GC_11, amp[144]); 
  FFV1_0(w[1], w[81], w[40], pars->GC_11, amp[145]); 
  VVV1_0(w[5], w[40], w[13], pars->GC_10, amp[146]); 
  FFV1_0(w[82], w[10], w[19], pars->GC_11, amp[147]); 
  FFV1_0(w[39], w[81], w[19], pars->GC_11, amp[148]); 
  FFV1_0(w[39], w[10], w[77], pars->GC_11, amp[149]); 
  FFV1_0(w[82], w[8], w[26], pars->GC_11, amp[150]); 
  FFV1_0(w[78], w[7], w[40], pars->GC_11, amp[151]); 
  VVV1_0(w[5], w[40], w[26], pars->GC_10, amp[152]); 
  FFV2_0(w[82], w[31], w[4], pars->GC_100, amp[153]); 
  FFV1_0(w[53], w[7], w[77], pars->GC_11, amp[154]); 
  FFV1_0(w[53], w[31], w[5], pars->GC_11, amp[155]); 
  FFV1_0(w[83], w[8], w[12], pars->GC_11, amp[156]); 
  FFV1_0(w[0], w[81], w[43], pars->GC_11, amp[157]); 
  ...
  FFV1_0(w[83], w[8], w[22], pars->GC_11, amp[162]); 
  FFV1_0(w[76], w[7], w[43], pars->GC_11, amp[163]); 
  VVV1_0(w[5], w[43], w[22], pars->GC_10, amp[164]); 
  FFV2_0(w[83], w[29], w[4], pars->GC_100, amp[165]); 
  FFV1_0(w[55], w[7], w[79], pars->GC_11, amp[166]); 
  FFV1_0(w[55], w[29], w[5], pars->GC_11, amp[167]); 
  FFV1_0(w[1], w[81], w[46], pars->GC_11, amp[168]); 
  FFV1_0(w[28], w[81], w[6], pars->GC_11, amp[169]); 
  FFV1_0(w[1], w[58], w[79], pars->GC_11, amp[170]); 
  VVV1_0(w[79], w[6], w[13], pars->GC_10, amp[171]); 
  FFV1_0(w[28], w[58], w[5], pars->GC_11, amp[172]); 
  VVV1_0(w[5], w[46], w[13], pars->GC_10, amp[173]); 
  FFV1_0(w[1], w[10], w[84], pars->GC_11, amp[174]); 
  FFV1_0(w[1], w[10], w[85], pars->GC_11, amp[175]); 
  FFV1_0(w[1], w[10], w[86], pars->GC_11, amp[176]); 
  FFV1_0(w[0], w[81], w[47], pars->GC_11, amp[177]); 
  FFV1_0(w[30], w[81], w[6], pars->GC_11, amp[178]); 
  FFV1_0(w[0], w[58], w[77], pars->GC_11, amp[179]); 
  VVV1_0(w[77], w[6], w[12], pars->GC_10, amp[180]); 
  FFV1_0(w[30], w[58], w[5], pars->GC_11, amp[181]); 
  VVV1_0(w[5], w[47], w[12], pars->GC_10, amp[182]); 
  FFV1_0(w[0], w[10], w[87], pars->GC_11, amp[183]); 
  FFV1_0(w[0], w[10], w[88], pars->GC_11, amp[184]); 
  FFV1_0(w[0], w[10], w[89], pars->GC_11, amp[185]); 
  FFV1_0(w[76], w[7], w[47], pars->GC_11, amp[186]); 
  FFV1_0(w[76], w[31], w[6], pars->GC_11, amp[187]); 
  FFV1_0(w[59], w[7], w[77], pars->GC_11, amp[188]); 
  VVV1_0(w[77], w[6], w[22], pars->GC_10, amp[189]); 
  FFV1_0(w[59], w[31], w[5], pars->GC_11, amp[190]); 
  VVV1_0(w[5], w[47], w[22], pars->GC_10, amp[191]); 
  FFV1_0(w[21], w[7], w[87], pars->GC_11, amp[192]); 
  FFV1_0(w[21], w[7], w[88], pars->GC_11, amp[193]); 
  FFV1_0(w[21], w[7], w[89], pars->GC_11, amp[194]); 
  FFV1_0(w[78], w[7], w[46], pars->GC_11, amp[195]); 
  FFV1_0(w[78], w[29], w[6], pars->GC_11, amp[196]); 
  FFV1_0(w[60], w[7], w[79], pars->GC_11, amp[197]); 
  VVV1_0(w[79], w[6], w[26], pars->GC_10, amp[198]); 
  FFV1_0(w[60], w[29], w[5], pars->GC_11, amp[199]); 
  VVV1_0(w[5], w[46], w[26], pars->GC_10, amp[200]); 
  FFV1_0(w[25], w[7], w[84], pars->GC_11, amp[201]); 
  FFV1_0(w[25], w[7], w[85], pars->GC_11, amp[202]); 
  FFV1_0(w[25], w[7], w[86], pars->GC_11, amp[203]); 

}
double P0_Sigma_sm_dd_mumvmxggud_W_4j::matrix_dd_wmggud_wm_mumvmx() 
{
  int i, j; 
  // Local variables
  ...
  jamp[0] = +1./2. * (+std::complex<double> (0, 1) * amp[2] +
      ...
      * amp[47] - amp[144] - amp[145] + std::complex<double> (0, 1) * amp[146]
      ...
      amp[201]);
  jamp[1] = +1./2. * (-std::complex<double> (0, 1) * amp[3] - 1./3. *
  ...
  jamp[2] = +1./2. * (-std::complex<double> (0, 1) * amp[0] - 1./3. *
  ...
  jamp[3] = +1./2. * (+1./3. * std::complex<double> (0, 1) * amp[0] +
      std::complex<double> (0, 1) * amp[1] + 1./3. * std::complex<double> (0,
      ...
      amp[202]);
  jamp[4] = +1./2. * (-amp[24] - 1./3. * amp[25] - 1./3. * amp[26] - amp[27] -
      ...
      amp[201] - amp[202]);
  jamp[5] = +1./2. * (+1./3. * amp[24] + amp[25] + amp[26] + 1./3. * amp[27] +
  ...
  jamp[7] = +1./2. * (-amp[48] - 1./3. * amp[49] - 1./3. * amp[50] - amp[51] -
      ...
      amp[201] - amp[202]);
  jamp[8] = +1./2. * (-std::complex<double> (0, 1) * amp[2] -
      std::complex<double> (0, 1) * amp[4] - amp[5] - 1./3. *
      std::complex<double> (0, 1) * amp[7] - 1./3. * std::complex<double> (0,
      1) * amp[9] - 1./3. * std::complex<double> (0, 1) * amp[12] - 1./3. *
      std::complex<double> (0, 1) * amp[13] - std::complex<double> (0, 1) *
      ...
      amp[202]);
  jamp[9] = +1./2. * (+std::complex<double> (0, 1) * amp[3] + 1./3. *
      std::complex<double> (0, 1) * amp[4] + 1./3. * std::complex<double> (0,
      1) * amp[6] + std::complex<double> (0, 1) * amp[7] + amp[8] +
      std::complex<double> (0, 1) * amp[11] + std::complex<double> (0, 1) *
      amp[13] + amp[14] + 1./3. * std::complex<double> (0, 1) * amp[17] + 1./3.
  ...
  jamp[10] = +1./2. * (+std::complex<double> (0, 1) * amp[0] + 1./3. *
      std::complex<double> (0, 1) * amp[1] + 1./3. * std::complex<double> (0,
      1) * amp[2] - amp[8] + std::complex<double> (0, 1) * amp[9] +
      std::complex<double> (0, 1) * amp[10] + std::complex<double> (0, 1) *
      amp[12] - amp[14] + 1./3. * std::complex<double> (0, 1) * amp[15] + 1./3.
  ...
  jamp[11] = +1./2. * (-1./3. * std::complex<double> (0, 1) * amp[0] -
      std::complex<double> (0, 1) * amp[1] - 1./3. * std::complex<double> (0,
      1) * amp[3] + amp[5] - std::complex<double> (0, 1) * amp[6] - 1./3. *
      std::complex<double> (0, 1) * amp[10] - 1./3. * std::complex<double> (0,
      1) * amp[11] - std::complex<double> (0, 1) * amp[15] -
