...
#include "P0_Sigma_sm_uux_mupvmdduxdx_W_4j.h"
...
// Process: u u~ > w+ d d u~ d~ WEIGHTED=6
// *   Decay: w+ > mu+ vm WEIGHTED=2
// Process: c c~ > w+ s s c~ s~ WEIGHTED=6
// *   Decay: w+ > mu+ vm WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_uux_mupvmdduxdx_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_uux_mupvmdduxdx_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_uux_wpdduxdx_wp_mupvm(); 
        ...
        t[1] = matrix_uux_wpdduxdx_wp_mupvm(); 
        double tsum = 0; 
...
double P0_Sigma_sm_uux_mupvmdduxdx_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_uux_mupvmdduxdx_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[0], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[25]); 
...
double P0_Sigma_sm_uux_mupvmdduxdx_W_4j::matrix_uux_wpdduxdx_wp_mupvm() 
{
  int i, j; 
  // Local variables
