...
#include "P0_Sigma_sm_uux_mupvmuduxux_W_4j.h"
...
// Process: u u~ > w+ u d u~ u~ WEIGHTED=6
// *   Decay: w+ > mu+ vm WEIGHTED=2
// Process: c c~ > w+ c s c~ c~ WEIGHTED=6
// *   Decay: w+ > mu+ vm WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_uux_mupvmuduxux_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_uux_mupvmuduxux_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_uux_wpuduxux_wp_mupvm(); 
        ...
        t[1] = matrix_uux_wpuduxux_wp_mupvm(); 
        double tsum = 0; 
...
double P0_Sigma_sm_uux_mupvmuduxux_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_uux_mupvmuduxux_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[28], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[30]); 
  ...
  FFV1_1(w[6], w[27], pars->GC_11, pars->ZERO, pars->ZERO, w[34]); 
  FFV1_1(w[6], w[17], pars->GC_11, pars->ZERO, pars->ZERO, w[35]); 
  FFV2_1(w[6], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[36]); 
  ...
  FFV1_3(w[39], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[44]); 
  FFV1_1(w[6], w[14], pars->GC_11, pars->ZERO, pars->ZERO, w[45]); 
  FFV1_3(w[0], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[46]); 
  ...
  FFV1_1(w[6], w[46], pars->GC_11, pars->ZERO, pars->ZERO, w[51]); 
  FFV1_1(w[6], w[10], pars->GC_11, pars->ZERO, pars->ZERO, w[52]); 
  ...
  FFV1_1(w[6], w[20], pars->GC_11, pars->ZERO, pars->ZERO, w[57]); 
  ...
  FFV1_0(w[21], w[6], w[20], pars->GC_11, amp[7]); 
  FFV1_0(w[22], w[6], w[17], pars->GC_11, amp[8]); 
  ...
  FFV1_0(w[32], w[6], w[14], pars->GC_11, amp[16]); 
  FFV1_0(w[28], w[6], w[33], pars->GC_11, amp[17]); 
  ...
  FFV1_0(w[39], w[6], w[37], pars->GC_11, amp[24]); 
  FFV1_0(w[40], w[6], w[17], pars->GC_11, amp[25]); 
  ...
  FFV1_0(w[49], w[6], w[20], pars->GC_11, amp[40]); 
  FFV1_0(w[28], w[6], w[50], pars->GC_11, amp[41]); 
  ...
  FFV1_0(w[39], w[6], w[53], pars->GC_11, amp[48]); 
  FFV1_0(w[55], w[6], w[10], pars->GC_11, amp[49]); 
...
double P0_Sigma_sm_uux_mupvmuduxux_W_4j::matrix_uux_wpuduxux_wp_mupvm() 
{
  int i, j; 
  // Local variables
