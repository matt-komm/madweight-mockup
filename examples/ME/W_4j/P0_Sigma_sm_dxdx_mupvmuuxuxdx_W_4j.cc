...
#include "P0_Sigma_sm_dxdx_mupvmuuxuxdx_W_4j.h"
...
void P0_Sigma_sm_dxdx_mupvmuuxuxdx_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_dxdx_mupvmuuxuxdx_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_dxdx_wpuuxuxdx_wp_mupvm(); 
...
double P0_Sigma_sm_dxdx_mupvmuuxuxdx_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_dxdx_mupvmuuxuxdx_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[9], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[14]); 
  FFV1_1(w[0], w[10], pars->GC_11, pars->ZERO, pars->ZERO, w[15]); 
  FFV1_3(w[8], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[16]); 
  ...
  FFV1_3(w[6], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[25]); 
  FFV2_2(w[7], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[26]); 
  FFV1_1(w[0], w[25], pars->GC_11, pars->ZERO, pars->ZERO, w[27]); 
  FFV1_3(w[26], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[28]); 
  FFV1_1(w[1], w[25], pars->GC_11, pars->ZERO, pars->ZERO, w[29]); 
  FFV1_3(w[26], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[30]); 
  ...
  FFV2_1(w[0], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[35]); 
  ...
  FFV2_1(w[1], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[39]); 
  FFV1_3(w[7], w[39], pars->GC_11, pars->ZERO, pars->ZERO, w[40]); 
  FFV1_1(w[39], w[25], pars->GC_11, pars->ZERO, pars->ZERO, w[41]); 
  FFV1_1(w[1], w[16], pars->GC_11, pars->ZERO, pars->ZERO, w[42]); 
  FFV1_1(w[0], w[19], pars->GC_11, pars->ZERO, pars->ZERO, w[43]); 
  ...
  FFV1_0(w[13], w[0], w[14], pars->GC_11, amp[3]); 
  FFV1_0(w[17], w[1], w[16], pars->GC_11, amp[4]); 
  FFV1_0(w[18], w[1], w[10], pars->GC_11, amp[5]); 
  VVV1_0(w[10], w[16], w[14], pars->GC_10, amp[6]); 
  FFV1_0(w[17], w[0], w[19], pars->GC_11, amp[7]); 
  VVV1_0(w[10], w[19], w[11], pars->GC_10, amp[8]); 
  FFV1_0(w[20], w[0], w[10], pars->GC_11, amp[9]); 
  ...
  FFV1_0(w[31], w[1], w[30], pars->GC_11, amp[16]); 
  FFV1_0(w[31], w[0], w[28], pars->GC_11, amp[17]); 
  FFV1_0(w[32], w[1], w[16], pars->GC_11, amp[18]); 
  FFV1_0(w[26], w[1], w[33], pars->GC_11, amp[19]); 
  FFV1_0(w[26], w[29], w[16], pars->GC_11, amp[20]); 
  FFV1_0(w[32], w[0], w[19], pars->GC_11, amp[21]); 
  FFV1_0(w[26], w[27], w[19], pars->GC_11, amp[22]); 
  FFV1_0(w[26], w[0], w[34], pars->GC_11, amp[23]); 
  FFV1_0(w[8], w[29], w[36], pars->GC_11, amp[24]); 
  FFV1_0(w[31], w[1], w[36], pars->GC_11, amp[25]); 
  ...
  FFV1_0(w[31], w[0], w[40], pars->GC_11, amp[30]); 
  ...
  FFV1_0(w[13], w[1], w[46], pars->GC_11, amp[43]); 
  ...
  FFV1_0(w[13], w[0], w[48], pars->GC_11, amp[48]); 
...
double P0_Sigma_sm_dxdx_mupvmuuxuxdx_W_4j::matrix_dxdx_wpuuxuxdx_wp_mupvm() 
{
  int i, j; 
  // Local variables
