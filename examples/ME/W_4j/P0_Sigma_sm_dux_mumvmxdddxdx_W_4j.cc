...
#include "P0_Sigma_sm_dux_mumvmxdddxdx_W_4j.h"
...
// Process: d u~ > w- d d d~ d~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: s c~ > w- s s s~ s~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_dux_mumvmxdddxdx_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_dux_mumvmxdddxdx_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_dux_wmdddxdx_wm_mumvmx(); 
        ...
        t[1] = matrix_dux_wmdddxdx_wm_mumvmx(); 
        double tsum = 0; 
...
double P0_Sigma_sm_dux_mumvmxdddxdx_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_dux_mumvmxdddxdx_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_1(w[5], w[17], pars->GC_11, pars->ZERO, pars->ZERO, w[18]); 
  FFV1_2(w[8], w[17], pars->GC_11, pars->ZERO, pars->ZERO, w[19]); 
  FFV1_3(w[8], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[20]); 
  ...
  FFV1_1(w[5], w[14], pars->GC_11, pars->ZERO, pars->ZERO, w[26]); 
  FFV1_3(w[0], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[27]); 
  ...
  FFV1_1(w[1], w[27], pars->GC_11, pars->ZERO, pars->ZERO, w[33]); 
  ...
  FFV1_0(w[28], w[1], w[34], pars->GC_11, amp[18]); 
  ...
  FFV1_0(w[59], w[5], w[30], pars->GC_11, amp[64]); 
  ...
  FFV1_0(w[62], w[5], w[42], pars->GC_11, amp[77]); 
  FFV1_0(w[8], w[18], w[61], pars->GC_11, amp[78]); 
  FFV1_0(w[19], w[5], w[61], pars->GC_11, amp[79]); 
  ...
  FFV1_0(w[62], w[5], w[44], pars->GC_11, amp[84]); 
  ...
  FFV1_0(w[25], w[5], w[61], pars->GC_11, amp[92]); 
  FFV1_0(w[7], w[26], w[61], pars->GC_11, amp[93]); 
  FFV1_0(w[59], w[5], w[43], pars->GC_11, amp[94]); 
  FFV1_0(w[0], w[26], w[43], pars->GC_11, amp[95]); 

}
double P0_Sigma_sm_dux_mumvmxdddxdx_W_4j::matrix_dux_wmdddxdx_wm_mumvmx() 
{
  int i, j; 
  // Local variables
