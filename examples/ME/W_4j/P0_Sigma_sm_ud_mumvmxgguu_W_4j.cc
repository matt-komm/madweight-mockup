...
#include "P0_Sigma_sm_ud_mumvmxgguu_W_4j.h"
...
// Process: u d > w- g g u u WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: c s > w- g g c c WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_ud_mumvmxgguu_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_ud_mumvmxgguu_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_ud_wmgguu_wm_mumvmx(); 
        ...
        t[1] = matrix_ud_wmgguu_wm_mumvmx(); 
        double tsum = 0; 
...
double P0_Sigma_sm_ud_mumvmxgguu_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_ud_mumvmxgguu_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[0], w[8], pars->GC_11, pars->ZERO, pars->ZERO, w[14]); 
  ...
  FFV1_3(w[0], w[7], pars->GC_11, pars->ZERO, pars->ZERO, w[21]); 
  ...
  FFV1_3(w[39], w[7], pars->GC_11, pars->ZERO, pars->ZERO, w[56]); 
  ...
  FFV1_3(w[62], w[8], pars->GC_11, pars->ZERO, pars->ZERO, w[63]); 
  FFV1_3(w[62], w[50], pars->GC_11, pars->ZERO, pars->ZERO, w[64]); 
  FFV1_3(w[62], w[7], pars->GC_11, pars->ZERO, pars->ZERO, w[65]); 
  ...
  FFV1_0(w[24], w[8], w[41], pars->GC_11, amp[30]); 
  FFV1_0(w[39], w[8], w[38], pars->GC_11, amp[31]); 
  FFV1_0(w[43], w[8], w[36], pars->GC_11, amp[32]); 
  ...
  FFV1_0(w[24], w[7], w[57], pars->GC_11, amp[54]); 
  FFV1_0(w[39], w[7], w[55], pars->GC_11, amp[55]); 
  FFV1_0(w[43], w[7], w[53], pars->GC_11, amp[56]); 
  ...
  FFV1_0(w[82], w[8], w[12], pars->GC_11, amp[144]); 
  FFV1_0(w[1], w[80], w[40], pars->GC_11, amp[145]); 
  VVV1_0(w[5], w[40], w[12], pars->GC_10, amp[146]); 
  FFV1_0(w[82], w[7], w[20], pars->GC_11, amp[147]); 
  FFV1_0(w[1], w[76], w[56], pars->GC_11, amp[148]); 
  VVV1_0(w[5], w[56], w[20], pars->GC_10, amp[149]); 
  FFV1_0(w[82], w[8], w[26], pars->GC_11, amp[150]); 
  FFV1_0(w[82], w[7], w[25], pars->GC_11, amp[151]); 
  FFV1_0(w[77], w[8], w[56], pars->GC_11, amp[152]); 
  FFV1_0(w[77], w[7], w[40], pars->GC_11, amp[153]); 
...
double P0_Sigma_sm_ud_mumvmxgguu_W_4j::matrix_ud_wmgguu_wm_mumvmx() 
{
  int i, j; 
  // Local variables
