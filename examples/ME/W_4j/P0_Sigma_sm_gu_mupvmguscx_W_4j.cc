...
#include "P0_Sigma_sm_gu_mupvmguscx_W_4j.h"
...
// Process: g u > w+ g u s c~ WEIGHTED=6
// *   Decay: w+ > mu+ vm WEIGHTED=2
// Process: g c > w+ g c d u~ WEIGHTED=6
// *   Decay: w+ > mu+ vm WEIGHTED=2
// Process: g d > w+ g d s c~ WEIGHTED=6
// *   Decay: w+ > mu+ vm WEIGHTED=2
// Process: g s > w+ g s d u~ WEIGHTED=6
// *   Decay: w+ > mu+ vm WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_gu_mupvmguscx_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_gu_mupvmguscx_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_gu_wpguscx_wp_mupvm(); 
        ...
        t[1] = matrix_gu_wpguscx_wp_mupvm(); 
        double tsum = 0; 
...
double P0_Sigma_sm_gu_mupvmguscx_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_gu_mupvmguscx_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double P0_Sigma_sm_gu_mupvmguscx_W_4j::matrix_gu_wpguscx_wp_mupvm() 
{
  int i, j; 
  // Local variables
