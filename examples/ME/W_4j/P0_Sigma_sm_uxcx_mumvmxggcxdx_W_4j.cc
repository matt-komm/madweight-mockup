...
#include "P0_Sigma_sm_uxcx_mumvmxggcxdx_W_4j.h"
...
void P0_Sigma_sm_uxcx_mumvmxggcxdx_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_uxcx_mumvmxggcxdx_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_uxcx_wmggcxdx_wm_mumvmx(); 
        ...
        t[1] = matrix_uxcx_wmggcxdx_wm_mumvmx(); 
        double tsum = 0; 
...
double P0_Sigma_sm_uxcx_mumvmxggcxdx_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_uxcx_mumvmxggcxdx_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[29], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[30]); 
  ...
  FFV1_0(w[29], w[1], w[28], pars->GC_11, amp[15]); 
  ...
  FFV1_0(w[18], w[0], w[39], pars->GC_11, amp[27]); 
  FFV1_0(w[40], w[0], w[37], pars->GC_11, amp[28]); 
  ...
  FFV1_0(w[18], w[0], w[46], pars->GC_11, amp[39]); 
  FFV1_0(w[40], w[0], w[45], pars->GC_11, amp[40]); 
  ...
  FFV1_0(w[49], w[0], w[34], pars->GC_11, amp[58]); 
  ...
  FFV1_0(w[54], w[0], w[30], pars->GC_11, amp[76]); 
  ...
  FFV1_0(w[40], w[0], w[55], pars->GC_11, amp[82]); 
...
double P0_Sigma_sm_uxcx_mumvmxggcxdx_W_4j::matrix_uxcx_wmggcxdx_wm_mumvmx() 
{
  int i, j; 
  // Local variables
  ...
  jamp[8] = +1./2. * (-amp[12] - amp[13] - amp[16] - amp[17] -
  ...
  jamp[9] = +1./2. * (+1./3. * amp[12] + 1./3. * amp[13] + 1./3. * amp[14] +
      ...
      1./3. * amp[76]);
  jamp[10] = +1./2. * (+1./3. * amp[24] + 1./3. * amp[25] + 1./3. * amp[28] +
      1./3. * amp[29] + 1./3. * amp[31] + 1./3. * amp[34] + 1./3. * amp[36] +
      1./3. * amp[37] + 1./3. * amp[40] + 1./3. * amp[41] + 1./3. * amp[43] +
      1./3. * amp[46]);
  jamp[11] = +1./2. * (-amp[24] - amp[25] - amp[26] - amp[27] - amp[31] -
