...
#ifndef MG5_Sigma_sm_us_mumvmxgguc_H
#define MG5_Sigma_sm_us_mumvmxgguc_H
...
class P0_Sigma_sm_us_mumvmxgguc_W_4j
{
  public:

    // Constructor.
    P0_Sigma_sm_us_mumvmxgguc_W_4j() {}
  ...
  private:
    ...
    double matrix_us_wmgguc_wm_mumvmx(); 
...
#endif  // MG5_Sigma_sm_us_mumvmxgguc_H
