...
#include "P0_Sigma_sm_uxsx_mumvmxcuxsxsx_W_4j.h"
...
// Process: u~ s~ > w- c u~ s~ s~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: c~ d~ > w- u c~ d~ d~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2
// Process: d~ s~ > w- c d~ s~ s~ WEIGHTED=6
// *   Decay: w- > mu- vm~ WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_uxsx_mumvmxcuxsxsx_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_uxsx_mumvmxcuxsxsx_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_uxsx_wmcuxsxsx_wm_mumvmx(); 
        ...
        t[1] = matrix_uxsx_wmcuxsxsx_wm_mumvmx(); 
        double tsum = 0; 
...
double P0_Sigma_sm_uxsx_mumvmxcuxsxsx_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_uxsx_mumvmxcuxsxsx_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double P0_Sigma_sm_uxsx_mumvmxcuxsxsx_W_4j::matrix_uxsx_wmcuxsxsx_wm_mumvmx() 
{
  int i, j; 
  // Local variables
