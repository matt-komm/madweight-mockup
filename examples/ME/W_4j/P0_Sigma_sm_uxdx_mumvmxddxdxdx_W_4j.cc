...
#include "P0_Sigma_sm_uxdx_mumvmxddxdxdx_W_4j.h"
...
void P0_Sigma_sm_uxdx_mumvmxddxdxdx_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_uxdx_mumvmxddxdxdx_W_4j::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_uxdx_wmddxdxdx_wm_mumvmx(); 
        ...
        t[1] = matrix_uxdx_wmddxdxdx_wm_mumvmx(); 
        double tsum = 0; 
...
double P0_Sigma_sm_uxdx_mumvmxddxdxdx_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_uxdx_mumvmxddxdxdx_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_3(w[9], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[11]); 
  ...
  FFV1_3(w[39], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[44]); 
  FFV1_1(w[0], w[14], pars->GC_11, pars->ZERO, pars->ZERO, w[45]); 
  ...
  FFV1_1(w[0], w[46], pars->GC_11, pars->ZERO, pars->ZERO, w[50]); 
  VVV1_1(w[46], w[20], pars->GC_10, pars->ZERO, pars->ZERO, w[51]); 
  FFV1_1(w[0], w[10], pars->GC_11, pars->ZERO, pars->ZERO, w[52]); 
  ...
  FFV1_1(w[0], w[20], pars->GC_11, pars->ZERO, pars->ZERO, w[57]); 
  ...
  FFV1_0(w[32], w[0], w[14], pars->GC_11, amp[16]); 
  FFV1_0(w[28], w[33], w[14], pars->GC_11, amp[17]); 
  FFV1_0(w[28], w[0], w[34], pars->GC_11, amp[18]); 
  ...
  FFV1_0(w[39], w[0], w[37], pars->GC_11, amp[24]); 
  FFV1_0(w[40], w[0], w[17], pars->GC_11, amp[25]); 
  ...
  FFV1_0(w[49], w[0], w[20], pars->GC_11, amp[40]); 
  FFV1_0(w[28], w[50], w[20], pars->GC_11, amp[41]); 
  FFV1_0(w[28], w[0], w[51], pars->GC_11, amp[42]); 
  ...
  FFV1_0(w[39], w[0], w[53], pars->GC_11, amp[48]); 
  FFV1_0(w[55], w[0], w[10], pars->GC_11, amp[49]); 
...
double P0_Sigma_sm_uxdx_mumvmxddxdxdx_W_4j::matrix_uxdx_wmddxdxdx_wm_mumvmx() 
{
  int i, j; 
  // Local variables
