...
#include "P0_Sigma_sm_gu_mupvmgggd_W_4j.h"
...
// Process: g u > w+ g g g d WEIGHTED=6
// *   Decay: w+ > mu+ vm WEIGHTED=2
// Process: g c > w+ g g g s WEIGHTED=6
// *   Decay: w+ > mu+ vm WEIGHTED=2

//--------------------------------------------------------------------------
// Initialize process.

void P0_Sigma_sm_gu_mupvmgggd_W_4j::initProc(string param_card_name) 
{
...
void P0_Sigma_sm_gu_mupvmgggd_W_4j::sigmaKin() 
{
...
double P0_Sigma_sm_gu_mupvmgggd_W_4j::sigmaHat() 
{
...
void P0_Sigma_sm_gu_mupvmgggd_W_4j::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_2(w[1], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[16]); 
  ...
  FFV1_2(w[1], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[23]); 
  FFV1_2(w[23], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[24]); 
  FFV1_2(w[1], w[7], pars->GC_11, pars->ZERO, pars->ZERO, w[25]); 
  FFV1_2(w[25], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[26]); 
  FFV2_2(w[1], w[4], pars->GC_100, pars->ZERO, pars->ZERO, w[27]); 
  FFV1_2(w[27], w[7], pars->GC_11, pars->ZERO, pars->ZERO, w[28]); 
  FFV1_3(w[27], w[8], pars->GC_11, pars->ZERO, pars->ZERO, w[29]); 
  FFV1_2(w[27], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[30]); 
  FFV1_1(w[8], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[31]); 
  ...
  FFV1_1(w[8], w[7], pars->GC_11, pars->ZERO, pars->ZERO, w[35]); 
  FFV1_1(w[35], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[36]); 
  FFV1_2(w[1], w[20], pars->GC_11, pars->ZERO, pars->ZERO, w[37]); 
  FFV1_1(w[8], w[20], pars->GC_11, pars->ZERO, pars->ZERO, w[38]); 
  ...
  FFV1_1(w[8], w[47], pars->GC_11, pars->ZERO, pars->ZERO, w[49]); 
  FFV1_2(w[1], w[48], pars->GC_11, pars->ZERO, pars->ZERO, w[50]); 
  FFV1_2(w[1], w[47], pars->GC_11, pars->ZERO, pars->ZERO, w[51]); 
  FFV1_1(w[8], w[48], pars->GC_11, pars->ZERO, pars->ZERO, w[52]); 
  ...
  FFV1_1(w[8], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[56]); 
  ...
  FFV1_2(w[1], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[62]); 
  ...
  FFV1_1(w[8], w[75], pars->GC_11, pars->ZERO, pars->ZERO, w[77]); 
  FFV1_2(w[1], w[76], pars->GC_11, pars->ZERO, pars->ZERO, w[78]); 
  FFV1_2(w[1], w[75], pars->GC_11, pars->ZERO, pars->ZERO, w[79]); 
  FFV1_1(w[8], w[76], pars->GC_11, pars->ZERO, pars->ZERO, w[80]); 
  ...
  FFV1_1(w[8], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[97]); 
  ...
  FFV1_2(w[1], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[112]); 
  ...
  FFV1_2(w[1], w[141], pars->GC_11, pars->ZERO, pars->ZERO, w[147]); 
  FFV1_2(w[1], w[142], pars->GC_11, pars->ZERO, pars->ZERO, w[148]); 
  FFV1_2(w[1], w[143], pars->GC_11, pars->ZERO, pars->ZERO, w[149]); 
  FFV1_1(w[8], w[141], pars->GC_11, pars->ZERO, pars->ZERO, w[150]); 
  FFV1_1(w[8], w[142], pars->GC_11, pars->ZERO, pars->ZERO, w[151]); 
  FFV1_1(w[8], w[143], pars->GC_11, pars->ZERO, pars->ZERO, w[152]); 
  ...
  FFV1_2(w[1], w[153], pars->GC_11, pars->ZERO, pars->ZERO, w[159]); 
  FFV1_2(w[1], w[154], pars->GC_11, pars->ZERO, pars->ZERO, w[160]); 
  FFV1_2(w[1], w[155], pars->GC_11, pars->ZERO, pars->ZERO, w[161]); 
  FFV1_1(w[8], w[153], pars->GC_11, pars->ZERO, pars->ZERO, w[162]); 
  FFV1_1(w[8], w[154], pars->GC_11, pars->ZERO, pars->ZERO, w[163]); 
  FFV1_1(w[8], w[155], pars->GC_11, pars->ZERO, pars->ZERO, w[164]); 
  ...
  FFV1_2(w[1], w[165], pars->GC_11, pars->ZERO, pars->ZERO, w[168]); 
  FFV1_2(w[1], w[166], pars->GC_11, pars->ZERO, pars->ZERO, w[169]); 
  FFV1_2(w[1], w[167], pars->GC_11, pars->ZERO, pars->ZERO, w[170]); 
  FFV1_1(w[8], w[165], pars->GC_11, pars->ZERO, pars->ZERO, w[171]); 
  FFV1_1(w[8], w[166], pars->GC_11, pars->ZERO, pars->ZERO, w[172]); 
  FFV1_1(w[8], w[167], pars->GC_11, pars->ZERO, pars->ZERO, w[173]); 
  ...
  FFV1_0(w[1], w[10], w[17], pars->GC_11, amp[6]); 
  FFV1_0(w[1], w[10], w[18], pars->GC_11, amp[7]); 
  FFV1_0(w[1], w[10], w[19], pars->GC_11, amp[8]); 
  FFV1_0(w[1], w[21], w[20], pars->GC_11, amp[9]); 
  FFV1_0(w[1], w[10], w[22], pars->GC_11, amp[10]); 
  ...
  FFV1_0(w[28], w[8], w[11], pars->GC_11, amp[18]); 
  VVV1_0(w[11], w[29], w[7], pars->GC_10, amp[19]); 
  FFV1_0(w[30], w[8], w[14], pars->GC_11, amp[20]); 
  VVV1_0(w[14], w[29], w[6], pars->GC_10, amp[21]); 
  FFV1_0(w[30], w[31], w[7], pars->GC_11, amp[22]); 
  FFV1_0(w[28], w[31], w[6], pars->GC_11, amp[23]); 
  FFV1_0(w[27], w[8], w[17], pars->GC_11, amp[24]); 
  FFV1_0(w[27], w[8], w[18], pars->GC_11, amp[25]); 
  FFV1_0(w[27], w[8], w[19], pars->GC_11, amp[26]); 
  FFV1_0(w[32], w[8], w[20], pars->GC_11, amp[27]); 
  FFV1_0(w[27], w[8], w[22], pars->GC_11, amp[28]); 
  ...
  FFV1_0(w[1], w[39], w[14], pars->GC_11, amp[38]); 
  ...
  FFV1_0(w[41], w[8], w[14], pars->GC_11, amp[43]); 
  ...
  FFV1_0(w[1], w[10], w[53], pars->GC_11, amp[56]); 
  FFV1_0(w[1], w[54], w[48], pars->GC_11, amp[57]); 
  FFV1_0(w[51], w[10], w[48], pars->GC_11, amp[58]); 
  FFV1_0(w[27], w[8], w[53], pars->GC_11, amp[59]); 
  FFV1_0(w[55], w[8], w[48], pars->GC_11, amp[60]); 
  FFV1_0(w[27], w[49], w[48], pars->GC_11, amp[61]); 
  FFV1_0(w[1], w[58], w[57], pars->GC_11, amp[62]); 
  ...
  FFV1_0(w[63], w[8], w[57], pars->GC_11, amp[70]); 
  ...
  FFV1_0(w[1], w[10], w[81], pars->GC_11, amp[110]); 
  FFV1_0(w[1], w[82], w[76], pars->GC_11, amp[111]); 
  FFV1_0(w[79], w[10], w[76], pars->GC_11, amp[112]); 
  FFV1_0(w[27], w[8], w[81], pars->GC_11, amp[113]); 
  FFV1_0(w[83], w[8], w[76], pars->GC_11, amp[114]); 
  FFV1_0(w[27], w[77], w[76], pars->GC_11, amp[115]); 
  FFV1_0(w[1], w[58], w[84], pars->GC_11, amp[116]); 
  ...
  FFV1_0(w[63], w[8], w[84], pars->GC_11, amp[124]); 
  ...
  FFV1_0(w[1], w[98], w[103], pars->GC_11, amp[170]); 
  ...
  FFV1_0(w[1], w[98], w[108], pars->GC_11, amp[196]); 
  ...
  FFV1_0(w[1], w[98], w[109], pars->GC_11, amp[210]); 
  FFV1_0(w[1], w[98], w[110], pars->GC_11, amp[211]); 
  FFV1_0(w[1], w[98], w[111], pars->GC_11, amp[212]); 
  ...
  FFV1_0(w[113], w[8], w[99], pars->GC_11, amp[216]); 
  ...
  FFV1_0(w[113], w[8], w[103], pars->GC_11, amp[224]); 
  ...
  FFV1_0(w[113], w[8], w[108], pars->GC_11, amp[250]); 
  ...
  FFV1_0(w[113], w[8], w[109], pars->GC_11, amp[264]); 
  FFV1_0(w[113], w[8], w[110], pars->GC_11, amp[265]); 
  FFV1_0(w[113], w[8], w[111], pars->GC_11, amp[266]); 
  ...
  FFV1_0(w[1], w[12], w[121], pars->GC_11, amp[270]); 
  VVV1_0(w[121], w[13], w[7], pars->GC_10, amp[271]); 
  FFV1_0(w[1], w[122], w[99], pars->GC_11, amp[272]); 
  FFV1_0(w[78], w[122], w[7], pars->GC_11, amp[273]); 
  VVV1_0(w[0], w[99], w[13], pars->GC_10, amp[274]); 
  FFV1_0(w[78], w[12], w[0], pars->GC_11, amp[275]); 
  FFV1_0(w[1], w[10], w[123], pars->GC_11, amp[276]); 
  FFV1_0(w[1], w[10], w[124], pars->GC_11, amp[277]); 
  FFV1_0(w[1], w[10], w[125], pars->GC_11, amp[278]); 
  ...
  FFV1_0(w[28], w[8], w[121], pars->GC_11, amp[282]); 
  VVV1_0(w[121], w[29], w[7], pars->GC_10, amp[283]); 
  FFV1_0(w[127], w[8], w[99], pars->GC_11, amp[284]); 
  FFV1_0(w[127], w[80], w[7], pars->GC_11, amp[285]); 
  VVV1_0(w[0], w[99], w[29], pars->GC_10, amp[286]); 
  FFV1_0(w[28], w[80], w[0], pars->GC_11, amp[287]); 
  FFV1_0(w[27], w[8], w[123], pars->GC_11, amp[288]); 
  FFV1_0(w[27], w[8], w[124], pars->GC_11, amp[289]); 
  FFV1_0(w[27], w[8], w[125], pars->GC_11, amp[290]); 
  ...
  FFV1_0(w[30], w[8], w[129], pars->GC_11, amp[312]); 
  VVV1_0(w[129], w[29], w[6], pars->GC_10, amp[313]); 
  FFV1_0(w[127], w[8], w[103], pars->GC_11, amp[314]); 
  FFV1_0(w[127], w[52], w[6], pars->GC_11, amp[315]); 
  VVV1_0(w[0], w[103], w[29], pars->GC_10, amp[316]); 
  FFV1_0(w[30], w[52], w[0], pars->GC_11, amp[317]); 
  FFV1_0(w[27], w[8], w[130], pars->GC_11, amp[318]); 
  FFV1_0(w[27], w[8], w[131], pars->GC_11, amp[319]); 
  FFV1_0(w[27], w[8], w[132], pars->GC_11, amp[320]); 
  ...
  FFV1_0(w[1], w[39], w[129], pars->GC_11, amp[324]); 
  FFV2_0(w[50], w[134], w[4], pars->GC_100, amp[325]); 
  FFV1_0(w[50], w[39], w[0], pars->GC_11, amp[326]); 
  FFV1_0(w[41], w[8], w[129], pars->GC_11, amp[327]); 
  ...
  FFV1_0(w[1], w[58], w[136], pars->GC_11, amp[340]); 
  ...
  FFV1_0(w[63], w[8], w[136], pars->GC_11, amp[364]); 
  ...
  FFV1_0(w[1], w[122], w[108], pars->GC_11, amp[378]); 
  FFV1_0(w[37], w[122], w[5], pars->GC_11, amp[379]); 
  FFV1_0(w[1], w[68], w[136], pars->GC_11, amp[380]); 
  VVV1_0(w[136], w[5], w[13], pars->GC_10, amp[381]); 
  FFV1_0(w[37], w[68], w[0], pars->GC_11, amp[382]); 
  VVV1_0(w[0], w[108], w[13], pars->GC_10, amp[383]); 
  FFV1_0(w[1], w[10], w[138], pars->GC_11, amp[384]); 
  FFV1_0(w[1], w[10], w[139], pars->GC_11, amp[385]); 
  FFV1_0(w[1], w[10], w[140], pars->GC_11, amp[386]); 
  ...
  FFV1_0(w[127], w[8], w[108], pars->GC_11, amp[399]); 
  FFV1_0(w[127], w[38], w[5], pars->GC_11, amp[400]); 
  FFV1_0(w[72], w[8], w[136], pars->GC_11, amp[401]); 
  VVV1_0(w[136], w[5], w[29], pars->GC_10, amp[402]); 
  FFV1_0(w[72], w[38], w[0], pars->GC_11, amp[403]); 
  VVV1_0(w[0], w[108], w[29], pars->GC_10, amp[404]); 
  FFV1_0(w[27], w[8], w[138], pars->GC_11, amp[405]); 
  FFV1_0(w[27], w[8], w[139], pars->GC_11, amp[406]); 
  FFV1_0(w[27], w[8], w[140], pars->GC_11, amp[407]); 
  ...
  FFV1_0(w[1], w[10], w[144], pars->GC_11, amp[432]); 
  FFV1_0(w[1], w[10], w[145], pars->GC_11, amp[433]); 
  FFV1_0(w[1], w[10], w[146], pars->GC_11, amp[434]); 
  ...
  FFV1_0(w[27], w[8], w[144], pars->GC_11, amp[441]); 
  FFV1_0(w[27], w[8], w[145], pars->GC_11, amp[442]); 
  FFV1_0(w[27], w[8], w[146], pars->GC_11, amp[443]); 
  ...
  FFV1_0(w[1], w[10], w[156], pars->GC_11, amp[456]); 
  FFV1_0(w[1], w[10], w[157], pars->GC_11, amp[457]); 
  FFV1_0(w[1], w[10], w[158], pars->GC_11, amp[458]); 
  ...
  FFV1_0(w[27], w[8], w[156], pars->GC_11, amp[465]); 
  FFV1_0(w[27], w[8], w[157], pars->GC_11, amp[466]); 
  FFV1_0(w[27], w[8], w[158], pars->GC_11, amp[467]); 
  ...
  FFV1_0(w[1], w[10], w[174], pars->GC_11, amp[492]); 
  FFV1_0(w[1], w[10], w[175], pars->GC_11, amp[493]); 
  FFV1_0(w[1], w[10], w[176], pars->GC_11, amp[494]); 
  FFV1_0(w[168], w[10], w[5], pars->GC_11, amp[495]); 
  FFV1_0(w[169], w[10], w[5], pars->GC_11, amp[496]); 
  FFV1_0(w[170], w[10], w[5], pars->GC_11, amp[497]); 
  FFV1_0(w[27], w[8], w[174], pars->GC_11, amp[498]); 
  FFV1_0(w[27], w[8], w[175], pars->GC_11, amp[499]); 
  FFV1_0(w[27], w[8], w[176], pars->GC_11, amp[500]); 
  FFV1_0(w[27], w[171], w[5], pars->GC_11, amp[501]); 
  FFV1_0(w[27], w[172], w[5], pars->GC_11, amp[502]); 
  FFV1_0(w[27], w[173], w[5], pars->GC_11, amp[503]); 
  FFV1_0(w[1], w[10], w[177], pars->GC_11, amp[504]); 
  FFV1_0(w[1], w[10], w[178], pars->GC_11, amp[505]); 
  FFV1_0(w[1], w[10], w[179], pars->GC_11, amp[506]); 
  FFV1_0(w[1], w[122], w[109], pars->GC_11, amp[507]); 
  FFV1_0(w[1], w[122], w[110], pars->GC_11, amp[508]); 
  FFV1_0(w[1], w[122], w[111], pars->GC_11, amp[509]); 
  FFV1_0(w[27], w[8], w[177], pars->GC_11, amp[510]); 
  FFV1_0(w[27], w[8], w[178], pars->GC_11, amp[511]); 
  FFV1_0(w[27], w[8], w[179], pars->GC_11, amp[512]); 
  FFV1_0(w[127], w[8], w[109], pars->GC_11, amp[513]); 
  FFV1_0(w[127], w[8], w[110], pars->GC_11, amp[514]); 
  FFV1_0(w[127], w[8], w[111], pars->GC_11, amp[515]); 

}
double P0_Sigma_sm_gu_mupvmgggd_W_4j::matrix_gu_wpgggd_wp_mupvm() 
{
  int i, j; 
  // Local variables
